...
// ## Images to use (specify full path)
	flipImg_open   = "images/inlftdownarrow.gif";
	flipImg_closed = "images/inlftnorarrow.gif"; 
	flipImg_static = "flip_static.gif";
	flipImgSqrBullet = "images/sqrbullet.gif";
...
document.write(
	...
	"ul.flipMenu { margin-top: " + flipTopMargin + "; margin-left: " + flipLeftMargin + "; " + (flipImages ? "" : "list-style-image: url("+ flipImgSqrBullet +");") + " }" +
	"ul.flipMenu ul, ul.flipMenu li { padding-top: " + flipVerticalPadding + "; margin-left: " + flipIndentation + "; margin_right: 0px; " + (flipImages ? "" : "list-style-image: url("+ flipImgSqrBullet +");") + " }" +
...
if (flipImages) {
	...
	aFlipPreloads[3] = new Image;
	aFlipPreloads[3].src = flipImgSqrBullet;
}
