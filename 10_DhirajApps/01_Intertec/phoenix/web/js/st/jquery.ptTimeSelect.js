		...
		function () {
			...
			if (!jQuery('#ptTimeSelectCntr').length) {
				jQuery("body").append(
						...
						+ '<div><div>'
						+ '<table border=1 width="100%" bordercolor="#7c92be" bgcolor="#b9c7e2">'
						+ '<tr>'
						+ '	<td colspan=2>'
						...
						+ '			<b><span id="ptTimeSelectUserSelHr">1</span> :</b>'
						+ '			<b><span id="ptTimeSelectUserSelMin">00</span></b>'
						+ '			<b><span id="ptTimeSelectUserSelAmPm">AM</span></b>'
						+ '		</div>'
						+ '     </td>'
						+ '</tr>   '
						+ '<tr>'
						...
						+ '		<div class="ptTimeSelectLeftPane" style="width: 50%; text-align: center; float: left;"><b>Hours</b></div>'
						+ '	</div>'
						+ '<br style="clear: left;" />'
						...
						+ '		</td>'
						+ '		<td>'
						+ '		<div class="ptTimeSelectRightPane" style="width: 50%; text-align: center; float: left;"><b>Minutes<b></div>'
						+ '					<br style="clear: left;" />'						
						...
						+ '						style="display: block; width: 20%; float: left;"><b>AM</b></a>'
						+ '					<a class="ptTimeSelectHr ui-state-default" href="javascript: void(0);"'
						+ '						style="display: block; width: 20%; float: left;"><b>PM</b></a>'
						+ '			</div>'
