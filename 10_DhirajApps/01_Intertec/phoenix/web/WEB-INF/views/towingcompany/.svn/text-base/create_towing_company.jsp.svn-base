...
<form:form name="towingCompanyCreateForm" method="POST" action="create_towing_company.htm">
<div style="color:red;">
...
<table border="0" cellpadding="0" cellspacing="0" class="MainTable">
  <tr>
    ...
    <tr>
      <th colspan="2" width="50%"><f:message key="createNewTowingCompany"/></th>
      ...
      <th width="10%" ><a href="search_towing_company.htm"><img src="images/icofindjob.gif" alt="Search" width="16" height="14" border="0" align="absmiddle"></a>&nbsp
  ...
  <tr>
    ...
    <td class="TDShadeBlue"><form:input cssClass="inputBox" size="35" maxlength="70" path="email" />
  ...
  <tr>
    <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        ...
        <td style="text-align:right"><a href="search_towing_company.htm"><img src="images/icofindjob.gif" alt="Search" width="16" height="14" border="0" align="absmiddle"></a>&nbsp <a href="#"><input type="image" src="images/icosave.gif" alt="Save" width="14" height="14" border="0"></a></td>
      </tr>
    </table></td>
  </tr>
</table>
