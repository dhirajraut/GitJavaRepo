          ...
          <div id="tab_inner">
            ...
            <div id="tab1" class="innercontent" >
              <table width="100%" cellpadding="0" cellspacing="0" class="mainApplTable">
                <tbody>
                  <tr>
                    <th class="TDShade" colspan="5">Contract ID: ${command.id} <img src="images/separator2.gif" width="2" height="27"  align="absmiddle"/> Description: Contract Description&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Status: Active&nbsp;|&nbsp;Working PB :&nbsp;<select name="sel4" class="selectionBox" id="sel4" >
