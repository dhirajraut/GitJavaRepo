...
function setform()
{
  ...
  if (isAdd(code.value) == false) {
    ...
    document.createJobsOutSourcingForm.ccode.focus();
  document.createJobsOutSourcingForm.ccode.value="";
  return false;
    }
  ...
  document.createJobsOutSourcingForm.uniqueFlag.value="uniqueFlag";
    document.createJobsOutSourcingForm.submit();
...
{
 document.createJobsOutSourcingForm.jobFlag.value="none";
 document.createJobsOutSourcingForm.jobIndex.value = index;
 document.createJobsOutSourcingForm.deleteFlag.value ="delval";
 document.createJobsOutSourcingForm.submit();
}
}
...
function setsubflag()
{
document.createJobsOutSourcingForm.jobValFlag.value="newjobval";
document.createJobsOutSourcingForm.tabName.value = "1";
}

function setcontactflag(rowIndex)
{
  document.createJobsOutSourcingForm.jobFlag.value="none";
  document.createJobsOutSourcingForm.contactIndex.value=rowIndex;
  document.createJobsOutSourcingForm.contactFlag.value="contFlag";
  document.createJobsOutSourcingForm.tabName.value="1";
}

function setAttachFilesFlag(rowIndex)
{
  document.createJobsOutSourcingForm.attachFilesFlag.value=rowIndex;
  document.createJobsOutSourcingForm.tabName.value="1";
}
...
{
document.createJobsOutSourcingForm.jobFlag.value="none";
 document.createJobsOutSourcingForm.popFlag.value="none";
document.createJobsOutSourcingForm.contactFlag.value="none";
  document.createJobsOutSourcingForm.uniqueFlag.value="none";
  setpage();
}
...
{
  document.createJobsOutSourcingForm.nextPageFlag.value = "1";
 ...
 function updateJobDescription(dateFormat,jobDescExist)
  {
   ...
   var w = document.createJobsOutSourcingForm.sel5.selectedIndex;
   var ops_text = document.createJobsOutSourcingForm.sel5.options[w].text;
...
return false;
 ...
 document.createJobsOutSourcingForm.jobDateFlag.value="jobDate";
  if(buName!= "" && buName!= null)
  {
document.getElementById('jobbu').setAttribute("src",src="search_branch_popup.htm?inputFieldId=jobOrder.branchName&div1=jobbranchcode&div2=jobbranchcodebody&buName="+buName+"&formName=createJobsOutSourcingForm")
...
function checkSearchField()
{
  ...
  return false;
   ...
   {
    document.createJobsOutSourcingForm.goFlag.value="true";    
    document.createJobsOutSourcingForm.operationFlag.value = "operation";
    submitform();
   }
}
...
{
document.createJobsOutSourcingForm.tabName.value=val;
} 
function submitform(){      
  top.document.forms[0].submit();
  }
...
{	
 ...
 document.createJobsOutSourcingForm.errorFlag.value="none";
 document.createJobsOutSourcingForm.uniqueFlag.value="uniqueFlag";
...
{
  document.createJobsOutSourcingForm.jobFlag.value="none";
  document.createJobsOutSourcingForm.deleteFlag.value ="none";
  document.createJobsOutSourcingForm.contactFlag.value="contFlag";
  document.createJobsOutSourcingForm.tabName.value="1";
  document.createJobsOutSourcingForm.submit();
}
...
function selectJobDateBoolean(flag)
 {
 document.createJobsOutSourcingForm.jobDateFlag.value="jobDate";
 document.createJobsOutSourcingForm.dateFlag.value=flag;
 if(flag=='true')
 document.createJobsOutSourcingForm.openPeriodsFlag.value="true";
 else
 document.createJobsOutSourcingForm.openPeriodsFlag.value="false";
 document.createJobsOutSourcingForm.submit();
 }
...
document.createJobsOutSourcingForm.showWarn.value="false";
}
...
<form:form name="createJobsOutSourcingForm" method="POST" action="create_job_entry_outsourcing.htm">
...
<div id="tab_inner">
  <!-- ----------------------------------------------------- TAB 1 CONTAINER ---------------------------------------------------------->
          ...
          <table width="100%" cellpadding=0 cellspacing=0 class=mainApplTable>
            <tbody>
              <tr bgcolor=#ffffff>
                <th width="50%" colspan="2" nowrap><f:message key="headerDetails"/> <img src=" images/separator2.gif" width="2" height="27"  align="absmiddle" style="margin-left:5px;margin-right:5px;"/><f:message key="jobId"/> :<img src=" images/separator2.gif" width="2" height="27" align="absmiddle" style="margin-left:5px;margin-right:5px;"/><f:message key="jobTypeASandMNTesting"/></th>
...
<form:select id="projectTypes" cssClass="selectionBox" path="phxProjectType" items="${command.projectTypes}" itemLabel="name" itemValue="value" disabled="${command.projectTypeViewOnly}" />
        ...
        <form:input id="brnch" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;"
          cssClass="inputBox" size="52" path="jobOrder.branchName" onchange="selectJobDateBoolean('false');"/>
		...
		<c:when test="${command.userTimeFormat != 'AM/PM'}">
                ...
                <td width="45%" colspan="4" class="TDShadeBlue"><form:input id="etadate" cssClass="inputBox" path="jobOrder.etaDate" onchange="selectJobDate('false','etadate');"/>
       ...
       <form:input size="4" id="etaTimes" cssClass="inputBox" path="uiEtaTime" /> 
        ...
        <img src=" images/lookup.gif" alt="Lookup Time Zone" width="13" height="13" border="0" /></a>
         ...
         <tr>
                  ...
                  <td class="TDShadeBlue" width="10%" colspan="1"> <form:input cssClass="inputBox" size="52" maxlength="100" path="jobOrder.turnaroundTime"/>
...
<th style="text-align:right"><a href="#"  onclick="goToNextPage('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}')"><img src=" images/savennextbluarrow.gif" alt="Save and Go to Next Page" width="14" height="14" hspace="4" border="0" align="absmiddle" title="Save and Go to Next Page"></a>
<a href="#" ><img src=" images/icosave.gif" alt="Save" title="Save" width="14" height="14" border="0" align="absmiddle" onclick="javascript:updateJobDescription('${command.dateFormat}');setTabName('1');checkcount('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}');"
<%--checkDate('${command.dateFormat}','${command.userTimeFormat}');"--%>
/></a></th>
</tr>
...
{  
document.createJobsOutSourcingForm.jobFlag.value="jobval";
document.createJobsOutSourcingForm.tabName.value = "1";
var buname=document.getElementById("sel3").value;
...
document.getElementById('pu').setAttribute("src","search_job_contract_insp_popup.htm?inputFieldId=inputFieldIdValue&searchForm=createJobsOutSourcingForm&code="+code+"&pageNumber="+pageN0+"&buName="+buname+"&fromPage=3");
}
}
</script>
</c:when>
...
if(scode.charAt("/"))
{ code=scode.replace("/","'");}
document.createJobsOutSourcingForm.ccode.value=code;
document.createJobsOutSourcingForm.uniqueFlag.value="uniqueFlag";
document.createJobsOutSourcingForm.submit();
}
</script>
...
<td width="26%"><form:select id="sel6" cssClass="selectionBoxbig" path="addJobContracts[${counter.index}].jobContract.custSentBy" items="${icbfn:dropdown('staticDropdown',origin)}" itemLabel="name" itemValue="value"/><form:errors path="addJobContracts[${counter.index}].jobContract.custSentBy" cssClass="redstar"/></td>
...
<td><form:input id="remitto${counter.index}" cssClass="inputBox" size="14" maxlength="0" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" path="addJobContracts[${counter.index}].jobContract.bankCd"/>
            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td style="text-align:right"><a href="#"  onclick="goToNextPage('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}')"><img src="images/savennextbluarrow.gif" alt="Save and Go to Next Page" width="14" height="14" hspace="4" border="0" align="absmiddle" title="Save and Go to Next Page"></a><a href="#" ><img src="images/icosave.gif" alt="Save" title="Save" width="14" height="14" border="0"  onclick="javascript:updateJobDescription('${command.dateFormat}');setTabName('1');checkcount('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}');"
