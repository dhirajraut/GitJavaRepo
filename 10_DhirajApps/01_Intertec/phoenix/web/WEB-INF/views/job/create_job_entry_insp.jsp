 ...
 function setTowingCoFlag()
  {
   ...
   // document.createJobsInspForm.towingCompFlag.value="towingCompany";
document.createJobsInspForm.tabName.value = "0";
  
  }
    function setShippingFlag()
  {
        
  //  document.createJobsInspForm.shippingAgentFlag.value="shippingAgent";
document.createJobsInspForm.tabName.value = "0";
   ...
   function setServiceLcoationFlag()
  {
    ...
    document.createJobsInspForm.serviceLocationFlag.value="servicelocation";
document.createJobsInspForm.tabName.value = "0";
   ...
   function setPortLcoationFlag()
  {
    ...
    document.createJobsInspForm.portLocationFlag.value="portlocation";
document.createJobsInspForm.tabName.value = "0";
...
var buName= document.getElementById("sel3").value;
 document.createJobsInspForm.jobDateFlag.value="jobDate";
if(buName!= "" && buName!= null)
{
document.getElementById('jobbu').setAttribute("src",src="search_branch_popup.htm?inputFieldId=jobOrder.branchName&div1=jobbranchcode&div2=jobbranchcodebody&buName="+buName+"&formName=createJobsInspForm");
}
}
...
function setform()
{
  ...
  if (isAdd(code.value) == false) {
    ...
    document.createJobsInspForm.ccode.focus();
  document.createJobsInspForm.ccode.value="";
  return false;
    }
  ...
  document.createJobsInspForm.uniqueFlag.value="uniqueFlag";
    document.createJobsInspForm.submit();
  } 
}
...
{
 document.createJobsInspForm.jobFlag.value="none";
 document.createJobsInspForm.jobIndex.value = index;
 document.createJobsInspForm.deleteFlag.value ="delval";
 document.createJobsInspForm.submit();
}
}
function resetJobValFlag()
{
 document.createJobsInspForm.contactFlag.value="none";
 document.createJobsInspForm.jobFlag.value="none";
 document.createJobsInspForm.popFlag.value="none";
  document.createJobsInspForm.uniqueFlag.value="none";
  setpage();
}
...
function setsubflag()
{
document.createJobsInspForm.jobValFlag.value="newjobval";
document.createJobsInspForm.tabName.value = "1";
}

function setcontactflag(rowIndex)
{
  document.createJobsInspForm.jobFlag.value="none";
  document.createJobsInspForm.deleteFlag.value ="none";
  document.createJobsInspForm.contactIndex.value=rowIndex;
  document.createJobsInspForm.contactFlag.value="contFlag";
  document.createJobsInspForm.tabName.value="1";
}

function setAttachFilesFlag(rowIndex)
{
  document.createJobsInspForm.attachFilesFlag.value=rowIndex;
  document.createJobsInspForm.tabName.value="1";
}
function setpage()
{
...
{	
 ...
 document.createJobsInspForm.errorFlag.value="none";
 document.createJobsInspForm.uniqueFlag.value="uniqueFlag";
...
if(portLoc == "" || portLoc == null)
{
  ...
  document.createJobsInspForm.nextPageFlag.value = "1";
...
function checkSearchField()
{
  ...
  return false;
   ...
   {document.createJobsInspForm.goFlag.value="true";    
    document.createJobsInspForm.operationFlag.value = "operation";
    submitform();
	}
}
  ...
  {
   var w = document.createJobsInspForm.sel5.selectedIndex;
   var ops_text = document.createJobsInspForm.sel5.options[w].text;
...
document.createJobsInspForm.bankFlag.value="bankFlag";
document.createJobsInspForm.tabName.value="1";
document.createJobsInspForm.bankIndex.value=index;
 document.createJobsInspForm.submit();
}
...
/* function checkcount(count,dateFormat,userTimeFormat) {
 ...
 {
 document.createJobsInspForm.jobDateFlag.value="jobDate";
 document.createJobsInspForm.dateFlag.value=flag;
 if(flag=='true')
 document.createJobsInspForm.openPeriodsFlag.value="true";
 else
 document.createJobsInspForm.openPeriodsFlag.value="false";
 document.createJobsInspForm.submit();
 }
...
document.createJobsInspForm.showWarn.value="false";
}
...
<form:form name="createJobsInspForm" method="POST"
  action="create_job_entry_insp.htm">
    ...
    <tbody>
      <tr bgcolor=#ffffff>
        ...
        <img src=" images/separator2.gif" width="2" height="27"
          ...
          key="jobId" /> :<img src=" images/separator2.gif" width="2"
          height="27" align="absmiddle"
          style="margin-left:5px;margin-right:5px;" /><f:message
...
<form:select id="projectTypes" cssClass="selectionBox" path="phxProjectType" items="${command.projectTypes}" itemLabel="name" itemValue="value" disabled="${command.projectTypeViewOnly}" />
      ...
      <tr>
        ...
        <form:input id="brnch" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;"
          cssClass="inputBox" maxlength="128" size="52" path="jobOrder.branchName" onchange="selectJobDateBoolean('false');"/>
...
<td class="TDShadeBlue"><form:select id="sel5"  cssClass="selectionBoxbig" path="jobOrder.operation"  items="${icbfn:dropdown('jobOperations', operations)}" itemLabel="name" itemValue="value" /> <form:errors path="jobOrder.operation" cssClass="redstar" /></td>
        ...
        <img src=" images/lookup.gif"  alt="Lookup receivedBy" width="13" height="13" border="0" /></a></td>
      </tr>
      <tr>
		...
		<a href="#" onClick="displayCalendar(document.forms[0].finishdate,'${command.dateFormat}',this)">
      ...
      <tr>
        ...
        <img src=" images/calendar.gif" width="15" height="17"
          align="absmiddle" border="0" /></a>&nbsp&nbsp&nbsp<f:message
          key="time"/>:&nbsp<form:input size="4" id="nomTimes" cssClass="inputBox"
          path="uiNominationTime" /> <form:errors
          path="uiNominationTime" cssClass="redstar" /> <form:input 
          size="4" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" cssClass="inputBox" path="jobOrder.nominationTimeTz" /> <form:errors
        ...
        <img src=" images/calendar.gif" width="15" height="17"
          ...
          key="time" />:&nbsp<form:input size="4" cssClass="inputBox" id="etaTimes"
      ...
      <tr>
        ...
        <td class="TDShadeBlue"><form:input id="tco" 
          cssClass="inputBox" maxlength="128" size="52" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;"
          path="jobOrder.towingCompany.name" /> <form:errors
          path="jobOrder.towingCompany.name" cssClass="redstar" /> <a
          href="#"
         ...
         'towingco_drag','towingco_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('towingco','towingbody');popupboxenable();"><img
          src=" images/lookup.gif" width="13" alt="Lookup Towing Company" height="13" border="0" /></a></td>
        <td class="TDShade"><strong><f:message
          key="telephoneNo" /></strong></td>
        <td class="TDShadeBlue"><form:input id="tphone" 
          cssClass="inputBox" maxlength="20" size="52" path="jobOrder.towingCompanyPhone" /> <form:errors
          path="jobOrder.towingCompanyPhone" cssClass="redstar" /></td>
      </tr>
      <tr>
        <td class="TDShade"><strong><f:message
          key="shippingAgent" />:</strong></td>
        <td class="TDShadeBlue"><form:input id="shipagnt" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;"
          cssClass="inputBox" maxlength="128" size="52"
          path="jobOrder.shippingAgent.name" /> <form:errors
          path="jobOrder.shippingAgent.name" cssClass="redstar" /> <a
          href="#"
        ...
        <img src=" images/lookup.gif" width="13" alt="Lookup Shipping Agent" height="13" border="0" /></a></td>
        <td class="TDShade"><strong><f:message
          key="telephoneNo" /></strong></td>
        <td class="TDShadeBlue"><form:input  id="sphone" 
          cssClass="inputBox" maxlength="20" size="52" path="jobOrder.shippingAgentPhone" /> <form:errors
          path="jobOrder.shippingAgentPhone" cssClass="redstar" /></td>
      </tr>
      <tr>
        <td class="TDShade"><strong><f:message
          key="portLocation" />:<span class="redstar">*</span></strong></td>
        <td class="TDShadeBlue"><form:input id="portLoc" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" onchange="javascript:changeVisibleStyle();"
          cssClass="inputBox" maxlength="30" size="52"
          path="jobOrder.serviceLocation.city" /> <form:errors
          path="jobOrder.serviceLocation.city" cssClass="redstar" /><a
        ...
        <td colspan="2" class="TDShadeBlue"><form:input id="serviceLoc" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" size="52"
          ...
          href="#"  onClick="javascript:updateServiceLocationIframeSrc();setServiceLcoationFlag();popup_show('servloc','servloc_drag','servloc_exit', 'screen-corner', 12, 5);hideIt();showPopupDiv('servloc','servlocbody');popupboxenable();">
        <img src="images/lookup.gif" id="lookup"  width="13" height="13" border="0" /></a></td>
      </tr>
      <tr>
      ...
      <tr>
        <td valign="top" class="TDShade"><strong><a href="#" onClick="javascript:updateJobDescription('${command.dateFormat}','jobdescexist');"><f:message
    ...
    <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td style="text-align:right"><a href="#" onClick="goToNextPage('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}')"><img
            src=" images/savennextbluarrow.gif" alt="Save and Go to Next Page"
            width="14" height="14" hspace="4" border="0" align="absmiddle"
            title="Save and Go to Next Page"></a><a href="#"
            onclick="javascript:updateJobDescription('${command.dateFormat}');checkcount('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}');
...
<!------------------------------------------------------------TAB 1 CONTAINER END------------------------------------------------------>
  ...
  <ajax:autocomplete 
   ...
   <ajax:autocomplete 
            baseUrl="joborder.htm"
          source="jobOrder.nominationTimeTz" target="jobOrder.nominationTimeTz"
          className="autocomplete"
          parameters="nominationTimeZone={jobOrder.nominationTimeTz}"
          minimumCharacters="3" /> 
  <ajax:autocomplete 
            baseUrl="joborder.htm"
          source="jobOrder.etaTimeTz" target="jobOrder.etaTimeTz"
          className="autocomplete" parameters="etaTimeZone={jobOrder.etaTimeTz}"
          minimumCharacters="3" /> 
 <ajax:autocomplete
           baseUrl="branch.htm"
...
<form:input  id="ccode" cssClass="inputBox" path="contractCode.value" size="52" maxlength="100"/>
...
<tr>
<iframe id="pu" align="left" frameborder="0" style="padding:0px;" height="670px;" width="100%" src="blank.html"
scrolling="auto" id="searchjobContractFr" name="searchjobContractFr" allowtransparency="yes" ></iframe>
</tr>
</table>
</div>
</div>
...
{  
document.createJobsInspForm.jobFlag.value="jobval";
document.createJobsInspForm.tabName.value = "1";
var buname=document.getElementById("sel3").value;
...
code = escape(code);
//END: To fix issue 110817
document.getElementById("pu").setAttribute("src","search_job_contract_insp_popup.htm?inputFieldId=inputFieldIdValue&searchForm=createJobsInspForm&code="+code+"&pageNumber="+pageN0+"&buName="+buname+"&fromPage=1");
}
}
</script>
</c:when>
...
if(scode.charAt("/"))
{ code=scode.replace("/","'");}
document.createJobsInspForm.ccode.value=code;
document.createJobsInspForm.uniqueFlag.value="uniqueFlag";
document.createJobsInspForm.submit();
}
</script>
...
<th width="125" scope="col"  align="left"><f:message key="customerName"/></th>
...
<%--<td><form:select id="sel9" cssClass="selectionBoxbig" path="addJobContracts[${counter.index}].jobContract.productType" items="${icbfn:dropdown('productType', null)}" itemLabel="name" itemValue="value"/></td>--%>
...
<td><form:select id="sel10"  cssClass="selectionBoxbig" path="addJobContracts[${counter.index}].jobContract.locationDesc" items="${icbfn:dropdown('portCode', contracts)}" itemLabel="name" itemValue="value" />
</td> 
...
<td><form:input id="remitto${counter.index}" cssClass="inputBox"  cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" size="12"  maxlength="0" path="addJobContracts[${counter.index}].jobContract.bankCd"/>
...
<img class="menu_form_exit" id="searchremitto_exit${counter.index}" src="images/form_exit.png" /> &nbsp;&nbsp;&nbsp;<f:message key="remitToSearch"/></div><div class="menu_form_body" id="remittobody${counter.index}"   style="width:750px; height:500px;overflow-y:hidden;">
<table cellspacing="0" cellpadding="0" align="center" style="width:95%;" >
<tr><iframe align="left" frameborder="0" style="padding:0px;" height="530px;" width="100%" src="blank.html" scrolling="auto" id="sremittoframe${counter.index}" name="sremittoframe${counter.index}" allowtransparency="yes" ></iframe></tr></table></div></div>
...
<iframe align="left" frameborder="0" style="padding:0px; height:530px;" width="100%" src="search_project_popup.htm?inputFieldId=addJobContracts[${counter.index}].jobContract.projectNumber&custCode=${command.addJobContracts[counter.index].jobContract.custCode}&rowNum=${counter.index}" scrolling="no" id="sprojframe${counter.index}" name="sprojframe${counter.index}" allowtransparency="yes"></iframe></div> </div>
             ...
             <td>
			    <strong>
				     <span class="redstar">*</span>
			             ...
			             <span class="Font11pt"><f:message key="markedfiledsaremdtry"/></span>
						</td>
                     <td style="text-align:right">
	 	    		 <a href="#" onClick="goToNextPage('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}')">
              ...
              <a href="#"><img src="images/icosave.gif" alt="Save" title="Save" width="14" height="14" border="0"  onclick="javascript:updateJobDescription('${command.dateFormat}');checkcount('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}');"/></a>
           </td>
         </tr>
      </table>
    </td>
   ...
   <div class="menu_form_header" id="towingco_drag" style="width:750px;">
      <img class="menu_form_exit" id="towingco_exit"  src="images/form_exit.png"/>&nbsp;&nbsp;&nbsp;
	     <f:message key="selectTowingCompany"/></div>
	       ...
	       <iframe id="tow" align="left" src="blank.html" style="padding:0px;height:530px;" width="100%" scrolling="auto" name="frame1"  allowtransparency="yes">
        </iframe>
    </div>
 </div>
<!------------------------------------------------------- Towing Company Lookup End--------------------------------------------------->

<!-----------------------------------------Shipping Agent Look Up------------------------------------------------->
<div class="sample_popup" id="shippingagent"  style="visibility: hidden; display: none;">
   <div class="menu_form_header" id="shippingagent_drag"  style="width:750px;">
       <img class="menu_form_exit"  id="shippingagent_exit" src=" images/form_exit.png"/>&nbsp;&nbsp;&nbsp;
           <f:message key="selectShippingAgent" /></div>
             ...
             <iframe id="ship" align="left" src="blank.html"  frameborder="0" style="padding:0px; height:530px;" width="100%"  
             scrolling="auto" id="frame2" name="frame2" allowtransparency="yes">
       </iframe>
    </div>
</div>
      ...
      <img class="menu_form_exit" id="servloc_exit" src=" images/form_exit.png"/>&nbsp;&nbsp;&nbsp;
         <f:message key="selectServiceLocation" /></div>
           <div class="menu_form_body" id="servlocbody" style="width:980px; height:980px;overflow-y:hidden;">
            <iframe id="serv" align="left" src="blank.html" frameborder="0" style="padding:0px; height:980px; width:980px" width="100%"
...
<div class="sample_popup" id="timezone"  style="visibility: hidden;display: none;">
   <div class="menu_form_header" id="timezone_drag" style="width:750px;">
      <img class="menu_form_exit" id="timezone_exit" src=" images/form_exit.png"/>&nbsp;&nbsp;&nbsp;
         <f:message key="selectTimeZone"/>
		   </div>
            <div class="menu_form_body" id="timezonebody" style="width:750px; height:530px;overflow-y:hidden;">
          <iframe align="middle" frameborder="0" style="padding:1px; height:530px;" width="100%" src="search_timezone_popup.htm?inputFieldId=jobOrder.nominationTimeTz&div1=timezone&div2=timezonebody"
          id="frame4" name="frame4" allowtransparency="yes">
       </iframe>
   </div>
</div>
   ...
   <div class="menu_form_header" id="etatimezone_drag" style="width:750px;">
      <img class="menu_form_exit" id="etatimezone_exit" src="images/form_exit.png"/>&nbsp;&nbsp;&nbsp;
         <f:message key="selectTimeZone"/></div>
           ...
           src="search_timezone_popup.htm?inputFieldId=jobOrder.etaTimeTz&div1=etatimezone&div2=etatimezonebody" id="frame5" name="frame5" allowtransparency="yes">
        </iframe>
     </div>
</div>
   ...
   <div class="menu_form_header" id="receivedby_drag" style="width:750px;">
      <img class="menu_form_exit" id="receivedby_exit" src="images/form_exit.png" />&nbsp;&nbsp;&nbsp;
         <f:message  key="searchUser"/></div>
            <div class="menu_form_body" id="receivedbybody" style="width:750px; height:530px;padding-left:4px;overflow-y:hidden;">
              ...
              scrolling="auto" id="searchAccountOwnerFr" name="searchAccountOwnerFr" allowtransparency="yes">
          </iframe>
      </div>
</div>
