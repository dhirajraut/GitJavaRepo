...
{   
 document.editJobsMarineForm.portLocationFlag.value="portlocation";
 document.editJobsMarineForm.tabName.value = "0";
}
...
function checkSearchField()
{
  ...
  return false;
   ...
   {
     document.editJobsMarineForm.goFlag.value="true";  
     document.editJobsMarineForm.operationFlag.value = "operation";
       submitform();
    }
}
...
if(finishDate != "" && finishDate != null)
  ...
  var desc = ops_text+" "+"on"+" "+ vessel+" "+"at"+" "+newServLoc+" "+"on"+" "+date;
...
return true;
  ...
  function nextList()
  {
	...
	document.editJobsMarineForm.portLocationFlag.value="none";
	document.editJobsMarineForm.shipAgentPhoneFlag.value="none";
	document.editJobsMarineForm.towCoPhoneFlag.value="none";
	document.editJobsMarineForm.operationFlag.value="none";
	document.editJobsMarineForm.jobFlag.value="none";
	document.editJobsMarineForm.deleteFlag.value="none";
	document.editJobsMarineForm.contactFlag.value="none";
	document.editJobsMarineForm.uniqueFlag.value="none";
	document.editJobsMarineForm.bankFlag.value="none";
	document.editJobsMarineForm.jobDateFlag.value="none";
	document.editJobsMarineForm.warnUserFlag.value="none";
	// END : #119240
    document.editJobsMarineForm.submit();
  }
...
function monjobnumberFlag(index,jobnumber){
  ...
  document.getElementById("anchor"+index).style.visibility="hidden";
    ...
    {
      document.editJobsMarineForm.monthlyJobFlag.value="monthlyid";
      document.editJobsMarineForm.rowNum.value=index;
...
function checkForRebill(elemid,index,contractCode,jobContractId)
{
 ...
 if(confirm(msg)==true)
	{
    document.editJobsMarineForm.rebillFlag.value="rebill";
    document.editJobsMarineForm.contractIndex.value=index;
	//populatePhone();
...
{  
  ...
  document.getElementById("creditreasonbox_" + index).src="credit_reason_popup.htm?contractCode=" + contractCode + "&jobContractId=" + jobContractId + "&contractIndex=" + index+ "&controllerName=EditJobOrderMarineFormController";                            
...
{ 
 ...
 document.editJobsMarineForm.errorFlag.value="none";
 document.editJobsMarineForm.uniqueFlag.value="uniqueFlag";
...
checkDate(dateFormat,userTimeFormat);
 ...
 {
 document.editJobsMarineForm.jobDateFlag.value="jobDate";
 document.editJobsMarineForm.dateFlag.value=flag;
  if(flag=='true')
 document.editJobsMarineForm.openPeriodsFlag.value="true";
 else
 document.editJobsMarineForm.openPeriodsFlag.value="false";
 document.editJobsMarineForm.submit();
 }
...
document.editJobsMarineForm.showWarn.value="false";
}
 function warnUser(navigationUrl)
{
  if(document.editJobsMarineForm.warnUserFlag.value == 'warn' || document.editJobsMarineForm.warnUserFlag.value == 'warned')
    document.editJobsMarineForm.warnUserFlag.value = 'navigate';
  else
    document.editJobsMarineForm.warnUserFlag.value = "warn";
    
  document.editJobsMarineForm.navigationUrl.value = navigationUrl;
  document.editJobsMarineForm.submit();
}
...
<form:form name="editJobsMarineForm" method="POST" action="edit_job_entry_marine.htm">
    ...
    <div id="tab1" class="innercontent">
        ...
        <table width="100%" align="right" cellpadding="0" cellspacing="0">
            ...
            <f:message key="status" />: <form:select id="sel1"
              cssClass="selectionBox" path="jobOrder.jobStatus" onchange="popCancelReason('${command.jobOrder.jobNumber}')"
              ...
              id="jobSearch" size="12" cssClass="inputBox" path="searchString" /> <form:errors
              path="searchString" cssClass="redstar" /> <input name="Submit2"
              type="button" class="button1" value="Go" style="height:18px;"
              onclick="javascript:checkSearchField();" onkeypress="if(event.keyCode==13) {checkSearchField();}"/-->
...
<form:select id="projectTypes" cssClass="selectionBox" path="phxProjectType" items="${command.projectTypes}" itemLabel="name" itemValue="value" disabled="${command.projectTypeViewOnly}" />
		...
		<!-- END : #119240 -->			  
              ...
              onclick="updateJobDescription('${command.dateFormat}');setTabName('0');checkcount('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}');
        ...
        <form:input id="brnch" disabled="true" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;"
...
<td class="TDShadeBlue"><form:select id="sel10" cssClass="selectionBoxbig" path="jobOrder.operation"  items="${icbfn:dropdown('jobOperations', operations)}" itemLabel="name" itemValue="value" disabled="${command.viewOnly && !(reopenViewOnly && (empty command.jobOrder.operation || empty fn:trim(command.jobOrder.operation)))}"/> <form:errors path="jobOrder.operation" cssClass="redstar" /></td>

                <td class="TDShade"><strong><f:message key="receivedBy"/>: </strong></td>
                <td colspan="2" class="TDShadeBlue"><form:input cssClass="inputBox" size="52" maxlength="128" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" path="jobOrder.receivedByUserName" disabled="${command.viewOnly}"/>
        <form:errors path="jobOrder.receivedByUserName" cssClass="redstar"/>
    <c:if test="${!command.viewOnly}">
                   <a href="#" onClick="javascript:popup_show('receivedby','receivedby_drag','receivedby_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('receivedby','receivedbybody');popupboxenable();"> <img src=" images/lookup.gif" alt="Lookup receivedBy" width="13" height="13" border="0" /></a>
           </c:if></td>
              </tr>
              <tr>
        ...
        <a href="#" onClick="displayCalendar(document.forms[0].quotedate,'dd/mm/yyyy',this)"> <img src=" images/calendar.gif" width="15" height="17"  align="absmiddle" border="0"/></a> &nbsp;&nbsp;<strong><f:message key="quoteID"/>:</strong></td>
                ...
                <td colspan="2" class="TDShadeBlue"><form:input id="finishdate" cssClass="inputBox" path="jobOrder.jobFinishDate" onchange="selectJobDate('true','finishdate');" disabled="${command.viewOnly && !(reopenViewOnly && empty command.jobOrder.jobFinishDate)}"/>
    ...
    showInvoiceWarn();
      ...
      <c:when test="${command.userTimeFormat != 'AM/PM'}">
                ...
                <td class="TDShadeBlue"><form:input id="nomdate" cssClass="inputBox" path="jobOrder.nominationDate" disabled="${command.viewOnly && !(reopenViewOnly && empty command.jobOrder.nominationDate)}"/>
    ...
    <c:if test="${!command.viewOnly || (reopenViewOnly && empty command.jobOrder.nominationDate)}">
     ...
     &nbsp;&nbsp;<f:message key="time"/>:&nbsp;
         ...
         <form:input size="3" cssClass="inputBox" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" path="jobOrder.nominationTimeTz" disabled="${command.viewOnly && !(reopenViewOnly && empty command.jobOrder.nominationTimeTz)}"/>
     ...
     <c:otherwise>
      ...
      <f:message
       ...
       <form:select
              ...
              cssClass="redstar" />
      <form:input
          size="3" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" cssClass="inputBox" path="jobOrder.nominationTimeTz" disabled="${command.viewOnly && !(reopenViewOnly && empty command.jobOrder.nominationTimeTz)}"/> <form:errors
    ...
    <c:when test="${command.userTimeFormat != 'AM/PM'}">
                ...
                <td colspan="2" class="TDShadeBlue"><form:input id="etadate" cssClass="inputBox" path="jobOrder.etaDate" onchange="selectJobDate('false','etadate');" disabled="${command.viewOnly && !(reopenViewOnly && empty command.jobOrder.etaDate)}"/>
...
<!-- END: 118717,119283 Fix for new requirement - 04 June 2009 -->    
          ...
          </c:if>&nbsp;&nbsp;<f:message key="time"/>:&nbsp;
         <form:input size="4" cssClass="inputBox" id="etaTimes" path="uiEtaTime" disabled="${command.viewOnly}"/> 
         <form:errors path="uiEtaTime" cssClass="redstar" />
         <form:input size="3" cssClass="inputBox" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" path="jobOrder.etaTimeTz" disabled="${command.viewOnly && !(reopenViewOnly && empty command.jobOrder.etaTimeTz)}"/>
    ...
    <td class="TDShade"><strong><f:message key="eta" />:</strong></td>
        <td colspan="2" class="TDShadeBlue"><form:input id="etadate" size="11"
          ...
          path="jobOrder.etaDate" cssClass="redstar" />
           <!-- START: 118717,119283 Fix for new requirement - 04 June 2009 --> 
      <c:if test="${!command.viewOnly || (not empty command.jobOrder.jobFinishDate) || (not empty command.jobOrder.jobFinishDate) || (reopenViewOnly && empty command.jobOrder.etaDate)}">
		<!-- END: 118717,119283 Fix for new requirement - 04 June 2009 -->       
      <a href="#"
      ...
      <a href="#"
        ...
        <img src=" images/lookup.gif" alt="Lookup Time Zone" width="13" height="13" border="0" /></a>
              ...
              <tr>
                ...
                <td class="TDShadeBlue" >
        <form:input id="tco" cssClass="inputBox" size="52" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" maxlength="128" path="jobOrder.towingCompany.name" disabled="${command.viewOnly && !(reopenViewOnly && (empty command.jobOrder.towingCompany || empty command.jobOrder.towingCompany.name))}"/>
         ...
         'towingco_drag','towingco_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('towingco','towingbody');popupboxenable();"><img src=" images/lookup.gif" alt="Lookup Towing Company " width="13" height="13" border="0"/></a>
     </c:if></td>
                <td class="TDShade"><strong><f:message key="telephoneNo"/></strong></td>
        <td class="TDShadeBlue"> <form:input id="tphone" cssClass="inputBox" size="52" path="jobOrder.towingCompanyPhone" disabled="${command.viewOnly && !reopenViewOnly}"/>
        <form:errors path="jobOrder.towingCompanyPhone" cssClass="redstar"/></td>
              ...
              <tr>
                ...
                <td class="TDShadeBlue">
        <form:input id="shipagnt" size="52" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" cssClass="inputBox" maxlength="128" path="jobOrder.shippingAgent.name" disabled="${command.viewOnly && !(reopenViewOnly && (empty command.jobOrder.shippingAgent || empty command.jobOrder.shippingAgent.name))}"/>
         ...
         <c:if test="${!command.viewOnly || (reopenViewOnly && (empty command.jobOrder.shippingAgent || empty command.jobOrder.shippingAgent.name))}">
                  <a href="#" onClick="javascript:updateShipAgentIframeSrc();setShippingFlag();popup_show('shippingagent', 'shippingagent_drag', 'shippingagent_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('shippingagent','shippingagentbody');popupboxenable();"> <img src=" images/lookup.gif"  alt="Lookup Shipping Agent" width="13" height="13" border="0"/></a> 
          </c:if></td>
                <td class="TDShade"><strong><f:message key="telephoneNo"/></strong></td>
                <td class="TDShadeBlue">
        <form:input id="sphone" cssClass="inputBox" size="52" path="jobOrder.shippingAgentPhone" disabled="${command.viewOnly && !reopenViewOnly}"/>
        <form:errors path="jobOrder.shippingAgentPhone" cssClass="redstar"/></td>
              ...
              <tr>
                ...
                <td class="TDShadeBlue">
         <form:input id="portLoc" cssClass="inputBox" maxlength="30" size="52" onchange="javascript:changeVisibleStyle();" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" path="jobOrder.serviceLocation.city" disabled="${command.viewOnly && !(reopenViewOnly && (empty command.jobOrder.serviceLocation || empty command.jobOrder.serviceLocation.city))}"/>
      ...
      <a
        ...
        <div style="visibility: hidden; display: none;"> <form:input id="vessel" size="45"
          ...
          path="jobOrder.vesselNames"/></div>
               ...
               <%-- <td colspan="2" class="TDShadeBlue" style="border-bottom:#7c92be dashed 1px;"> ${command.jobOrder.productNames}</td>--%>
...
<div style="visibility: hidden; display: none;"> <form:input id="product" size="45"
        ...
        <a href="#" onClick="javascript:updateJobDescription('${command.dateFormat}','jobdescexist');"><f:message key="jobOrderDescription"/>:</a>
                ...
                <td colspan="4" class="TDShadeBlue"><form:textarea id="jobDesc" path="jobOrder.jobDescription" rows="5" cols="100"/>
...
<th><f:message key="contractEntry"/>
 ...
 align="absmiddle" style="margin-left:5px;margin-right:5px;"/><f:message key="jobTypeOCAMarineAndCalibrations"/>
 &nbsp;&nbsp;&nbsp;
<f:message key="status" />: <form:select id="sel1"
...
onclick="javascript:updateJobDescription('${command.dateFormat}');checkcount('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}');<%--checkDate('${command.dateFormat}','${command.userTimeFormat}');--%>"/></a></th>
</tr>
...
document.getElementById('pu').setAttribute("src","search_job_contract_insp_popup.htm?inputFieldId=inputFieldIdValue&searchForm=editJobsMarineForm&code="+code+"&pageNumber="+pageN0+"&buName="+buname+"&fromPage=6");
}
}
</script>
</c:when>
...
if(scode.charAt("/"))
{ code=scode.replace("/","'");}
document.editJobsMarineForm.ccode.value=code;
document.editJobsMarineForm.uniqueFlag.value="uniqueFlag";
document.editJobsMarineForm.submit();
}
</script>
...
<%--<td align="left"><a href="#" style="cursor:hand;" onMouseOver="doTooltip(event, '<table><tr><td width=120px><b>Scheduler ID:</b></td><td>21506 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>Company ID:</b>1320</td></tr><tr><td valign=top><b>Scheduler Address:</b></td> <td>1st   Floor, 10 Bruton Street, London, W1J 6PX, GBR </td></tr><tr><td><b>Telephone:</b></td>  <td>334-2424-222</td></tr><tr><td><b>Email Address:</b></td><td>xxxx@xxxx.com</td></tr></table>')" onMouseOut="hideTip()">${command.addJobContracts[counter.index].jobContract.contractCustContact.contact.firstName} ${command.addJobContracts[counter.index].jobContract.contractCustContact.contact.lastName}</a></td>--%>
...
<form:input cssClass="inputBox" size="41" maxlength="128" path="addJobContracts[${counter.index}].jobContract.projectNumber" disabled="true"/>
</c:when>
<c:otherwise>
<form:input cssClass="inputBox" size="41" maxlength="128" path="addJobContracts[${counter.index}].jobContract.projectNumber" disabled="${command.addJobContracts[counter.index].contractViewOnly}"/>
</c:otherwise>
</c:choose>
...
function monthlyJobcheck(index,jobnumber)
{
  if (confirm("You cannot deselect this row as a monthly header since jobs are attached.")==true)
    ...
    document.editJobsMarineForm.monthlyCheck.value="false";
}
</script>
</c:when>
</c:choose>
...
<td><form:input id="billingContactId${counter.index}" cssClass="inputBox" maxlength="19" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" size="14" path="addJobContracts[${counter.index}].jobContract.billingContact.id" disabled="${command.addJobContracts[counter.index].contractViewOnly}"/>
...
onClick="javascript:updateJobDescription('${command.dateFormat}');checkcount('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}'); <%--checkDate('${command.dateFormat}','${command.userTimeFormat}');--%>"/></a></td>
                  </tr>
                </table>
      </td>
         </tr>
...
<div class="menu_form_body" id="towingbody" style="width:750px; height:530px;overflow-y:hidden;">
<iframe id="tow" align="left" style="padding:0px; height:530px;" width="100%" scrolling="auto" src="blank.html"
name="frame1"  allowtransparency="yes"></iframe></div></div> 
...
<div class="menu_form_header" id="shippingagent_drag" style="width:750px;"> 
<img class="menu_form_exit" id="shippingagent_exit" src=" images/form_exit.png"/>&nbsp;&nbsp;&nbsp; <f:message key="selectShippingAgent"/> </div>
<div class="menu_form_body" id="shippingagentbody" style="width:750px; height:530px;overflow-y:hidden;">
<iframe id="ship" align="left" frameborder="0" style="padding:0px; height:530px;" width="100%" scrolling="auto" id="frame2" name="frame2" allowtransparency="yes" src="blank.html"></iframe></div></div>
...
<iframe id="serv" align="left" frameborder="0" style="padding:0px; height:980px;  width:980px" " width="100%" scrolling="auto" id="frame3" name="frame3" allowtransparency="yes" src="blank.html"></iframe></div></div>
<!-- --------------------------------- ServiceLocation Lookup END ----------------------------------------- -->
<!-- --------------------------------- Port Lookup START ----------------------------------------- -->
<div class="sample_popup" id="port" style="visibility: hidden; display: none;">
<div class="menu_form_header" id="port_drag" style="width:980px;">
<img class="menu_form_exit" id="port_exit" src=" images/form_exit.png" />&nbsp;&nbsp;&nbsp;
<f:message key="selectPortLocation" /></div>
...
<img class="menu_form_exit"   id="etatimezone_exit" src=" images/form_exit.png" />&nbsp;&nbsp;&nbsp;
...
<div class="menu_form_header" id="receivedby_drag" style="width:750px;"> <img class="menu_form_exit"   id="receivedby_exit" src="images/form_exit.png" /> &nbsp;&nbsp;&nbsp;<f:message key="searchUser"/></div>
<div class="menu_form_body" id="receivedbybody" style="width:750px; height:530px;overflow-y:hidden;padding-left:4px;">
<iframe align="left" frameborder="0" style="padding:0px;" height="530px" width="100%" src="search_user_popup.htm?inputFieldId=jobOrder.receivedByUserName&div1=receivedby&div2=receivedbybody" scrolling="auto" id="searchAccountOwnerFr" name="searchAccountOwnerFr" allowtransparency="yes" ></iframe></div></div>
...
try{
			...
			if('' != objFnshDate.value && objFnshDate.value.length > 0){						
				document.editJobsMarineForm.uiEtaTime.disabled = false;
				if(document.editJobsMarineForm.etaTimeFormat){
					document.editJobsMarineForm.etaTimeFormat.disabled = false;
				}
