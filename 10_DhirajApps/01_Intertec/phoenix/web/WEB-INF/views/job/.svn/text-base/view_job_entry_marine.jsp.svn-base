...
function submitform()
    {
      populatePhone();
      top.document.editJobsMarineForm.submit();
      
    }
 function setTowingCoFlag()
  {
    
    document.editJobsMarineForm.towingCompFlag.value="towingCompany";
  
  }
    function setShippingFlag()
  {
        
    document.editJobsMarineForm.shippingAgentFlag.value="shippingAgent";
    
  }
   function setServiceLcoationFlag()
  {
        
    document.editJobsMarineForm.serviceLocationFlag.value="servicelocation";
    
  }
  function updateTowCoIframeSrc()
  {
  var towingCoName= document.getElementById("tco").value;
  //var branchName=document.getElementById("sel4").value;
  var branchName=document.getElementById("brnch").value;

  
  if(towingCoName!= "" && towingCoName!= null)
  {
    document.getElementById('tow').setAttribute("src","search_towingcompany_popup.htm?inputFieldId=jobOrder.towingCompany.name&branchName="+branchName+"&tcoName="+towingCoName);
  }else
  {
    document.getElementById('tow').setAttribute("src","search_towingcompany_popup.htm?inputFieldId=jobOrder.towingCompany.name&branchName="+branchName+"&tcoName="+towingCoName);
  ...
  {
  var shippingAgentName= document.getElementById("shipagnt").value;
  //var branchName=document.getElementById("sel4").value;
  var branchName=document.getElementById("brnch").value;

  if(shippingAgentName != "" && shippingAgentName != null)
  {
      document.getElementById('ship').setAttribute("src","search_shippingagent_popup.htm?inputFieldId=jobOrder.shippingAgent.name&shipAgentName="+shippingAgentName+"&branchName="+branchName);
  ...
  {
      document.getElementById('serv').setAttribute("src","search_serviceLocation_popup.htm?inputFieldId=jobOrder.serviceLocation.name&serviceLcoationName="+serviceLocationName + "&portLocationName=" + portLocationName+"&branchName="+branchName);
...
function setform()
{
  ...
  if (isAdd(code.value) == false) {
    ...
    document.editJobsMarineForm.ccode.focus();
  document.editJobsMarineForm.ccode.value="";
  return false;
    }
  ...
  document.editJobsMarineForm.uniqueFlag.value="uniqueFlag";
  populatePhone();
    document.editJobsMarineForm.submit();
  } 
}
...
{
document.editJobsMarineForm.jobFlag.value="none";
document.editJobsMarineForm.jobIndex.value = index;
document.editJobsMarineForm.deleteFlag.value ="delval";
populatePhone();
document.editJobsMarineForm.submit();
}
}
...
function setsubflag()
{
document.editJobsMarineForm.jobValFlag.value="newjobval";
document.editJobsMarineForm.tabName.value = "1";
}

function setcontactflag(rowIndex)
{
document.editJobsMarineForm.jobFlag.value="none";
document.editJobsMarineForm.contactIndex.value=rowIndex;
document.editJobsMarineForm.contactFlag.value="contFlag";
document.editJobsMarineForm.tabName.value="1";
}

function setAttachFilesFlag(rowIndex)
{
document.editJobsMarineForm.attachFilesFlag.value=rowIndex;
document.editJobsMarineForm.tabName.value="1";
}
...
{
document.editJobsMarineForm.nextPageFlag.value = "1";
populatePhone();
...
{
document.editJobsMarineForm.jobFlag.value="none";
document.editJobsMarineForm.popFlag.value="none";
document.editJobsMarineForm.contactFlag.value="none";
  document.editJobsMarineForm.uniqueFlag.value="none";
  setpage();
}
  function updateJobDescription(urllink)
  {
  
   var w = document.editJobsMarineForm.sel10.selectedIndex;
   var ops_text = document.editJobsMarineForm.sel10.options[w].text;
 ...
 if(finishDate != "" && finishDate != null)
  ...
  if(date == null)
  date="";
  var desc=ops_text+" "+"of"+" "+product+","+vessel+" "+"on"+" "+date+" "+"at"+" "+servLoc+","+portLoc+".";
   if(urllink=="")
    {
...
function updateDescription(index)
{
  ...
  function nextList()
  {
    //document.editJobsMarineForm.nextListFlag.value="next";
    document.editJobsMarineForm.showNextListFlag.value="next";
    populatePhone();
	// START : #119240
	document.editJobsMarineForm.shippingAgentFlag.value="none";
	document.editJobsMarineForm.towingCompFlag.value="none";
	document.editJobsMarineForm.serviceLocationFlag.value="none";
	document.editJobsMarineForm.shipAgentPhoneFlag.value="none";
	document.editJobsMarineForm.towCoPhoneFlag.value="none";
	document.editJobsMarineForm.deleteFlag.value="none";
	document.editJobsMarineForm.jobFlag.value="none";
	document.editJobsMarineForm.contactFlag.value="none";
	document.editJobsMarineForm.uniqueFlag.value="none";
	document.editJobsMarineForm.bankFlag.value="none";
	// END : #119240
    document.editJobsMarineForm.submit();
  }
  ...
  function prevList()
  {
    //document.editJobsMarineForm.prevListFlag.value="prev";
    document.editJobsMarineForm.showPrevListFlag.value="prev";
    populatePhone();
	// START : #119240
	document.editJobsMarineForm.shippingAgentFlag.value="none";
	document.editJobsMarineForm.towingCompFlag.value="none";
...
function noPrevList()
{
	document.editJobsMarineForm.noPrevJob.value="true";
	document.editJobsMarineForm.submit();
}

function noNextList()
{
	document.editJobsMarineForm.noNextJob.value="true";
	document.editJobsMarineForm.submit();
}
// END : #119240
...
{
document.editJobsMarineForm.tabName.value=val;
}
 function populatePhone()
 {
  var shipPhone= document.getElementById("sphone").value;
  var towCoPhone= document.getElementById("tphone").value;
  
  
  if(shipPhone!=null)
    document.editJobsMarineForm.shipAgentPhoneFlag.value=shipPhone;
  if(towCoPhone!=null)
    document.editJobsMarineForm.towCoPhoneFlag.value=towCoPhone;
...
document.getElementById('searchContactFr'+index).setAttribute("src","search_contact_popup.htm?inputFieldId=addJobContracts["+index+"].jobContract.billingContact.id&rowNum="+index+"&searchForm=editJobsMarineForm&divName=searchbillingcontact"+index+"&divbody=contactbody"+index+"&custCode="+customercode);
}

function setbankFlag(index){
document.editJobsMarineForm.bankFlag.value="bankFlag";
document.editJobsMarineForm.tabName.value="1";
document.editJobsMarineForm.bankIndex.value=index;
 document.editJobsMarineForm.submit();
}
...
<form:form name="editJobsMarineForm" method="POST" action="view_job_entry_marine.htm">
...
<!--------------------------------------------------------------------------------------- TAB 1 CONTAINER ------------------------------------------------------------------------------------------------->
    ...
    <div id="tab1" class="innercontent">
          <table width="100%" cellpadding=0 cellspacing=0 class=mainApplTable>
            <tbody>
              <tr bgcolor=#ffffff>
                <th width="50%" colspan=2 nowrap><f:message key="headerDetails"/> <img src=" images/separator2.gif" width="2" height="27"  align="absmiddle" style="margin-left:5px;margin-right:5px;"/><f:message key="jobId"/>: ${command.jobOrder.jobNumber}<img src=" images/separator2.gif" width="2" height="27" align="absmiddle" style="margin-left:5px;margin-right:5px;"/><f:message key="jobTypeOCAMarineAndCalibrations"/></th>
                <th colspan=3 width="50%" style="text-align:right">
        <table width="104%" align="right" cellpadding="0" cellspacing="0">
            <th nowrap
...
<form:select id="projectTypes" cssClass="selectionBox" path="phxProjectType" items="${command.projectTypes}" itemLabel="name" itemValue="value" disabled="${command.projectTypeViewOnly}" />
		...
		<!-- END : #119240 -->	  
              ...
              onclick="updateJobDescription();setTabName('0');checkDate();"><img src="images/icosave.gif"
              ...
              <tr>
                ...
                <td width="35%" class="TDShadeBlue"><span class="id_input">
                   <form:select id="sel3" disabled="true" cssClass="selectionBoxbig" path="jobOrder.buName" items="${icbfn:dropdown('businessUnit', null)}" itemLabel="name" itemValue="value" onchange="makeBranchblank()"/>
        ...
        <form:input id="brnch" disabled="true" 
          cssClass="inputBox" size="52" path="jobOrder.branchName"/>
...
<td class="TDShadeBlue"><form:select disabled="true" id="sel10" cssClass="selectionBoxbig" path="jobOrder.operation"  items="${icbfn:dropdown('jobOperations', operations)}" itemLabel="name" itemValue="value" /> <form:errors path="jobOrder.operation" cssClass="redstar" /></td>

                <td class="TDShade"><strong><f:message key="receivedBy"/>: </strong></td>
                <td colspan="2" class="TDShadeBlue"><form:input size="52" disabled="true" cssClass="inputBox" maxlength="128"  path="jobOrder.receivedByUserName" />
        <form:errors path="jobOrder.receivedByUserName" cssClass="redstar"/>
                   <a href="#" onClick="javascript:popup_show('receivedby','receivedby_drag','receivedby_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('receivedby','receivedbybody');popupboxenable();"><%-- <img src=" images/lookup.gif" width="13" height="13" border="0" /> --%></a></td>
              </tr>
              <tr>
                <td class="TDShade"><f:message key="quoteIssuedDate"/>:</td>
                <td class="TDShadeBlue">
        <input name="textfield92" type="text" class="inputBox" size="23" disabled="true"/>
        
         &nbsp;&nbsp;<strong><f:message key="quoteID"/>:</strong></td>
                <td class="TDShade"><f:message key="jobFinishedDate"/>: </td>
                <td colspan="2" class="TDShadeBlue"><form:input disabled="true" size="52" id="finishdate" cssClass="inputBox" path="jobOrder.jobFinishDate"/>
        <form:errors path="jobOrder.jobFinishDate" cssClass="redstar"/>
                 </td>
              </tr>
              <tr>
                <td class="TDShade"><strong><f:message key="nominationDate"/>:<span class="redstar">*</span></strong></td>
                <td class="TDShadeBlue"><form:input id="nomdate" size="23" disabled="true" cssClass="inputBox" path="jobOrder.nominationDate"/>
        <form:errors path="jobOrder.nominationDate" cssClass="redstar"/>
        &nbsp;&nbsp;<f:message key="time"/>:&nbsp;
         <form:input size="4" disabled="true" cssClass="inputBox" path="uiNominationTime" /> 
         <form:errors path="uiNominationTime" cssClass="redstar" />
         <form:input size="4" disabled="true" cssClass="inputBox" path="jobOrder.nominationTimeTz"/>
         <form:errors path="jobOrder.nominationTimeTz" cssClass="redstar"/>
               <a href="#" onClick="javascript:popup_show('timezone','timezone_drag','timezone_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('timezone','timezonebody');popupboxenable();"><%-- <img src=" images/lookup.gif" width="13" height="13" border="0" /> --%></a>
        
                  <div id="debug"></div></td>
                <td class="TDShade"><strong><f:message key="eta"/>:</strong></td>
                <td colspan="2" class="TDShadeBlue"><form:input size="23" id="etadate" disabled="true" cssClass="inputBox" path="jobOrder.etaDate"/>
        <form:errors path="jobOrder.etaDate" cssClass="redstar"/>
                  &nbsp;&nbsp;<f:message key="time"/>:&nbsp;
         <form:input size="4" disabled="true" cssClass="inputBox" path="uiEtaTime" /> 
         <form:errors path="uiEtaTime" cssClass="redstar" />
         <form:input disabled="true" size="4" cssClass="inputBox" path="jobOrder.etaTimeTz"/>
         <form:errors path="jobOrder.etaTimeTz" cssClass="redstar"/>
         <a href="#" onClick="javascript:popup_show('etatimezone','etatimezone_drag','etatimezone_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('etatimezone','etatimezonebody');popupboxenable();"><%-- <img src=" images/lookup.gif" width="13" height="13" border="0" /> --%></a>
                 </td>
              </tr>
              <tr>
                <td class="TDShade" ><strong><f:message key="towingCompany"/>:</strong></td>
                <td class="TDShadeBlue" >
        <form:input disabled="true" id="tco" size="52" cssClass="inputBox" maxlength="128" path="jobOrder.towingCompany.name"/>
         <form:errors path="jobOrder.towingCompany.name" cssClass="redstar"/>
        
         <a href="#"onClick="javascript:updateTowCoIframeSrc();setTowingCoFlag();popup_show('towingco',
         'towingco_drag','towingco_exit', 'screen-corner', 40,80);hideIt();showPopupDiv('towingco','towingbody');popupboxenable();"><%-- <img src=" images/lookup.gif" width="13" height="13" border="0"/> --%></a></td>
                <td class="TDShade"><strong><f:message key="telephoneNo"/></strong></td>
        <td class="TDShadeBlue"> <form:input disabled="true" id="tphone" cssClass="inputBox" size="52" path="jobOrder.towingCompanyPhone"/>
        <form:errors path="jobOrder.towingCompanyPhone" cssClass="redstar"/></td>
              ...
              <tr>
                ...
                <td class="TDShadeBlue">
        <form:input size="52" id="shipagnt" disabled="true" cssClass="inputBox" maxlength="128" path="jobOrder.shippingAgent.name"/>
         <form:errors path="jobOrder.shippingAgent.name" cssClass="redstar"/>
        
                  <a href="#" onClick="javascript:updateShipAgentIframeSrc();setShippingFlag();popup_show('shippingagent', 'shippingagent_drag', 'shippingagent_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('shippingagent','shippingagentbody');popupboxenable();"><%-- <img src=" images/lookup.gif" width="13" height="13" border="0"/> --%></a> </td>
                <td class="TDShade"><strong><f:message key="telephoneNo"/></strong></td>
        <td class="TDShadeBlue">
         <form:input disabled="true" id="sphone" cssClass="inputBox" size="52" path="jobOrder.shippingAgentPhone"/>
        <form:errors path="jobOrder.shippingAgentPhone" cssClass="redstar"/></td>
              ...
              <tr>
                ...
                <td class="TDShadeBlue">
         <form:input size="52" id="portLoc" disabled="true" cssClass="inputBox"  maxlength="30" path="jobOrder.serviceLocation.city"/>
         <form:errors path="jobOrder.serviceLocation.city" cssClass="redstar"/> 
                  </td> 
                <td class="TDShade"><strong><f:message key="serviceLocation"/>:<span class="redstar">*</span></strong></td>
                <td colspan="2" class="TDShadeBlue">
         <form:input size="52" id="serviceLoc" disabled="true" cssClass="inputBox" maxlength="254" path="jobOrder.serviceLocation.name"/>
         <form:errors path="jobOrder.serviceLocation.name" cssClass="redstar"/>

                  <a href="#" onClick="javascript:updateServiceLocationIframeSrc();setServiceLcoationFlag();popup_show('servloc','servloc_drag','servloc_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('servloc','servlocbody');popupboxenable();"><%-- <img src="images/lookup.gif" width="13" height="13" border="0"/> --%></a></td>
              </tr>
               <tr>
                <td class="TDShade" style="border-bottom:#7c92be dashed 1px; "><strong><f:message key="vessel"/>:</strong></td>
                <td class="TDShadeBlue" style="border-bottom:#7c92be dashed 1px;">${command.jobOrder.vesselNames}</td>
        <div style="visibility: hidden; display: none;"> <form:input id="vessel" size="45"
          ...
          path="jobOrder.vesselNames"/></div>
                <td class="TDShade" style="border-bottom:#7c92be dashed 1px;"><strong><f:message key="product"/>:</strong></td>
                <td colspan="2" class="TDShadeBlue" style="border-bottom:#7c92be dashed 1px;"> ${command.jobOrder.productNames}</td><div style="visibility: hidden; display: none;"> <form:input id="product" size="45"
          cssClass="inputBox" maxlength="254"
          path="jobOrder.productNames"/></div>
              </tr>
              <tr>
                <td valign="top" class="TDShade" ><strong><f:message key="jobDescription"/>:</strong></td>
                <td colspan="4" class="TDShadeBlue"><form:textarea disabled="true" id="jobDesc" path="jobOrder.jobDescription" rows="5" cols="100"/>
     ...
     <%--     <c:choose>
      ...
      <td>&nbsp;</td>
		...
		<!-- END : #119240 -->	  
					<a href="#" onClick="goToNextPage()"><img src=" images/savennextbluarrow.gif" alt="Save and Go to Next Page" width="14" height="14" hspace="4" border="0" align="absmiddle" title="Save and Go to Next Page"></a><a href="#" onClick="javascript:updateJobDescription();checkDate();"><img src=" images/icosave.gif" alt="Save" title="Save" width="14" height="14" border="0" align="absmiddle" /></a></td>
                  </tr>
                </table></td>
            </tr>
          </table>
 ...
 <ajax:autocomplete
  ...
  target="jobOrder.towingCompanyPhone"
  ...
  source="jobOrder.shippingAgent.name"
  target="jobOrder.shippingAgentPhone"
  className="autocomplete"
  parameters="shippingAgent.name={jobOrder.shippingAgent.name}"
  minimumCharacters="3"
   /> 
    <ajax:autocomplete
  baseUrl="servicelocation.htm"
  source="jobOrder.serviceLocation.name"
  target="jobOrder.serviceLocation.city"
  className="autocomplete"
...
<th><f:message key="contractEntry"/>
 ...
 <f:message key="jobTypeOCAMarineAndCalibrations"/>&nbsp;&nbsp;&nbsp;
...
onclick="javascript:updateJobDescription();checkDate();"/></a></th>
</tr>
...
<tr>
<iframe id="pu" align="left" frameborder="0" style="padding:0px;" height="400px;" width="100%"  scrolling="auto" id="searchjobContractFr"
src="blank.html"
...
function setflag()
{  
document.editJobsMarineForm.jobFlag.value="jobval";
document.editJobsMarineForm.tabName.value = "1";
var code= document.getElementById("ccode").value;
if(code!= "" && code!= null)
{
document.getElementById('pu').setAttribute("src","search_job_contract_insp_popup.htm?inputFieldId=inputFieldIdValue&searchForm=editJobsMarineForm&code="+code+"&fromPage=10");
}
}
</script>
</c:when>
...
<form:select disabled="true" id="jobContractStatus${counter.index}" cssClass="selectionBox" path="addJobContracts[${counter.index}].jobContract.jobContractStatus" items="${icbfn:dropdown('staticDropdown',jobContractStatus)}"   itemLabel="name" itemValue="value" onchange="checkForRebill('jobContractStatus${counter.index}')"/> 
</c:when>
<c:otherwise>
...
<td><form:input disabled="true" cssClass="inputBox" maxlength="128" path="addJobContracts[${counter.index}].jobContract.projectNumber"/>
 <form:errors path="addJobContracts[${counter.index}].jobContract.projectNumber" cssClass="redstar"/>
<%--  <a href="#" onClick="javascript:popup_show('searchprojects${counter.index}','searchprojects_drag${counter.index}','searchprojects_exit${counter.index}', 'screen-corner', 120, 20);showPopupDiv('searchprojects${counter.index}','searchprojectsbody${counter.index}');hideIt();popupboxenable();"><img src="images/lookup.gif" width="13" height="13" border="0"/>--%></a></td>
</c:otherwise>
</c:choose>


<td id="mjobid${counter.index}" class="TDShadeGrey"><f:message key="monthlyJobId"/>:</td>
<td> <form:input disabled="true" id="monjobnumber${counter.index}" cssClass="inputBox" size="41" maxlength="128" path="addJobContracts[${counter.index}].jobContract.monthlyJobNumber" />
<form:errors path="addJobContracts[${counter.index}].jobContract.monthlyJobNumber" cssClass="redstar"/>
<form:checkbox disabled="true" id="monFlag${counter.index}"   path="addJobContracts[${counter.index}].jobContract.monthlyFlag" value="Y"  onclick="monjobnumberFlag('${counter.index}','${command.jobOrder.jobNumber}')"/></td></tr>


<tr>
<td width="25%" class="TDShadeGrey"><f:message key="origin"/></td>
<td width="30%"><form:select disabled="true" id="sel1" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.custSentBy" items="${icbfn:dropdown('staticDropdown',origin)}" itemLabel="name" itemValue="value"/></td>
...
<td><form:select disabled="true" id="sel6" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.language" items="${icbfn:dropdown('staticDropdown',selectedLanguage)}" itemLabel="name" itemValue="value"/></td>
...
<td><form:select disabled="true" id="sel3" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.transactionCurrencyCd" items="${icbfn:dropdown('currencyTrans', currencies)}" itemLabel="name" itemValue="value"/></td>
...
<td><form:select disabled="true" id="sel4" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.productType" items="${icbfn:dropdown('productType', null)}" itemLabel="name" itemValue="value"/></td>
...
<td><form:select id="sel15" disabled="true" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.locationDesc" items="${icbfn:dropdown('portCode', contracts)}" itemLabel="name" itemValue="value" /></td> 
...
<form:select id="sel9" disabled="true" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.zone" items="${icbfn:dropdown('zoneId', pcodes)}" itemLabel="name" itemValue="value" />
</td>
...
<td><form:input cssClass="inputBox" maxlength="19" size="18" disabled="true" path="addJobContracts[${counter.index}].jobContract.billingContact.id"/>
...
<form:input  cssClass="inputBox"  size="10" maxlength="50" path="addJobContracts[${counter.index}].jobContract.billingContactName" disabled="true"/>
...
<td>
<form:select id="sel6" disabled="true" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.invoiceType" items="${icbfn:dropdown('staticDropdown',invoiceType)}" itemLabel="name" itemValue="value"/> </td>
</tr>
...
<td><form:input id="remitto${counter.index}" cssClass="inputBox" size="12"  disabled="true" maxlength="5" path="addJobContracts[${counter.index}].jobContract.bankCd"/>
...
<td><form:select id="sel7" disabled="true" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.pymntType" items="${icbfn:dropdown('staticDropdown',paymentType)}" itemLabel="name" itemValue="value"/></td>
<td class="TDShadeGrey"><f:message key="paymentterms"/>:</td>
<td><form:select id="sel8" disabled="true" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.pymntTermsCd" items="${icbfn:dropdown('paymentTerms', null)}" itemLabel="name" itemValue="value"/></td>
</tr>
<tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="applTableBot">
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                   <td>&nbsp;</td>
                    <td style="text-align:right"><a href="#" onClick="updateJobDescription();goToNextPage()"><img src="images/savennextbluarrow.gif" alt="Save and Go to Next Page" width="14" height="14" hspace="4" border="0" align="absmiddle" title="Save and Go to Next Page"></a><a href="#"><img src="images/icosave.gif" alt="Save" title="Save" width="14" height="14" border="0"  
          onclick="javascript:updateJobDescription();checkDate();"/></a></td>
                  </tr>
                </table>
      </td>
         </tr>
...
<!-- ----------------------------------- Towing Company Lookup ------------------------------------------------- -->
  ...
  <div class="menu_form_header" id="towingco_drag" style="width:650px; "> 
  <img class="menu_form_exit" id="towingco_exit" src="images/form_exit.png"/>&nbsp;&nbsp;&nbsp;
  <f:message key="selectTowingCompany"/></div>
  <div class="menu_form_body" id="towingbody" style="width:650px; height:275px;">
  <iframe id="tow" align="left" style="padding:0px; height:275px;" width="100%" scrolling="auto" src="blank.html"
   name="frame1"  allowtransparency="yes" ></iframe>
...
<!-- --------------------------------- Shipping Agent Lookup  ----------------------------------------- -->
  ...
  <div class="menu_form_header" id="shippingagent_drag" style="width:650px;"> 
  <img class="menu_form_exit" id="shippingagent_exit" src=" images/form_exit.png"/>&nbsp;&nbsp;&nbsp; <f:message key="selectShippingAgent"/> </div>
  <div class="menu_form_body" id="shippingagentbody" style="width:675px; height:275px;">
   <iframe id="ship" align="left" frameborder="0" style="padding:0px; height:275px;" width="100%" scrolling="auto" id="frame2" name="frame2" allowtransparency="yes" src="blank.html"></iframe>
...
<div class="sample_popup" id="servloc" style="visibility: hidden; display: none;">
  <div class="menu_form_header" id="servloc_drag" style="width:650px; "> 
  <img class="menu_form_exit"   id="servloc_exit" src=" images/form_exit.png" />&nbsp;&nbsp;&nbsp; <f:message key="selectServiceLocation"/> </div>
  <div class="menu_form_body" id="servlocbody" style="width:650px; height:260px;">
    
  <iframe id="serv" align="left" frameborder="0" style="padding:1px; height:260px;" width="100%" scrolling="auto" id="frame3" name="frame3" allowtransparency="yes" src="blank.html"></iframe>
...
<div class="sample_popup" id="receivedby" style="visibility: hidden; display: none;">
  <div class="menu_form_header" id="receivedby_drag" style="width:300px;"> <img class="menu_form_exit"   id="receivedby_exit" src="images/form_exit.png" /> &nbsp;&nbsp;&nbsp;<f:message key="searchUser"/></div>
  <div class="menu_form_body" id="receivedbybody" style="width:300px; height:250px;padding-left:4px;">
  <iframe align="left" frameborder="0" style="padding:0px;" height="250px" width="100%" src="search_user_popup.htm?inputFieldId=jobOrder.receivedByUserName&div1=receivedby&div2=receivedbybody" scrolling="auto" id="searchAccountOwnerFr" name="searchAccountOwnerFr" allowtransparency="yes" ></iframe>
 </div>
</div>
