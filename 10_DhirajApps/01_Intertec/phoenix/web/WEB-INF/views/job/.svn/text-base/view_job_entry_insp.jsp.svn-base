...
function populatePhone() {
  ...
  if(shipPhone!=null)  {    
    document.editJobsInspForm.shipAgentPhoneFlag.value=shipPhone;   
   }
  if(towCoPhone!=null)   {
    document.editJobsInspForm.towCoPhoneFlag.value=towCoPhone;    
   }
 }
...
document.getElementById('searchContactFr'+index).setAttribute("src","search_contact_popup.htm?inputFieldId=addJobContracts["+index+"].jobContract.billingContact.id&rowNum="+index+"&searchForm=editJobsInspForm&divName=searchbillingcontact"+index+"&divbody=contactbody"+index+"&custCode="+customercode);
}
...
<form:form name="editJobsInspForm" method="POST"  action="view_job_entry_insp.htm">
...
<form:select id="projectTypes" cssClass="selectionBox" path="phxProjectType" items="${command.projectTypes}" itemLabel="name" itemValue="value" disabled="${command.projectTypeViewOnly}" />
		...
		<!-- END : #119240 -->	
			  <a
              href="#" onClick="javascript:checkContactIds('${fn:length(command.addJobContracts)}');goToNextPage()"><img
              ...
              onclick="javascript:updateJobDescription();setTabName('0');checkContactIds('${fn:length(command.addJobContracts)}');checkDate();"><img src="images/icosave.gif"
      ...
      <tr>
        ...
        <form:input id="brnch" size="52" disabled="true" 
...
<td class="TDShadeBlue"><form:select id="sel5" disabled="true"  cssClass="selectionBoxbig" path="jobOrder.operation"  items="${icbfn:dropdown('jobOperations', operations)}" itemLabel="name" itemValue="value" /> <form:errors path="jobOrder.operation" cssClass="redstar" /></td>



        <td class="TDShade"><strong><f:message
          key="receivedBy" />: </strong></td>
        <td colspan="2" class="TDShadeBlue"><form:input disabled="true"
          cssClass="inputBox" maxlength="128" size="52" 
          path="jobOrder.receivedByUserName" /> <form:errors
          path="jobOrder.receivedByUserName" cssClass="redstar" /> <a
          href="#"
          onClick="javascript:popup_show('receivedby','receivedby_drag','receivedby_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('receivedby','receivedbybody');popupboxenable();">
      ...
      <tr>
        ...
        <td class="TDShadeBlue"><input name="textfield92" type="text"
          class="inputBox" size="23" disabled="true" /> <a href="#"
          onClick="displayCalendar(document.forms[0].quotedate,'dd/mm/yyyy',this)">
        ...
        <td colspan="2" class="TDShadeBlue"><form:input id="finishdate" size="52" disabled="true"
          cssClass="inputBox" path="jobOrder.jobFinishDate"/> <form:errors
          path="jobOrder.jobFinishDate" cssClass="redstar" /> <a href="#"
          onClick="javascript:displayCalendar(document.forms[0].finishdate,'dd/mm/yyyy',this);">
        <%-- <img src=" images/calendar.gif" width="15" height="17"
          align="absmiddle" border="0" /> --%></a></td>
      </tr>
      <tr>
        <td class="TDShade"><strong><f:message
          key="nominationDate" />:<span class="redstar">*</span></strong></td>
        <td class="TDShadeBlue"><form:input id="nomdate" size="23" disabled="true"
          cssClass="inputBox" path="jobOrder.nominationDate" /> <form:errors
          path="jobOrder.nominationDate" cssClass="redstar" /> <a href="#"
          onClick="displayCalendar(document.forms[0].nomdate,'dd/mm/yyyy',this)">
        <%-- <img src=" images/calendar.gif" width="15" height="17"
          align="absmiddle" border="0" /> --%> </a>&nbsp;&nbsp;&nbsp;<f:message
          key="time" />: <form:input size="4" cssClass="inputBox" disabled="true"
          path="uiNominationTime" /> <form:errors
          path="uiNominationTime" cssClass="redstar" /> <form:input disabled="true"
          size="4" cssClass="inputBox" path="jobOrder.nominationTimeTz" /> <form:errors
        ...
        <td colspan="2" class="TDShadeBlue"><form:input id="etadates" size="23" disabled="true"
          cssClass="inputBox" path="jobOrder.etaDate" /> <form:errors
          path="jobOrder.etaDate" cssClass="redstar" /> <a href="#"
          onClick="displayCalendar(document.forms[0].etadates,'dd/mm/yyyy',this)">
        <%-- <img src=" images/calendar.gif" width="15" height="17"
          align="absmiddle" border="0" /> --%> </a>&nbsp;&nbsp;&nbsp;<f:message
          key="time" />: <form:input size="4" cssClass="inputBox" disabled="true"
          path="uiEtaTime" /> <form:errors path="uiEtaTime"
          cssClass="redstar" />  <form:input size="4" disabled="true" cssClass="inputBox" 
          path="jobOrder.etaTimeTz" /> <form:errors path="jobOrder.etaTimeTz"
          cssClass="redstar" /> <a href="#"
      ...
      <tr>
        ...
        <td class="TDShadeBlue"><form:input id="tco" disabled="true" size="52" 
          cssClass="inputBox" maxlength="128"
          path="jobOrder.towingCompany.name" /> <form:errors
          path="jobOrder.towingCompany.name" cssClass="redstar" /> <a href="#"
          onClick="javascript:updateTowCoIframeSrc();setTowingCoFlag();popup_show('towingco',
         'towingco_drag','towingco_exit', 'screen-corner', 40,80);hideIt();showPopupDiv('towingco','towingbody');popupboxenable();"> <%-- <img
          src=" images/lookup.gif" width="13" height="13" border="0" /> --%> </a></td>
        <td class="TDShade"><strong><f:message
          key="telephoneNo" /></strong></td>
        <td class="TDShadeBlue"><form:input disabled="true" id="tphone" size="52"
          cssClass="inputBox" path="jobOrder.towingCompanyPhone" /> <form:errors
      ...
      <tr>
        ...
        <td class="TDShadeBlue"><form:input id="shipagnt" disabled="true" size="52" 
          cssClass="inputBox" maxlength="128" 
          path="jobOrder.shippingAgent.name" /> <form:errors
          path="jobOrder.shippingAgent.name" cssClass="redstar" /> <a href="#"
        ...
        <td class="TDShade"><strong><f:message
          key="telephoneNo" /></strong></td>
        <td class="TDShadeBlue"><form:input disabled="true" id="sphone" size="52"
          cssClass="inputBox" path="jobOrder.shippingAgentPhone" /> <form:errors
      ...
      <tr>
        <td class="TDShade"><strong><f:message
          key="portLocation" />:</strong></td>
        <td class="TDShadeBlue"><form:input id="portLoc" disabled="true"
          cssClass="inputBox" maxlength="30" size="52"
          path="jobOrder.serviceLocation.city" /> <form:errors
          path="jobOrder.serviceLocation.city" cssClass="redstar" /></td>
        <td class="TDShade"><strong><f:message
          key="serviceLocation" />:<span class="redstar">*</span></strong></td>
        <td colspan="2" class="TDShadeBlue"><form:input id="serviceLoc" disabled="true" size="52" 
          ...
          href="#"
          onClick="javascript:updateServiceLocationIframeSrc();setServiceLcoationFlag();popup_show('servloc','servloc_drag','servloc_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('servloc','servlocbody');popupboxenable();">
        <%-- <img src="images/lookup.gif" width="13" height="13" border="0" /> --%> </a></td>
      </tr>
      <tr>
      ...
      <tr>
        <td valign="top" class="TDShade"><strong><f:message
          key="jobDescription" />:</strong></td>
        <td colspan="4" class="TDShadeBlue"><form:textarea id="jobDesc" disabled="true"
          path="jobOrder.jobDescription" rows="5" cols="100" /> <form:errors
  ...
  <table width="100%" border="0" cellpadding="0" cellspacing="0"
    ...
    <tr>
      ...
      <td>&nbsp;</td>
		...
		<!-- END : #119240 -->	
		  <a href="#" onClick="goToNextPage()"><img
            src=" images/savennextbluarrow.gif" alt="Save and Go to Next Page"
            width="14" height="14" hspace="4" border="0" align="absmiddle"
            title="Save and Go to Next Page"></a><a href="#"
            onclick="javascript:updateJobDescription();checkDate();"><img src=" images/icosave.gif"
            alt="Save" title="Save" width="14" height="14" border="0"
...
<th><f:message key="contractEntry"/>
 ...
 <f:message key="jobTypeOCAMNInspectionTesting"/>&nbsp;&nbsp;&nbsp;
...
<form:input  id="ccode" disabled="true" cssClass="inputBox" path="contractCode.value" size="50" maxlength="100"/>
...
<a href="#"  onclick="resetJobValFlag()"><img class="menu_form_exit"   id="popup_exit2" src=" images/form_exit.png" /></a> &nbsp;&nbsp;&nbsp;<f:message key="contractSearchResults"/></div>
...
if(code!= "" && code!= null)
{
document.getElementById("pu").setAttribute("src","search_job_contract_insp_popup.htm?inputFieldId=inputFieldIdValue&searchForm=editJobsInspForm&code="+code+"&fromPage=9");
}
}
</script>
</c:when>
...
<td><form:input cssClass="inputBox" maxlength="128" path="addJobContracts[${counter.index}].jobContract.projectNumber"/>
...
<td width="30%"><form:select id="sel1" disabled="true" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.custSentBy" items="${icbfn:dropdown('staticDropdown',origin)}" itemLabel="name" itemValue="value"/></td>
<td width="20%" class="TDShadeGrey"><f:message key="custRefNum"/></td>
<td><form:input cssClass="inputBox" disabled="true" size="40" maxlength="40" path="addJobContracts[${counter.index}].jobContract.custRefNum"/>
...
<td><form:select id="sel6" disabled="true" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.language" items="${icbfn:dropdown('staticDropdown',selectedLanguage)}" itemLabel="name" itemValue="value"/></td>
...
<td><form:input cssClass="inputBox" size="46" disabled="true" maxlength="64" path="addJobContracts[${counter.index}].jobContract.invoiceValue1"/>
...
<td><form:input cssClass="inputBox" size="46" maxlength="64" disabled="true" path="addJobContracts[${counter.index}].jobContract.invoiceValue2"/>
...
<td><form:select id="sel3" cssClass="selectionBoxmid" disabled="true" path="addJobContracts[${counter.index}].jobContract.transactionCurrencyCd" items="${icbfn:dropdown('currencyTrans', currencies)}" itemLabel="name" itemValue="value"/></td>
...
<td><form:input cssClass="inputBox" size="46" maxlength="64" disabled="true" path="addJobContracts[${counter.index}].jobContract.invoiceValue3"/>
...
<td><form:select id="sel4" disabled="true" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.productType" items="${icbfn:dropdown('productType', null)}" itemLabel="name" itemValue="value"/></td>
...
<td><form:input id="remitto${counter.index}" disabled="true" cssClass="inputBox" size="12" maxlength="5" path="addJobContracts[${counter.index}].jobContract.bankCd"/>
...
<f:message key="acct"/>:
<form:input cssClass="inputBox" size="12" disabled="true" maxlength="4"  path="addJobContracts[${counter.index}].jobContract.bankAcctKey"/>
...
<td> <form:input cssClass="inputBox" size="46" disabled="true" maxlength="4"path="addJobContracts[${counter.index}].jobContract.depositNo"/>
...
<td><form:select disabled="true" id="sel7" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.pymntType" items="${icbfn:dropdown('staticDropdown',paymentType)}" itemLabel="name" itemValue="value"/></td>
...
<iframe align="left" frameborder="0" style="padding:0px;" height="350px;" width="100%" src="blank.html" id="searchContactFr${counter.index}" name="searchContactFr${counter.index}" allowtransparency="yes"></iframe>
</div>
</div>
<!-- ----------------------------- Billing Contact Lookup  ---------------------------------------------- -->
...
<table cellspacing="0" cellpadding="0" align="center" style="width:95%;" >
<tr>
<iframe align="left" frameborder="0" style="padding:0px;" height="300px;" width="100%" src="blank.html" scrolling="auto" id="sremittoframe${counter.index}" name="sremittoframe${counter.index}" allowtransparency="yes" ></iframe>
</tr>
</table>
</div>
</div>
...
<table cellspacing="0" cellpadding="0" align="center" style="width:95%;" >
<tr>
<iframe align="left" frameborder="0" style="padding:0px;" height="300px;" width="100%" src="blank.html" scrolling="auto" id="saccountframe${counter.index}" name="saccountframe${counter.index}" allowtransparency="yes" ></iframe>
</tr>
</table>
</div>
</div>
...
<ajax:select
              ...
              parameters="zonesearch=1,portCode={addJobContracts[${counter.index}].jobContract.locationDesc},contractCode=${command.addJobContracts[counter.index].jobContract.contractCustContact.contractCust.contract.contractCode},branchCode=${command.jobOrder.branchName}"
            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                   <td></td>
                    <td style="text-align:right">
          <a href="#" onClick="goToNextPage()"><img src="images/savennextbluarrow.gif" alt="Save and Go to Next Page" width="14" height="14" hspace="4" border="0" align="absmiddle" title="Save and Go to Next Page"></a><a href="#"><img src="images/icosave.gif" alt="Save" title="Save" width="14" height="14" border="0" onClick="javascript:updateJobDescription();checkDate();"
          /></a></td>
          <%-- onclick="top.document.editJobsInspForm.submit();" --%>
                  </tr>
                </table>
...
<div class="sample_popup" id="towingco"
  style="visibility: hidden; display: none;">
<div class="menu_form_header" id="towingco_drag" style="width:650px; ">
<img class="menu_form_exit" id="towingco_exit"
  src="images/form_exit.png" />&nbsp;&nbsp;&nbsp; <f:message
  key="selectTowingCompany" /></div>
<div class="menu_form_body" id="towingbody"
  style="width:650px; height:275px;"><iframe id="tow" align="left"
  style="padding:0px; height:275px;" width="100%"
  src="search_towingcompany_popup.htm?inputFieldId=jobOrder.towingCompany.name"
  scrolling="auto" name="frame1" allowtransparency="yes"></iframe></div>
</div>
...
<div class="sample_popup" id="shippingagent"
  style="visibility: hidden; display: none;">
<div class="menu_form_header" id="shippingagent_drag"
  style="width:650px;"><img class="menu_form_exit"
  id="shippingagent_exit" src=" images/form_exit.png" />&nbsp;&nbsp;&nbsp;
<f:message key="selectShippingAgent" /></div>
<div class="menu_form_body" id="shippingagentbody"
  style="width:650px; height:275px;"><iframe id="ship" align="left"
  frameborder="0" style="padding:0px; height:275px;" width="100%"
  src="search_shippingagent_popup.htm?inputFieldId=jobOrder.shippingAgent.name"
  scrolling="auto" id="frame2" name="frame2" allowtransparency="yes"></iframe>
...
<div class="menu_form_body" id="servlocbody"
  style="width:650px; height:275px;"><iframe id="serv" align="left"
  frameborder="0" style="padding:1px; height:275px;" width="100%"
  src="search_serviceLocation_popup.htm?inputFieldId=jobOrder.serviceLocation.name"
  scrolling="auto" id="frame3" name="frame3" allowtransparency="yes"></iframe>
...
<div class="menu_form_body" id="timezonebody"
  style="width:300px; height:250px;""><iframe align="middle"
  frameborder="0" style="padding:1px; height:250px;" width="100%"
...
<div class="sample_popup" id="etatimezone"
  style="visibility: hidden; display: none;">
<div class="menu_form_header" id="etatimezone_drag"
  style="width:300px; "><img class="menu_form_exit"
  id="etatimezone_exit" src=" images/form_exit.png" />&nbsp;&nbsp;&nbsp;
<f:message key="selectTimeZone" /></div>
<div class="menu_form_body" id="etatimezonebody"
  style="width:300px; height:250px;""><iframe align="left:2px"
  frameborder="0" style="padding:2px; height:250px;" width="100%"
...
<div class="sample_popup" id="receivedby"
  style="visibility: hidden; display: none;">
<div class="menu_form_header" id="receivedby_drag" style="width:300px;">
<img class="menu_form_exit" id="receivedby_exit"
  src="images/form_exit.png" /> &nbsp;&nbsp;&nbsp;<f:message
  key="searchUser" /></div>
<div class="menu_form_body" id="receivedbybody"
  style="width:300px; height:250px;padding-left:4px;"><iframe
  align="left" frameborder="0" style="padding:0px;" height="250px"
  width="100%"
  src="search_user_popup.htm?inputFieldId=jobOrder.receivedByUserName&div1=receivedby&div2=receivedbybody"
  scrolling="auto" id="searchAccountOwnerFr" name="searchAccountOwnerFr"
