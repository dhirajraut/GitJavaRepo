...
function submitform()
{
top.document.createJobsMarineForm.submit();
}
function setTowingCoFlag()
{
 //document.createJobsMarineForm.towingCompFlag.value="towingCompany";
document.createJobsMarineForm.tabName.value = "0";
}
function setShippingFlag()
{
//document.createJobsMarineForm.shippingAgentFlag.value="shippingAgent";
document.createJobsMarineForm.tabName.value = "0";
}

function setServiceLcoationFlag()
{
document.createJobsMarineForm.serviceLocationFlag.value="servicelocation";
document.createJobsMarineForm.tabName.value = "0";
}
 function setPortLcoationFlag()
{   
 document.createJobsMarineForm.portLocationFlag.value="portlocation";
 document.createJobsMarineForm.tabName.value = "0";
}
...
var buName= document.getElementById("sel3").value;
 document.createJobsMarineForm.jobDateFlag.value="jobDate";
if(buName!= "" && buName!= null)
{
document.getElementById('jobbu').setAttribute("src",src="search_branch_popup.htm?inputFieldId=jobOrder.branchName&div1=jobbranchcode&div2=jobbranchcodebody&buName="+buName+"&formName=createJobsMarineForm");
}
}
...
function setform(){
  ...
  if (isAdd(code.value) == false) {
    ...
    document.createJobsMarineForm.ccode.focus();
  document.createJobsMarineForm.ccode.value="";
  return false;
    }
  ...
  document.createJobsMarineForm.uniqueFlag.value="uniqueFlag";
    document.createJobsMarineForm.submit();
    } 
}
...
function setDeleteflag(index){
  ...
  {
  document.createJobsMarineForm.jobFlag.value="none";
  document.createJobsMarineForm.jobIndex.value = index;
  document.createJobsMarineForm.deleteFlag.value ="delval";
  document.createJobsMarineForm.submit();
  }
}
...
function resetJobValFlag(){
 document.createJobsMarineForm.jobFlag.value="none";
 document.createJobsMarineForm.popFlag.value="none";
document.createJobsMarineForm.contactFlag.value="none";
  document.createJobsMarineForm.uniqueFlag.value="none";
  setpage();
}
...
function setsubflag(){
document.createJobsMarineForm.jobValFlag.value="newjobval";
document.createJobsMarineForm.tabName.value = "1";
}

function setcontactflag(rowIndex){
document.createJobsMarineForm.jobFlag.value="none";
document.createJobsMarineForm.contactIndex.value=rowIndex;
document.createJobsMarineForm.contactFlag.value="contFlag";
document.createJobsMarineForm.tabName.value="1";
}

function setAttachFilesFlag(rowIndex){
document.createJobsMarineForm.attachFilesFlag.value=rowIndex;
document.createJobsMarineForm.tabName.value="1";
}
...
if(portLoc == "" || portLoc == null)
{
  ...
  document.createJobsMarineForm.nextPageFlag.value = "1";
...
function checkSearchField(){
  ...
  return false;
     ...
     {
		document.createJobsMarineForm.goFlag.value="true";    
		document.createJobsMarineForm.operationFlag.value = "operation";
		submitform();
	 }
}

   function updateJobDescription(dateFormat,jobDescExist)  {
   var w = document.createJobsMarineForm.sel5.selectedIndex;
   var ops_text = document.createJobsMarineForm.sel5.options[w].text;
 ...
 var desc = ops_text+" "+"on"+" "+"at"+" "+newServLoc+" "+"on"+" "+date;
...
{	
 ...
 document.createJobsMarineForm.errorFlag.value="none";
 document.createJobsMarineForm.uniqueFlag.value="uniqueFlag";
...
{
  document.createJobsMarineForm.jobFlag.value="none";
  document.createJobsMarineForm.deleteFlag.value ="none";
  document.createJobsMarineForm.contactFlag.value="contFlag";
  document.createJobsMarineForm.tabName.value="1";
  document.createJobsMarineForm.submit();
}
...
checkDate(dateFormat,userTimeFormat);
 ...
 {
 document.createJobsMarineForm.jobDateFlag.value="jobDate";
 document.createJobsMarineForm.dateFlag.value=flag;
 if(flag=='true')
 document.createJobsMarineForm.openPeriodsFlag.value="true";
 else
 document.createJobsMarineForm.openPeriodsFlag.value="false";
 document.createJobsMarineForm.submit();
 }
...
document.createJobsMarineForm.showWarn.value="false";
}
...
<form:form name="createJobsMarineForm" method="POST" action="create_job_entry_marine.htm">
...
<!------------------------------------------------------------TAB 1 CONTAINER---------------------------------------------------------->
    ...
    <div id="tab1" class="innercontent">
          <table width="100%" cellpadding=0 cellspacing=0 class=mainApplTable>
            <tbody>
              <tr bgcolor=#ffffff>
                <th width="50%" colspan=2 nowrap><f:message key="headerDetails"/> <img src=" images/separator2.gif" width="2" height="27"  align="absmiddle" style="margin-left:5px;margin-right:5px;"/><f:message key="jobId"/> :<img src=" images/separator2.gif" width="2" height="27" align="absmiddle" style="margin-left:5px;margin-right:5px;"/><f:message key="jobTypeOCAMarineAndCalibrations"/></th>
...
<form:select id="projectTypes" cssClass="selectionBox" path="phxProjectType" items="${command.projectTypes}" itemLabel="name" itemValue="value" disabled="${command.projectTypeViewOnly}" />
        ...
        <form:input id="brnch" size="52" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;"
          cssClass="inputBox" path="jobOrder.branchName" onchange="selectJobDateBoolean('false');"/>
...
<td class="TDShadeBlue"><form:select id="sel5"  cssClass="selectionBoxbig" path="jobOrder.operation"  items="${icbfn:dropdown('jobOperations', operations)}" itemLabel="name" itemValue="value" /> <form:errors path="jobOrder.operation" cssClass="redstar" /></td>
                ...
                <td colspan="2" class="TDShadeBlue"><form:input cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" cssClass="inputBox" maxlength="128" size="52" path="jobOrder.receivedByUserName" />
        <form:errors path="jobOrder.receivedByUserName" cssClass="redstar"/>
                   <a href="#" onClick="javascript:popup_show('receivedby','receivedby_drag','receivedby_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('receivedby','receivedbybody');popupboxenable();"> <img src=" images/lookup.gif" alt="Lookup receivedby" width="13" height="13" border="0" /></a></td>
              </tr>
              <tr>
       ...
       <input name="textfield92" type="text" class="inputBox" size="20" disabled="true"/> 
        ...
        <a href="#" onClick="displayCalendar(document.forms[0].quotedate,'dd/mm/yyyy',this)"> <img src=" images/calendar.gif" width="15" height="17"  align="absmiddle" border="0"/></a>&nbsp;&nbsp;&nbsp;<strong><f:message key="quoteID"/>:</strong></td>
                ...
                <td colspan="2" class="TDShadeBlue"><form:input id="finishdate" cssClass="inputBox" path="jobOrder.jobFinishDate" onchange="selectJobDate('true','finishdate');"/>
        <form:errors path="jobOrder.jobFinishDate" cssClass="redstar"/>
			...
			<c:when test="${command.userTimeFormat != 'AM/PM'}">
                ...
                <td class="TDShadeBlue"><form:input id="nomdate" cssClass="inputBox" path="jobOrder.nominationDate"/>
				<form:errors path="jobOrder.nominationDate" cssClass="redstar"/>
				 <a href="#" onClick="displayCalendar(document.forms[0].nomdate,'${command.dateFormat}',this)"> <img src=" images/calendar.gif" width="15" height="17"  align="absmiddle" border="0"/></a>&nbsp;&nbsp;&nbsp;<f:message key="time"/>:
				 <form:input size="4" cssClass="inputBox" id="nomTimes" path="uiNominationTime" /> 
		...
		<c:when test="${command.userTimeFormat != 'AM/PM'}">
                ...
                <td colspan="2" class="TDShadeBlue"><form:input id="etadate" cssClass="inputBox" path="jobOrder.etaDate" onchange="selectJobDate('false','etadate');"/>
        <form:errors path="jobOrder.etaDate" cssClass="redstar"/>
                  <a href="#" onClick="displayCalendar(document.forms[0].etadate,'${command.dateFormat}',this)"> <img src=" images/calendar.gif" width="15" height="17"  align="absmiddle" border="0"/></a>&nbsp;&nbsp;&nbsp;<f:message key="time"/>:
        ...
        <img src=" images/lookup.gif" alt="Lookup Time Zone" width="13" height="13" border="0" /></a>
              ...
              <tr>
                ...
                <td class="TDShadeBlue" >
        <form:input id="tco" cssClass="inputBox" size="52" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" maxlength="128" path="jobOrder.towingCompany.name"/>
         ...
         'towingco_drag','towingco_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('towingco','towingbody');popupboxenable();"><img src=" images/lookup.gif" alt="Lookup Towing Company" width="13" height="13" border="0"/></a></td>
                <td class="TDShade"><strong><f:message key="telephoneNo"/></strong></td>
         <td class="TDShadeBlue"> <form:input id="tphone" cssClass="inputBox" size="52" path="jobOrder.towingCompanyPhone"/>
        <form:errors path="jobOrder.towingCompanyPhone" cssClass="redstar"/></td>
              ...
              <tr>
                ...
                <td class="TDShadeBlue">
        <form:input id="shipagnt" size="52" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" cssClass="inputBox" maxlength="128" path="jobOrder.shippingAgent.name"/>
         <form:errors path="jobOrder.shippingAgent.name" cssClass="redstar"/>
        
                  <a href="#" onClick="javascript:updateShipAgentIframeSrc();setShippingFlag();popup_show('shippingagent', 'shippingagent_drag', 'shippingagent_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('shippingagent','shippingagentbody');popupboxenable();"> <img src=" images/lookup.gif" alt="Lookup Shipping Agent" width="13" height="13" border="0"/></a> </td>
                <td class="TDShade"><strong><f:message key="telephoneNo"/></strong></td>
         <td class="TDShadeBlue">
         <form:input  id="sphone" cssClass="inputBox" size="52" path="jobOrder.shippingAgentPhone"/>
        <form:errors path="jobOrder.shippingAgentPhone" cssClass="redstar"/></td>
              ...
              <tr>
                ...
                <td class="TDShadeBlue">
         <form:input id="portLoc" cssClass="inputBox" maxlength="30" size="52" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" onchange="javascript:changeVisibleStyle();" path="jobOrder.serviceLocation.city"/>
         <form:errors path="jobOrder.serviceLocation.city" cssClass="redstar"/> <a
        ...
        <img src="images/lookup.gif" id="lookup"  width="13" height="13" border="0" /></a>
          ...
          path="jobOrder.serviceLocation.name" /> <form:errors
          path="jobOrder.serviceLocation.name" cssClass="redstar" /> <a
        ...
        <img src="images/lookup.gif" id="lookup" width="13" height="13" border="0" /></a></td>
              </tr>
               <tr>
...
<tr>
<iframe id="pu" align="left" frameborder="0" style="padding:0px;" height="670px;" width="100%" src="blank.html" scrolling="auto" id="searchjobContractFr" name="searchjobContractFr" allowtransparency="yes" ></iframe>
</tr>
</table>
</div>
</div>
...
{  
document.createJobsMarineForm.jobFlag.value="jobval";
document.createJobsMarineForm.tabName.value = "1";
var buname=document.getElementById("sel3").value;
var code= scode;
...
document.getElementById('pu').setAttribute("src","search_job_contract_insp_popup.htm?inputFieldId=inputFieldIdValue&searchForm=createJobsMarineForm&code="+code+"&pageNumber="+pageN0+"&buName="+buname+"&fromPage=2");
}
}
</script>
</c:when>
...
if(scode.charAt("/"))
{ code=scode.replace("/","'");}
document.createJobsMarineForm.ccode.value=code;
document.createJobsMarineForm.uniqueFlag.value="uniqueFlag";
document.createJobsMarineForm.submit();
}
</script>
...
<td align="center"><a href="#" onClick="javascript:setDeleteflag('${counter.index}');">
...
<td width="26%"><form:select id="sel1" cssClass="selectionBoxbig" path="addJobContracts[${counter.index}].jobContract.custSentBy" items="${icbfn:dropdown('staticDropdown',origin)}" itemLabel="name" itemValue="value"/>
...
<td><form:select id="sel6" cssClass="selectionBoxbig" path="addJobContracts[${counter.index}].jobContract.language" items="${icbfn:dropdown('staticDropdown',selectedLanguage)}" itemLabel="name" itemValue="value"/></td>
...
<td><form:select id="sel3" cssClass="selectionBoxbig" path="addJobContracts[${counter.index}].jobContract.transactionCurrencyCd" items="${icbfn:dropdown('currencyTrans', currencies)}" itemLabel="name" itemValue="value" onchange="setbankFlag(${counter.index});"/>
...
<td><form:select id="sel4" cssClass="selectionBoxbig" path="addJobContracts[${counter.index}].jobContract.productType" items="${icbfn:dropdown('staticDropdown', productType)}" itemLabel="name" itemValue="value"/></td>
...
<form:select id="sel9" cssClass="selectionBoxbig" path="addJobContracts[${counter.index}].jobContract.zone" items="${icbfn:dropdown('zoneId', pcodes)}" itemLabel="name" itemValue="value"/>
</td>
...
<td>
<form:select id="sel6" cssClass="selectionBoxint" path="addJobContracts[${counter.index}].jobContract.invoiceType" items="${icbfn:dropdown('staticDropdown',invoiceType)}" itemLabel="name" itemValue="value"/> </td>
</tr>
...
<td><form:input id="remitto${counter.index}" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" cssClass="inputBox" size="12"  maxlength="0" path="addJobContracts[${counter.index}].jobContract.bankCd"/>
<form:errors path="addJobContracts[${counter.index}].jobContract.bankCd" cssClass="redstar"/>
&nbsp;<a href="#" onClick="javascript:updateBankIframe('${counter.index}','${command.jobOrder.buName}','${command.addJobContracts[counter.index].jobContract.transactionCurrencyCd}');popup_show('searchremitto${counter.index}', 'searchremitto_drag${counter.index}', 'searchremitto_exit${counter.index}', 'screen-corner', 120, 20);hideIt();popupboxenable();showPopupDiv('searchremitto${counter.index}','remittobody${counter.index}');"><img src=" images/lookup.gif" alt="Lookup remitTo" width="13" height="13" border="0" /></a>&nbsp;&nbsp;&nbsp;

<f:message key="acct"/>:
<form:input cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" cssClass="inputBox" size="20"  maxlength="0" path="addJobContracts[${counter.index}].jobContract.bankAcctKey"/>
...
<td><form:select id="sel7" cssClass="selectionBoxbig" path="addJobContracts[${counter.index}].jobContract.pymntType" items="${icbfn:dropdown('staticDropdown',paymentType)}" itemLabel="name" itemValue="value"/></td>
...
<td><form:select id="sel13" cssClass="selectionBoxint" path="addJobContracts[${counter.index}].jobContract.pymntTermsCd" items="${icbfn:dropdown('paymentTerms', null)}" itemLabel="name" itemValue="value" disabled="true"/></td>
</c:when>
<c:otherwise>
<td>
<form:select id="sel13" cssClass="selectionBoxint" path="addJobContracts[${counter.index}].jobContract.pymntTermsCd" itemLabel="name" itemValue="value" disabled="true">
...
<ajax:autocomplete
 ...
 <ajax:autocomplete
              ...
              className="autocomplete"              
              parameters="projectNumber={addJobContracts[${counter.index}].jobContract.projectNumber},custCode=${command.addJobContracts[counter.index].jobContract.custCode}"
              minimumCharacters="1"
               /> 
