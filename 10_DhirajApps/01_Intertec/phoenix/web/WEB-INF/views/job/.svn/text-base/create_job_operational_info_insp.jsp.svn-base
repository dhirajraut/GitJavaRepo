...
function showRequiredFields(){
  ...
  function onAddVessel(index)
  {
	...
	var a=++index;
    document.jobOrderCreateOpInstrForm.addOrDeleteVessel.value = "add";
	document.jobOrderCreateOpInstrForm.scrollFlag.value="addVess"+a;		
    document.jobOrderCreateOpInstrForm.submit();
  }
  function onDeleteVessel(index)
  {
    document.jobOrderCreateOpInstrForm.addOrDeleteVessel.value = "delete";
    document.jobOrderCreateOpInstrForm.vesselIndex.value = index;
	if(index!=0)
	{
	document.jobOrderCreateOpInstrForm.scrollFlag.value="delvessel"+(index-1);
	}
	else
	  {
		document.jobOrderCreateOpInstrForm.scrollFlag.value="addVess";	
	  }	
    document.jobOrderCreateOpInstrForm.submit();
  ...
  {  
    document.jobOrderCreateOpInstrForm.addOrDeleteProduct.value = "add";
    document.jobOrderCreateOpInstrForm.vesselIndex.value = index;
	var a=++count;	
	document.jobOrderCreateOpInstrForm.scrollFlag.value="addProd"+index+a;	
    document.jobOrderCreateOpInstrForm.submit();
  }
  function onDeleteProduct(vesselIndex,productIndex)
  {
    document.jobOrderCreateOpInstrForm.addOrDeleteProduct.value = "delete";
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;
	document.jobOrderCreateOpInstrForm.scrollFlag.value="delProd"+vesselIndex;
    document.jobOrderCreateOpInstrForm.submit();
  ...
  function onAddEvent(vesselIndex,productIndex)
  {
    ...
    document.jobOrderCreateOpInstrForm.addOrDeleteEvent.value = "add";
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;
	 document.jobOrderCreateOpInstrForm.scrollFlag.value="addEventRow"+vesselIndex+productIndex;
    document.jobOrderCreateOpInstrForm.submit();
  }
  function onDeleteEvent(vesselIndex,productIndex,eventIndex)
  {
    document.jobOrderCreateOpInstrForm.addOrDeleteEvent.value = "delete";
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;
    document.jobOrderCreateOpInstrForm.eventIndex.value = eventIndex;
	document.jobOrderCreateOpInstrForm.scrollFlag.value="delEventRow"+vesselIndex+productIndex;
    document.jobOrderCreateOpInstrForm.submit();
  }   
  ...
  {
    var a=++count;
    document.jobOrderCreateOpInstrForm.addOrDeleteSampleLoc.value = "add";
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;   
	document.jobOrderCreateOpInstrForm.scrollFlag.value="addSampleRow"+vesselIndex+productIndex+a;
	document.getElementById('sampleLocationFr'+vesselIndex+productIndex).setAttribute("src","sample_location_popup.htm?searchForm=jobOrderCreateOpInstrForm&div1=sampleLoc"+vesselIndex+productIndex+"&div2=sampleLocBody"+vesselIndex+productIndex);   
  }
  
	function resetJob()
	{ 
	 document.jobOrderCreateOpInstrForm.addOrDeleteSampleLoc.value = "none";
	 document.jobOrderCreateOpInstrForm.scrollFlag.value="none";
	}
  
  function onDeleteSampleLoc(vesselIndex,productIndex,sampleLocIndex)
  {
    document.jobOrderCreateOpInstrForm.addOrDeleteSampleLoc.value = "delete";
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;       
    document.jobOrderCreateOpInstrForm.sampleLocIndex.value = sampleLocIndex;
	document.jobOrderCreateOpInstrForm.scrollFlag.value="delRowSample"+vesselIndex+productIndex;	
    document.jobOrderCreateOpInstrForm.submit();
  ...
  function onAddQty(vesselIndex,productIndex)
  {
    ...
    document.jobOrderCreateOpInstrForm.addOrDeleteQty.value = "add";
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;   
	document.jobOrderCreateOpInstrForm.scrollFlag.value="addQuantity"+vesselIndex+productIndex;
    document.jobOrderCreateOpInstrForm.submit();
  }
  function onUpdateQty(vesselIndex,productIndex)
  {
  
    document.jobOrderCreateOpInstrForm.addOrDeleteQty.value = "update";
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;   
    document.jobOrderCreateOpInstrForm.submit();
  }  
  ...
  {
    document.jobOrderCreateOpInstrForm.addOrDeleteQty.value = "delete";
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;       
    document.jobOrderCreateOpInstrForm.qtyIndex.value = qtyIndex;
	document.jobOrderCreateOpInstrForm.scrollFlag.value="delQuantity"+vesselIndex+productIndex;
    document.jobOrderCreateOpInstrForm.submit();

  } 
  function onDeleteTest(vesselIndex,productIndex,sampleLocIndex,testIndex)
  {
    document.jobOrderCreateOpInstrForm.addOrDeleteTest.value = "delete";
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;       
    document.jobOrderCreateOpInstrForm.sampleLocIndex.value = sampleLocIndex;
    document.jobOrderCreateOpInstrForm.testIndex.value = testIndex;   
   	document.jobOrderCreateOpInstrForm.scrollFlag.value="delRowTest"+vesselIndex+productIndex+sampleLocIndex;
    document.jobOrderCreateOpInstrForm.submit();
  ...
  {
    document.jobOrderCreateOpInstrForm.addOrDeleteTest.value = "deleteManual";
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;       
    document.jobOrderCreateOpInstrForm.sampleLocIndex.value = sampleLocIndex;
    document.jobOrderCreateOpInstrForm.testIndex.value = testIndex;   
    ...
    function onAddTest(vesselIndex,productIndex,sampleLocIndex,testSize,manualTestSize,slateSize)
  {
    ...
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;       
    document.jobOrderCreateOpInstrForm.sampleLocIndex.value = sampleLocIndex;
	document.jobOrderCreateOpInstrForm.scrollFlag.value="testAdd"+vesselIndex+productIndex+sampleLocIndex;
  ...
  {
    document.jobOrderCreateOpInstrForm.addOrDeleteSlate.value = "delete";
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;       
    document.jobOrderCreateOpInstrForm.sampleLocIndex.value = sampleLocIndex;
    document.jobOrderCreateOpInstrForm.testIndex.value = slateIndex;    
	document.jobOrderCreateOpInstrForm.scrollFlag.value="delRowSlate"+vesselIndex+productIndex+sampleLocIndex;
    document.jobOrderCreateOpInstrForm.submit();
      ...
      function onAddSlate(vesselIndex,productIndex,sampleLocIndex,testSize,manualTestSize,slateSize)
  {
    ...
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;       
    document.jobOrderCreateOpInstrForm.sampleLocIndex.value = sampleLocIndex;
	document.jobOrderCreateOpInstrForm.scrollFlag.value="slateAdd"+vesselIndex+productIndex+sampleLocIndex;
    var massOTElemName = "massOT" + vesselIndex + productIndex + sampleLocIndex;
    document.getElementById(massOTElemName).style.visibility="hidden";
...
function onCopyVessel(vesselIndex,count) {
  ...
  var a=++count;  
  document.jobOrderCreateOpInstrForm.copyFlag.value = "copyVessel";
  document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;
  document.jobOrderCreateOpInstrForm.scrollFlag.value="copyVess"+a;
  document.jobOrderCreateOpInstrForm.submit();
  }   
function onCopyProduct() {
  document.jobOrderCreateOpInstrForm.copyFlag.value = "copyProduct";  
  }  
  ...
  var a=++count;
  document.jobOrderCreateOpInstrForm.copyFlag.value = "copySample";
  document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;
  document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
  document.jobOrderCreateOpInstrForm.sampleLocIndex.value = sampleLocIndex;
  document.jobOrderCreateOpInstrForm.scrollFlag.value = "copySampleLoc"+vesselIndex+productIndex+a;
  document.jobOrderCreateOpInstrForm.submit();
  }     
  ...
  {  
    ...
    {      
      if(document.jobOrderCreateOpInstrForm.chosenContracts.value == "")
      {
        document.jobOrderCreateOpInstrForm.chosenContracts.value = document.getElementById(elemName).value;
      }
      else
      {
        var existingVal = document.jobOrderCreateOpInstrForm.chosenContracts.value;
        document.jobOrderCreateOpInstrForm.chosenContracts.value = existingVal + ";" + document.getElementById(elemName).value;
      }  
     }
   }
  } 
...
{
  document.jobOrderCreateOpInstrForm.nextPageFlag.value = "1";
  document.jobOrderCreateOpInstrForm.scrollFlag.value = "none"
  top.document.forms[0].submit();
  //document.jobOrderCreateForm.submit();
}
////////////////////////////////////////////////////////// Template
 function createTemp()
{
  ...
  if(tName.value==null || tName.value=="")
  {
	...
	document.jobOrderCreateOpInstrForm.tmpNm.focus();
	return false;
  }
  document.jobOrderCreateOpInstrForm.templateFlag.value = "yes";
  top.document.forms[0].submit();
}

function setTemplateSearchFlag(){

  document.jobOrderCreateOpInstrForm.tmpSearchFlag.value = "tmpSearchFlag";
}
...
////////////////////////////////////////////////////////// Template
  ...
  function updateManualTestIFrameSrc(vesselCnt,productCnt,SampleCnt,nomDate,jobnumber)
  {
    ...
    document.getElementById('searchtestpopup').setAttribute("src","add_manual_test.htm?inputFieldId=addJobVessels["+vesselCnt+"].jobVessel.vesselName&rowNum="+vesselCnt+"&searchForm=jobOrderCreateOpInstrForm&chosenContracts="+chosenContractList+"&div1=test"+vesselCnt+productCnt+SampleCnt+"&div2=testbody"+vesselCnt+productCnt+SampleCnt+"&nomDate="+nomDate+"&productCnt="+productCnt+"&sampleCnt="+SampleCnt+"&jobnumber="+jobnumber);
    document.getElementById('searchtestpopup').height = "500px";
  }
...
function setJobContractCodeVal(elemId,vesselIndex,productIndex,jobContractCode)
{
  ...
  {
    document.jobOrderCreateOpInstrForm.chosenContracts.value = jobContractCode;
    document.jobOrderCreateOpInstrForm.applicableContractFlag.value = "add";
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
  }
  else
  {
    document.jobOrderCreateOpInstrForm.chosenContracts.value = jobContractCode;
    document.jobOrderCreateOpInstrForm.applicableContractFlag.value = "delete";
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselIndex;
    document.jobOrderCreateOpInstrForm.productIndex.value = productIndex;
  }
  document.jobOrderCreateOpInstrForm.submit();
...
{
  document.jobOrderCreateOpInstrForm.labAnalysisFlag.value = "Y";
  document.jobOrderCreateOpInstrForm.scrollFlag.value = "retainScroll"+index; 
  document.jobOrderCreateOpInstrForm.submit();
}
function setOtApprovedFlag(testIndex,index)
{
  document.jobOrderCreateOpInstrForm.otApprovedFlag.value = "Y";
  document.jobOrderCreateOpInstrForm.otApproveCheckFlag.value = "N";
  document.jobOrderCreateOpInstrForm.testIndexFlag.value = testIndex;

  if(index=='ind')
	{
	 if(testIndex != 'no')
     document.jobOrderCreateOpInstrForm.scrollFlag.value = "priorityScroll"+testIndex; 
	 //document.jobOrderCreateOpInstrForm.testIndexFlag.value = "no"
	}
	else if(index=='massOT')
	{
		document.jobOrderCreateOpInstrForm.scrollFlag.value = "massOtScroll"+testIndex;
	}
	else
	{
    document.jobOrderCreateOpInstrForm.testIndexFlag.value = testIndex;
	document.jobOrderCreateOpInstrForm.scrollFlag.value = "testOtScroll"+testIndex;
	}  
...
function checkForOtApprovedFlag(vesselIndex,productIndex,sampleIndex,jobTests,jobManualTests,jobSlates)
{
	...
	if(elemval == 'Overtime' || elemval == 'Rush') {
		document.jobOrderCreateOpInstrForm.scrollFlag.value = "priorityScroll"+vesselIndex+productIndex+sampleIndex; 
		if((jobTests != null && jobTests =='') && (jobManualTests != null && jobManualTests =='') && (jobSlates != null && jobSlates =='') ) {
			...
			//document.getElementById(elemname).value="Standard";
			//return false;
			}
		} else {
			setOtApprovedFlag('no','ind');
	...
	{
		//document.getElementById("otApproved").checked = false;
		//document.getElementById("otApproved").value = false;
		//document.jobOrderCreateOpInstrForm.otApprovedFlag.value = "N";
		document.jobOrderCreateOpInstrForm.scrollFlag.value = "priorityScroll"+vesselIndex+productIndex+sampleIndex; 
		document.jobOrderCreateOpInstrForm.otApproveCheckFlag.value = "Y";
		document.jobOrderCreateOpInstrForm.submit();
	}
}
...
{
    document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselCnt;
    document.jobOrderCreateOpInstrForm.productIndex.value = productCnt;
    document.jobOrderCreateOpInstrForm.eventIndex.value = eventCnt;
    document.jobOrderCreateOpInstrForm.instructionFlag.value = eventCode;
    document.jobOrderCreateOpInstrForm.scrollFlag.value="popEventInstr"+vesselCnt+productCnt;	
    document.jobOrderCreateOpInstrForm.submit();
}
...
function onMassDeleteTestSlate(vesselCnt,productCnt,sampleCnt,testSize,manualTestSize,slateSize)
{
	...
	chosenManualTests = chosenManualTests.substring(1,chosenManualTests.length );
      ...
      document.jobOrderCreateOpInstrForm.vesselIndex.value = vesselCnt;
      document.jobOrderCreateOpInstrForm.productIndex.value = productCnt;
      document.jobOrderCreateOpInstrForm.sampleLocIndex.value = sampleCnt;
      document.jobOrderCreateOpInstrForm.massTestSlateDeleteFlag.value = 'massDelete';
	  document.jobOrderCreateOpInstrForm.scrollFlag.value = 'delTotTest'+vesselCnt+productCnt+sampleCnt;	 
      document.jobOrderCreateOpInstrForm.submit();
...
{
	if(document.jobOrderCreateOpInstrForm.warnUserFlag.value == 'warn' || document.jobOrderCreateOpInstrForm.warnUserFlag.value == 'warned')
		document.jobOrderCreateOpInstrForm.warnUserFlag.value = 'navigate';
	else
		document.jobOrderCreateOpInstrForm.warnUserFlag.value = "warn";
		
	document.jobOrderCreateOpInstrForm.navigationUrl.value = navigationUrl;
	document.jobOrderCreateOpInstrForm.submit();
}
...
function popCancelReason()
{  
 confirm("Please save job instructions or go back to entry page to cancel job");
}
function submitFunction(){
  ...
  {
    document.jobOrderCreateOpInstrForm.portLocationFlag.value="portlocation";
    document.jobOrderCreateOpInstrForm.vesselIndex.value=vesselIndex;
    document.jobOrderCreateOpInstrForm.productIndex.value=productIndex;
  }
...
<form:form name="jobOrderCreateOpInstrForm" method="POST" action="create_job_operational_info_insp.htm">
...
<table border="0" cellpadding="0" cellspacing="0" class="MainTable">
  ...
  <tr>
    <td valign="top"><!-- BREADCRUMB TRAIL  -->
            ...
            <td><table height="22" border="0" align="left" cellpadding="0" cellspacing="0">
                <tr>
                  <td class="breadcrumbtrailDeactive" style="background:none; padding-left:5px;">&#9658; 
                    <a href="edit_job_entry_${urlSuffix}.htm?jobNumber=${command.jobOrder.jobNumber}">
                    <!-- <a href="#" onClick="warnUser('edit_job_entry_${urlSuffix}.htm?jobNumber=${command.jobOrder.jobNumber}')"> -->
                      <f:message key="entry"/> 
                    </a>
                  </td>
                ...
                <c:when test="${command.jobOrder.pageNumber >= 2}">               
                    <a href="edit_job_operational_info_insp.htm?jobNumber=${command.jobOrder.jobNumber}"> 
                    <!-- <a href="#" onClick="warnUser('edit_job_operational_info_insp.htm?jobNumber=${command.jobOrder.jobNumber}')">-->
          ...
          <div id="tab_inner">
            ...
            <div id="tab1" class="innercontent">
              <table width="100%" cellpadding=0 cellspacing=0 class="mainApplTable">
                <tbody>
                  <tr>
                    <th width="35%" ><f:message key="jobInstructions"/><img src="images/separator2.gif" width="2" height="27"  align="absmiddle" style="padding-left:10px;padding-right:10px;"/><f:message key="jobId"/>: ${command.jobOrder.jobNumber }</th>
                    <th width="35%" style="text-align:right"><f:message key="jobStatus"/>:
              <form:select id="sel1" cssClass="selectionBox" path="jobOrder.jobStatus" onchange="popCancelReason()" items="${icbfn:dropdown('staticDropdown',jobStatus)}" itemLabel="name" itemValue="value" />
                    ...
                    <th width="30%" style="text-align:right"><a href="#"><img src="images/add.gif" alt="Add Vessel" width="13" height="12" hspace="1px" border="0" onclick="onAddVessel('${fn:length(command.addJobVessels)}')"/></a>&nbsp;<a href="#"><img src="images/ico_print.gif" alt="Print Job Order" width="18" height="16" hspace="2" border="0" align="absmiddle" title="Print Job Order"></a>
                    <c:if test="${command.samBranchFlag}">
                    <a href="#"><img src="images/icoship.gif" alt="Send To SAM" hspace="2" border="0" align="absmiddle" title="Send To SAM"></a>
                    </c:if>
                    <c:if test="${command.limsBranchFlag}">
                    <a href="#"><img src="images/icoflask.gif" alt="Send To LIMS" hspace="2" border="0" align="absmiddle" title="Send To LIMS"></a>
                    </c:if>
		  ...
		  <td colspan="3" style="padding:0px;" class="TDShade"><div id="templatesContainer">
				...
				<tr>
					 <th>
						...
						<th><f:message key="searchTemplate"/>:<label>
     ...
     <form:hidden path="addJobVessels[${vesselCounter.index}].displayStatus" />                      
                  <tr>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" class="mainApplTable" >
                          <tbody>
                            <tr>
                              ...
                              <td width="12%" class="TDShade" ><a name="vessel1"></a>
                                <f:message key="vessel"/> ${vesselCounter.index + 1}:<span class="redstar">*</span></td>
                              </c:if>
                              ...
                              <form:input cssClass="inputBox" size="20" path="addJobVessels[${vesselCounter.index}].jobVessel.vesselName" maxlength="256"/>
                          ...
                          <form:select id="sel2" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].jobVessel.type" items="${icbfn:dropdown('vesselType', null)}" itemLabel="name" itemValue="value" />
                              </c:if>                              </td>

							 
                              <td  width="20%" class="TDShadeBlue">&nbsp;</td><a name="addVess${vesselCounter.index+1}"></a>
                              <td width="62" align="right" nowrap  class="TDShadeBlue"><div id="tablefunction" style="width:100px; text-align:center; margin-right:0;"><a href="#expan${vesselCounter.index}" onclick="javascript:expandAllv1(${vesselCounter.index},${fn:length(arrJobVessel.addJobProds)},'${command.jobOrder.jobType}');"><img src="images/icoexpandall.gif" alt="Expand All" width="20" height="17" border="0"/></a>&nbsp;
                <a href="#collap${vesselCounter.index}" onclick="javascript:collapseAllv1(${vesselCounter.index},${fn:length(arrJobVessel.addJobProds)},'${command.jobOrder.jobType}');"><img src="images/icocollapseall.gif" alt="Collapse All" width="20" height="17" border="0"/></a>
                <a href="#" onclick="onAddProduct('${vesselCounter.index}','${fn:length(arrJobVessel.addJobProds)}')"><img src="images/add.gif" alt="Add Product" width="13" height="12" border="0"/></a><a name="delProd${vesselCounter.index}"></a>
                <a href="#" onClick="javascript:onCopyVessel('${vesselCounter.index}','${fn:length(command.addJobVessels)}');"><img src="images/copy.gif" alt="Copy Vessel" width="13" height="12" hspace="1px" border="0" /></a><a name="copyVess${vesselCounter.index+1}">
                <a href="#"><img src="images/delete.gif" alt="Delete Vessel" width="13" height="12" hspace="1px" border="0"   onClick="onDeleteVessel(${vesselCounter.index })"/></a><a name="delvessel${vesselCounter.index}"></a></td>
                            </tr>
                          </tbody>
                        </table>
                        <!-- ------------------------VESSEL 1 Data ------------------------- -->
...
&nbsp;&nbsp;&nbsp;                </c:forEach>
                ...
                <table width="100%" border="0" cellpadding="0" cellspacing="0" class="OperationsTable" style="width:100%;">
                  <tr>
                    <th width="13" rowspan="2" valign="top" style="border-right:none;" > <div id="bluarrowrightv${vesselCounter.index }p${productCounter.index }" style="visibility:hidden; position:absolute; z-index: 5; margin-left:4px"> <a href="#sp${vesselCounter.index}${productCounter.index}"> <img src="images/bluarrowrightsml.gif" width="7" height="13" border="0" vspace="4" style="margin-top:2px;" onclick="javascript:showvproductTable(${vesselCounter.index },${productCounter.index },'${command.jobOrder.jobType}');"/> </a> </div>
                        <div id="bluarrowdownv${vesselCounter.index}p${productCounter.index }" style="visibility:visible;position:relative; z-index: 5; margin-top:6px "> <a href="#hp${vesselCounter.index}${productCounter.index}"> <img src="images/bluarrowdownsml.gif" width="13" height="7" border="0" vspace="4" onclick="javascript:hidevproductTable(${vesselCounter.index },${productCounter.index },'${command.jobOrder.jobType}');"/></a> </div></th>
                    <th width="255" class="TDShadeGrey"><f:message key="product"/>${ productCounter.index + 1}:<span class="redstar">*</span><a name="addProd${vesselCounter.index}${productCounter.index+1}"></a>
                        <form:input cssClass="inputBox" size="10" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.jobProductName" maxlength="256"/>
                    ...
                    <th width="480" align="left" nowrap="nowrap" class="TDShadeGrey" ><strong><f:message key="productGroup"/>:<span class="redstar">*</span></strong>
                        <form:select id="sel3" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.group" items="${icbfn:getProductGroups('productGroup', command.jobOrder)}" itemLabel="name" itemValue="value" /></th>
                    <th width="177" align="left" nowrap="nowrap" class="TDShadeGrey" >
					
					<c:if test="${command.jobOrder.jobType == 'INSP' || command.jobOrder.jobType=='MAR'}">
					Destination:
                      <form:input cssClass="inputBox" cssStyle="z-index:5;" size="30" maxlength="256"  path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.destination" id="V${vesselCounter.index}P${productCounter.index}Destination"/>
          ...
          minimumCharacters="3"/ -->  
                    ...
                    <th width="35"  align="right" nowrap="NOWRAP" class="TDShadeGreyDark" ><a href="#cprod${vesselCounter.index}${productCounter.index}" onclick="javascript:onCopyProduct();popup_show('copyprod${vesselCounter.index }${productCounter.index }', 'copyprod_drag${vesselCounter.index }${productCounter.index }', 'copyprod_exit${vesselCounter.index }${productCounter.index }', 'screen-corner', 120, 20);showFrmCopyProd();hideIt();"> <img src="images/copy.gif" alt="Copy Product" width="13" height="12" hspace="1px" border="0"/></a><a name="copyProduct${vesselCounter.index}${productCounter.index+1}"></a>&nbsp;<a href="#"><img src="images/delete.gif" alt="Delete Product" width="13" height="12" hspace="1px" border="0" onclick="onDeleteProduct(${vesselCounter.index},${productCounter.index })"/></a></th>
                  </tr>
                  <div id="product${productCounter.index}Container" style="z-index:1;">
            <tr>
                    <td colspan="6" style="border-right:#eeeeee 1px solid;"><!-- ------------------QUANTITY CONTAINER V1 ----------------------- -->
                        <c:if test="${command.jobOrder.jobType == 'INSP' || command.jobOrder.jobType=='MAR'}">
                          <div id="quantityContainerv${vesselCounter.index}p${productCounter.index}" class="quantityContainer" style="visibility:visible;" style="z-index:1;">
                            <table width="100%"  align="center" cellpadding="0" cellspacing="0" class="orderTable" style="border:none;" z-index:2;>
                              ...
                              <c:if test="${command.jobOrder.jobType == 'INSP' || command.jobOrder.jobType=='MAR'}">
                                <th width="3%" style="background-color:#f2f1f1;"><img src="images/spacer.gif" width="1" height="1" /></th>
                                <th width="10%" style="background-color:#f2f1f1;" ><f:message key="orderedQty"/></th>
                                <th width="10%" style="background-color:#f2f1f1;" ><f:message key="uom"/></th>
                                <th width="13%" style="background-color:#f2f1f1;" ><f:message key="option"/></th>
                                <th width="7%" style="background-color:#f2f1f1;" ><b><f:message key="+"/></b></th>
                                <th width="7%" style="background-color:#f2f1f1;" >&nbsp;</th>
                                <th width="18%" style="background-color:#f2f1f1;" ><f:message key="vesselorDrafts"/> </th>
                                <th width="12%" style="background-color:#f2f1f1;" ><f:message key="tanks"/></th>
                                <th width="10%" align="right" style="border-right:none"><div id="div14" style="text-align:right;"> <a href="#"><img src="images/add.gif" alt="Add Quantity" width="13" height="12" hspace="1px" align="right" border="0" onclick="onAddQty(${vesselCounter.index},${productCounter.index})"/> </a><a name="addQuantity${vesselCounter.index}${productCounter.index}"></a><a name="delQuantity${vesselCounter.index}${productCounter.index}"></a>
                                                </c:if>
                                        </div></th>
                              </tr>
                              <c:if test="${command.jobOrder.jobType == 'INSP' || command.jobOrder.jobType=='MAR'}">
                                <tr>
								  ...
								  <c:otherwise>
								  <form:input cssClass="inputBox" cssStyle="text-align:right; background-color:#d2e1ff; color:#000099;" size="15" maxlength="15"  path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.productQty"/>
								  </c:otherwise>
                                  </c:choose>                                    
                                  ...
                                  <td width="10%" >
                                      <form:select id="sel4" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.uom" items="${icbfn:dropdown('staticDropdown',UOM)}" itemLabel="name" itemValue="value" />
                                      <form:errors path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.uom" cssClass="redstar"/></td>
                                  <td width="10%">
                                      <form:select id="sel5" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.option" items="${icbfn:dropdown('staticDropdown',option)}" itemLabel="name" itemValue="value" />
                                      <form:errors path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.option" cssClass="redstar"/></td>
                                  <td width="7%">
                                      <form:select id="sel6" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.plusMinus" items="${icbfn:dropdown('staticDropdown',plusMinus)}" itemLabel="name" itemValue="value" />
                                  ...
                                  <td width="7%">
                                      <form:input cssClass="inputBox" cssStyle="width:20px;" size="3"  path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.plusMinusPct"/>
                                    ...
                                    % </td>
                                  <td width="7%">
                                      <form:input cssClass="inputBox"  size="10" maxlength="64"  path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.drafts"/>
                                      <form:errors path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.drafts" cssClass="redstar"/></td>
                                  <td width="12%">
                                      <form:input cssClass="inputBox" size="10" maxlength="256"  path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProd.tanks"/>
                                ...
                                <c:forEach items="${arrJobProd.jobProdQtys}" var="arrJobProdQty" varStatus="qtyCounter">
                                  <tr >
                                    ...
                                    <td width="10%" align="left">&nbsp;${arrJobProdQty.uom}
                                      <%--<form:select id="sel4" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProdQtys[${qtyCounter.index}].uom" items="${icbfn:dropdown('UOM', null)}" itemLabel="name" itemValue="value" />--%>
                                    </td>
                                    <td width="13%" align="left">${arrJobProd.optionDesc}
                                      <%--<form:select id="sel5" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProdQtys[${qtyCounter.index}].option" items="${icbfn:dropdown('option', null)}" itemLabel="name" itemValue="value" /> --%>
                                    </td>
                    ...
                    <form:errors path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProdQtys[${qtyCounter.index}].plusMinusPct" cssClass="redstar"/>     --%>
                                      % </td>
                                    <td width="18%" align="left"><form:input cssClass="inputBox"  size="10" maxlength="64"  path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProdQtys[${qtyCounter.index}].drafts"/>
                                    ...
                                    <td width="12%" align="left"><form:input cssClass="inputBox" size="10" maxlength="256"  path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobProdQtys[${qtyCounter.index}].tanks"/>
                                    ...
                                    <td width="10%" align="right" style="text-align:right; border-right:none;"><div id="div" style="text-align:ri"><a href="#"><img src="images/delete.gif" alt="Del Row" width="13" height="12" hspace="1" border="0" onclick="onDeleteQty(${vesselCounter.index},${productCounter.index},${qtyCounter.index })"/></a>&nbsp; </div></td>
                                  </tr>
                                </c:forEach>
                              </table>
                            </div>
                        ...
                        <div id="inspectionContainerv${vesselCounter.index }p${productCounter.index }" class="inspectionContainer" style="z-index:1;">
                          <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" style="border:none;">
                            <tr >
                              ...
                              <th width="207" style="background-color:#f2f1f1;" ><f:message key="events"/></th>
                              <th width="568" style="background-color:#f2f1f1;" ><f:message key="eventInstructions"/> </th>
                              <th width="100" align="left" nowrap="nowrap" style="background-color:#f2f1f1; text-align:left;"><f:message key="sort"/>#</th>
                              <th width="15" align="right" style="border-right:none;text-align:right;">
                                        <div id="div19" style="width:25px;"><a href="#"><img src="images/add.gif" alt="Add row" width="13" height="12" hspace="1px" border="0" align="right" onClick="onAddEvent(${vesselCounter.index },${productCounter.index })"/></a><a name="addEventRow${vesselCounter.index }${productCounter.index }"></a><a name="delEventRow${vesselCounter.index }${productCounter.index }"></a>
										<a name="popEventInstr${vesselCounter.index }${productCounter.index }"></a></div></th>
                            </tr>
                          </table>
                            ...
                            <table width="100%" class="orderTable"  border="0" align="center" cellpadding="00" cellspacing="0" style="border:none;">
                              <c:forEach items="${arrJobProd.jobEvents}" var="arrJobEvents" varStatus="eventCounter">
                                <tr >
                                  ...
                                  <td width="553" ><form:input cssClass="inputBox" size="60" maxlength="200"  path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobEvents[${eventCounter.index}].eventInstructions"/>
                                      <form:errors path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobEvents[${eventCounter.index}].eventInstructions" cssClass="redstar"/>                                  </td>
                                  <td width="96" align="left" style="text-align:left"><form:input cssClass="inputBox" cssStyle="width:13px; text-align:right" size="2" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].jobEvents[${eventCounter.index}].sortOrder"/>
                                  ...
                                  <td width="50" style="text-align:right; border-right:none;"><div id="div19"> <a href="#"><img src="images/delete.gif" alt="Del Row" width="13" height="12" hspace="1" border="0" onclick="onDeleteEvent(${vesselCounter.index},${productCounter.index},${eventCounter.index})"/></a>&nbsp;</div></td>
                                </tr>
                              </c:forEach>
                            </table>
                          </div>
                      ...
                      <!-- -----------------Inspection Table V1 END ---------------------- -->
                        ...
                        <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="0" style="border:none;">
                          <tr >
                            ...
                            <th width="12%" align="left" nowrap="nowrap" style="background-color:#f2f1f1; text-align:left" ><f:message key="sampleLoc"/></th>
                            ...
                            <th width="8%" align="left" nowrap="nowrap" style="background-color:#f2f1f1;" ><f:message key="sampleVol"/></th>
                            <th width="10%" align="left" nowrap="nowrap" style="background-color:#f2f1f1;" ><f:message key="containerType"/></th>
                            <th width="10%" align="left" nowrap="nowrap" style="background-color:#f2f1f1;" ><f:message key="retainTested"/></th>
							<th width="9%" align="left" nowrap="nowrap" style="background-color:#f2f1f1;" ><f:message key="priority"/></th>
                            <th width="7%" align="left" style="background-color:#f2f1f1;" nowrap="nowrap" ><f:message key="sort"/>#</th>
                           <%-- <th width="6%" style="background-color:#f2f1f1;" ><a href="#"><img src="images/add.gif" alt="Add row" width="13" height="12" hspace="1px" border="0" align="right" onclick="onAddSampleLoc(${vesselCounter.index },${productCounter.index},${fn:length(arrJobProd.addJobProdSamples)})"/></a><a name="delRowSample${vesselCounter.index}${productCounter.index}"></a> </th>--%>                          		                            
                             <th width="6%" style="background-color:#f2f1f1;" ><a href="#addsamp${vesselCounter.index}${productCounter.index}"  onclick="onAddSampleLoc(${vesselCounter.index },${productCounter.index},${fn:length(arrJobProd.addJobProdSamples)}); popup_show('sampleLoc${vesselCounter.index}${productCounter.index}', 'sampleLoc_drag${vesselCounter.index}${productCounter.index}', 'sampleLoc_exit${vesselCounter.index}${productCounter.index}', 'screen-corner', 120, 20);hideIt();popupboxenable();showPopupDiv('sampleLoc${vesselCounter.index}${productCounter.index}','sampleLocBody${vesselCounter.index}${productCounter.index}');"><img src="images/add.gif" alt="Add Sample Location(s)" width="13" height="12" hspace="1px" border="0" align="right"/></a>							
							 <a name="delRowSample${vesselCounter.index}${productCounter.index}"></a> </th>
                           </tr>
                        </table>
                      <div id="sampleloctablev${vesselCounter.index }p${productCounter.index }" style="visibility:visible; display:block;width:100%">
                          <table width="100%"  class="orderTable"  border="0" align="center" cellpadding="00" cellspacing="0" style="border:none;">
                            ...
                            <form:hidden path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].displayStatus" />   
                              <tr >
                                <td width="4%"><img src="images/spacer.gif" width="15" height="1" /></td>
                                <td width="12%" align="left" nowrap="nowrap"><span class="redstar">*</span>
                                    <form:select id="sel8" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobProdSample.jobSampleLocation" items="${icbfn:dropdown('staticDropdown',sampleLocation)}" itemLabel="name" itemValue="value" /></td>
                                <td width="7%" align="left"><form:input cssClass="inputBox"  size="5" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobProdSample.sampleNumber"/>
                                ...
                                <td  width="7%" align="left"><form:input cssClass="inputBox" cssStyle="text-align:right;" size="5" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobProdSample.tankNumber" maxlength="254"/>
								...
								<c:if test="${command.jobOrder.jobType == 'INSP' || command.jobOrder.jobType=='MAR'}">
                                <td  width="11%" align="left"><form:select id="sel9" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobProdSample.sampleTiming" items="${icbfn:dropdown('staticDropdown',sampleTiming)}" itemLabel="name" itemValue="value" /></td>
                                <td  width="10%" align="left"><form:select id="sel10" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobProdSample.sampleType" items="${icbfn:dropdown('staticDropdown',sampleType)}" itemLabel="name" itemValue="value" /></td>
								</c:if>
                                <td  width="8%" align="left"><form:select id="sel11" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobProdSample.sampleVolume" items="${icbfn:dropdown('staticDropdown',sampleVolume)}" itemLabel="name" itemValue="value" /></td>
                                <td  width="10%"  align="left" ><form:select id="sel12" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobProdSample.containerType" items="${icbfn:dropdown('staticDropdown',containerType)}" itemLabel="name" itemValue="value" /></td>
                                <td align="left"  width="10%"><form:select id="sel13" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobProdSample.retainTested" items="${icbfn:dropdown('staticDropdown',retainTested)}" itemLabel="name" itemValue="value" onchange="setLabAnalysisFlag('${vesselCounter.index}${productCounter.index}${sampleCounter.index}')"/>								
								</td>
								...
								<a name="priorityScroll${vesselCounter.index}${productCounter.index}${sampleCounter.index}"></a>

                                <td  width="10%" align="left" ><form:input cssClass="inputBox" cssStyle="width:13px; text-align:right" size="2" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobProdSample.sortOrder"/>
								...
								<a name="delRowSlate${vesselCounter.index}${productCounter.index}${sampleCounter.index}"></a>
                                <a href="#"><img src="images/delete.gif" alt="Delete Sample"  width="12" height="12" hspace="1px" border="0" onclick="onDeleteSampleLoc(${vesselCounter.index},${productCounter.index},${sampleCounter.index })"/></a> &nbsp;</div></td>
                              </tr>
                              <tr >
                                <td colspan="11" align="center" ><div align="center" id="sampleloctablev${vesselCounter.index}p${productCounter.index}s${sampleCounter.index }" style="visibility:visible; display:block;">
                                    <table width="80%"  border="0" align="center" cellpadding="0" cellspacing="0" style="width:100%; border:none;">
                                      <tr>
                                        <td><input type="checkbox"  id="selectAll${vesselCounter.index}${productCounter.index}${sampleCounter.index}" onClick="selectAllTestsSlates('${vesselCounter.index}','${productCounter.index}','${sampleCounter.index}',${fn:length(command.addJobVessels[vesselCounter.index].addJobProds[productCounter.index].addJobProdSamples[sampleCounter.index].jobTests)},${fn:length(command.addJobVessels[vesselCounter.index].addJobProds[productCounter.index].addJobProdSamples[sampleCounter.index].jobManualTests)},${fn:length(command.addJobVessels[vesselCounter.index].addJobProds[productCounter.index].addJobProdSamples[sampleCounter.index].jobSlates)})" /></td>
                                        <td><a href="#" onclick="javascript:onAddTest(${vesselCounter.index},${productCounter.index},${sampleCounter.index },${fn:length(arrAddJobProdSamples.jobTests)},${fn:length(arrAddJobProdSamples.jobManualTests)},${fn:length(arrAddJobProdSamples.jobSlates)});setChosenContracts(${vesselCounter.index},${productCounter.index},${fn:length(arrJobProd.applicableContracts)});popup_show('test', 'test_drag', 'test_exit', 'screen-corner', 120, 20);hideIt();popupboxenable();updateTestIFrameSrc('${vesselCounter.index}','${productCounter.index}','${sampleCounter.index }','${command.jobOrder.nominationDate }')"><f:message key="addTests"/></a>
										<a name="testAdd${vesselCounter.index}${productCounter.index}${sampleCounter.index}"></a>
										</td>
										<td><a href="#" onclick="javascript:onAddManualTest(${vesselCounter.index},${productCounter.index},${sampleCounter.index },${fn:length(arrAddJobProdSamples.jobTests)},${fn:length(arrAddJobProdSamples.jobManualTests)},${fn:length(arrAddJobProdSamples.jobSlates)});setChosenContracts(${vesselCounter.index},${productCounter.index},${fn:length(arrJobProd.applicableContracts)});popup_show('test', 'test_drag', 'test_exit', 'screen-corner', 120, 20);hideIt();popupboxenable();updateManualTestIFrameSrc('${vesselCounter.index}','${productCounter.index}','${sampleCounter.index }','${command.jobOrder.nominationDate }','${command.jobOrder.jobNumber}')"><f:message key="addManualTest"/></a>
										<a name="testAdd${vesselCounter.index}${productCounter.index}${sampleCounter.index}"></a>
										</td>
                                        <td><a href="#" onclick="javascript:onAddSlate(${vesselCounter.index},${productCounter.index},${sampleCounter.index },${fn:length(arrAddJobProdSamples.jobTests)},${fn:length(arrAddJobProdSamples.jobManualTests)},${fn:length(arrAddJobProdSamples.jobSlates)});setChosenContracts(${vesselCounter.index},${productCounter.index},${fn:length(arrJobProd.applicableContracts)});popup_show('slate', 'slate_drag', 'slate_exit', 'screen-corner', 120, 20);hideIt();popupboxenable();updateSlateIFrameSrc('${vesselCounter.index}','${productCounter.index}','${sampleCounter.index }','${command.jobOrder.nominationDate }')"><f:message key="addSlates"/></a>
										<a name="slateAdd${vesselCounter.index}${productCounter.index}${sampleCounter.index}"></a>
										</td>
                                        <td><a href="#"><img src="images/icodel.gif" alt="Delete Tests/Slates"  width="12" height="12" hspace="1px" border="0" onclick="onMassDeleteTestSlate(${vesselCounter.index},${productCounter.index},${sampleCounter.index },${fn:length(command.addJobVessels[vesselCounter.index].addJobProds[productCounter.index].addJobProdSamples[sampleCounter.index].jobTests)},${fn:length(command.addJobVessels[vesselCounter.index].addJobProds[productCounter.index].addJobProdSamples[sampleCounter.index].jobManualTests)},${fn:length(command.addJobVessels[vesselCounter.index].addJobProds[productCounter.index].addJobProdSamples[sampleCounter.index].jobSlates)})"/></a>
                                        <a name="delTotTest${vesselCounter.index}${productCounter.index}${sampleCounter.index}"></a>
                                        </td>
                                        <td>
                                      ...
                                      <c:forEach items="${arrAddJobProdSamples.jobTests}" var="arrJobTests" varStatus="jobTestCounter">
                                        <tr>
                                          ...
                                          <td width="11%"><form:input cssClass="inputBox" size="20" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobTests[${jobTestCounter.index }].test.testId" disabled="true"/>
                                              <form:errors path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobTests[${jobTestCounter.index }].test.testId" cssClass="redstar"/>                                          </td>
                                          <td width="20%"><form:input cssClass="inputBox" size="50" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobTests[${jobTestCounter.index }].test.testDescription" disabled="true"/>
                                              <form:errors path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobTests[${jobTestCounter.index }].test.testDescription" cssClass="redstar"/>                                          </td>
                                          <td width="5%" nowrap="nowrap" align="center">&nbsp;&nbsp;&nbsp;&nbsp;</td>
										  <td width="22%" nowrap="nowrap" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Qty.&nbsp;&nbsp;
                                              <form:input cssClass="inputBox" size="4" id="testqty${vesselCounter.index }${productCounter.index }${sampleCounter.index }${jobTestCounter.index }" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobTests[${jobTestCounter.index }].quantity" maxlength="8"/>
                                              <form:errors path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobTests[${jobTestCounter.index }].quantity" cssClass="redstar"/>                                          </td>
                                          <td width="16%" nowrap="nowrap" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;OT
                                            <form:select cssClass="selectionBox" id="testot${vesselCounter.index }${productCounter.index }${sampleCounter.index }${jobTestCounter.index }" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobTests[${jobTestCounter.index }].ot" items="${icbfn:dropdown('staticDropdown',yesNo)}" itemLabel="name" itemValue="value" onchange="setOtApprovedFlag('${vesselCounter.index}${productCounter.index}${sampleCounter.index}${jobTestCounter.index }','')"/>
                                            &nbsp;&nbsp; </td><a name="testOtScroll${vesselCounter.index }${productCounter.index }${sampleCounter.index }${jobTestCounter.index}"></a>
                                          <td width="14%" ><div align="right"> <a href="#"><img src="images/delete.gif" alt="Del Row" width="13" height="12" hspace="1" border="0" onclick="onDeleteTest(${vesselCounter.index},${productCounter.index},${sampleCounter.index },${jobTestCounter.index })"/></a>&nbsp;</div></td>
										  <td nowrap>&nbsp;&nbsp;</td>
                                        </tr>
                                      </c:forEach>
                                      ...
                                      <c:forEach items="${arrAddJobProdSamples.jobSlates}" var="arrJobSlates" varStatus="jobSlateCounter">
                                        <tr>
                                          ...
                                          <td width="11%"><form:input cssClass="inputBox" size="20" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobSlates[${jobSlateCounter.index }].slate.slateId" disabled="true"/>
                                              <form:errors path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobSlates[${jobSlateCounter.index }].slate.slateId" cssClass="redstar"/>                                          </td>
                                          <td width="20%"><form:input cssClass="inputBox" size="50" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobSlates[${jobSlateCounter.index }].slate.slateDescription" disabled="true"/>
                                              <form:errors path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobSlates[${jobSlateCounter.index }].slate.slateDescription" cssClass="redstar"/>                                          </td>
                                          <td width="5%" nowrap="nowrap" align="center">&nbsp;&nbsp;&nbsp;&nbsp;</td>
										  <td width="22%" nowrap="nowrap" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<f:message key="qty"/>.&nbsp;&nbsp;
                                              <form:input cssClass="inputBox" size="4" id="slateqty${vesselCounter.index }${productCounter.index }${sampleCounter.index }${jobSlateCounter.index }" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobSlates[${jobSlateCounter.index }].quantity" maxlength="8"/>
                                              <form:errors path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobSlates[${jobSlateCounter.index }].quantity" cssClass="redstar"/>                                          </td>
                                          <td width="16%" nowrap="nowrap" align="center">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<f:message key="ot"/>
                                            <form:select id="slateot${vesselCounter.index }${productCounter.index }${sampleCounter.index }${jobSlateCounter.index }" cssClass="selectionBox" path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobSlates[${jobSlateCounter.index }].ot" items="${icbfn:dropdown('staticDropdown',yesNo)}" itemLabel="name" itemValue="value" onchange="setOtApprovedFlag('${vesselCounter.index}${productCounter.index}${sampleCounter.index}${jobSlateCounter.index}','')"/>
                                            &nbsp;&nbsp; </td><a name="testOtScroll${vesselCounter.index }${productCounter.index }${sampleCounter.index }${jobSlateCounter.index}"></a>
                                          <td width="14%" ><div align="right"> <a href="#"><img src="images/delete.gif" alt="Del Row" width="13" height="12" hspace="1" border="0" onclick="onDeleteSlate(${vesselCounter.index},${productCounter.index},${sampleCounter.index },${jobSlateCounter.index })"/></a>&nbsp;</div></td>
										  <td nowrap>&nbsp;&nbsp;</td>
                                        </tr>
                                      </c:forEach>
                                      <tr>
                                        <td colspan="6" align="left"><table  border="0" cellpadding="0" cellspacing="0" style="width:100%">
                                            <tr>
                                              ...
                                              <td colspan="5" width="85%" style="border-bottom:none; border-right:none;"><label>
                                                <form:textarea cols="90" rows="4"  path="addJobVessels[${vesselCounter.index}].addJobProds[${productCounter.index}].addJobProdSamples[${sampleCounter.index}].jobProdSample.sampleInstructions"/>
   ...
   <div class="menu_form_header" id="sampleLoc_drag${vesselCounter.index}${productCounter.index}" style="width:600px;">
     <a href="#"  onclick="resetJob()"><img class="menu_form_exit" id="sampleLoc_exit${vesselCounter.index}${productCounter.index}" src="images/form_exit.png"/></a>&nbsp;&nbsp;&nbsp;
       <f:message key="selectSampleLocation"/></div>
           <div class="menu_form_body" id="sampleLocBody${vesselCounter.index}${productCounter.index}" style="width:600px; height:300px;overflow-y:hidden;">
...
<iframe align="left" frameborder="0" style="padding:0px;" height="300px;" width="100%" src="search_vessel_popup.htm?inputFieldId=addJobVessels[${vesselCounter.index}].jobVessel.vesselName&rowNum=${vesselCounter.index}&searchForm=jobOrderCreateOpInstrForm" scrolling="auto" id="searchcontractFr" name="searchcontractFr" allowtransparency="yes" ></iframe>
</div>
</div>
<!-- --------------------------- Search Vessel Popup ------------------------------------------------- -->
	<SCRIPT LANGUAGE="JavaScript">
        ...
        <tr><td></td></tr>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="InnerApplTable">
                <tr>
                  ...
                  <td width="871" class="TDShade"><a name="instructions" id="instructions"></a><f:message key="instructions"/></td>
                  <td  width="64" class="TDShade">&nbsp;</td>
                </tr>
                <tr>
                      ...
                      <table class="orderTable" width="100%" border="0" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                          <td align="center"><label>
                            <form:textarea cols="60" rows="4" path="jobOrder.inspInstructions" />
                            <form:errors path="jobOrder.inspInstructions" cssClass="redstar"/>
                          </label></td>
                          <td align="center"><form:textarea cols="60" rows="4" path="jobOrder.sampInstructions" />
                              <form:errors path="jobOrder.sampInstructions" cssClass="redstar"/>
                          </td>
                        </tr>
                        <tr>
                          <td colspan="2"><table width="80%" border="0" align="center" cellpadding="0" cellspacing="0" class="orderTable" style="margin:0px;">
                              <tr>
                              ...
                              <tr>
                                ...
                                <td><label>
                                  <form:input cssClass="inputBox" size="4" path="jobOrder.retainPeriod" maxlength="4"/>
                                ...
                                <td><label>
                                  <form:select id="sel1" cssClass="selectionBox" path="jobOrder.otApprovedby" items="${icbfn:dropdown('scheduler', jobDetail)}" itemLabel="name" itemValue="value" multiple="true"/>
                        ...
                        <tr>
                          <td align="center"><form:textarea cols="60" rows="4" path="jobOrder.labInstructions"/>
                              <form:errors path="jobOrder.labInstructions" cssClass="redstar"/>
                          </td>
                          <td align="center"><form:textarea cols="60" rows="4" path="jobOrder.shipInstructions"/>
                        ...
                        <tr>
                          <td align="center"><form:textarea cols="60" rows="4" path="jobOrder.reptInstructions"/>
                              <form:errors path="jobOrder.reptInstructions" cssClass="redstar"/>
                          </td>
                          <td align="center"><form:textarea cols="60" rows="4" path="jobOrder.billInstructions"/>
                        ...
                        <tr>
                          <td><form:textarea cols="60" rows="4" path="jobOrder.otherInstructions"/>
			  ...
			  <table width="100%" border="0" cellpadding="0" cellspacing="0" class="applTableBot">
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        <td align="right"></td>
                        <td style="text-align:right"><a href="#"><img src="images/ico_print.gif" alt="Print Job Order" width="18" height="16" hspace="2" border="0" align="absmiddle" title="Print Job Order"></a>
                        <c:if test="${command.samBranchFlag}">
                        <a href="#"><img src="images/icoship.gif" alt="Send To SAM" hspace="2" border="0" align="absmiddle" title="Send To SAM"></a>
                        </c:if>
                        <c:if test="${command.limsBranchFlag}">
...
<table width="98%" align="center" cellpadding="0" cellspacing="0" class="InnerApplTable" style="margin-bottom:15px;">
  <tbody>
    ...
    <tr>
      <th class="TDShade"><f:message key="integrationType"/></th>
      <th class="TDShade"><f:message key="integrationUser"/></th>
      <th class="TDShadeBlue"><f:message key="dateTime"/></th>
      <th class="TDShadeBlue"><f:message key="integrationStatus"/></th>
      <th class="TDShadeBlue" width="20%"><f:message key="errorMessage"/></th>
    </tr>
    <tr>
      <td class="TDShade"><f:message key="lims"/></td>
...
<f:message key="both"/></td>
        ...
        <tr>
          ...
          <td><input name="textfield2" type="text" class="inputBox" size="25" value="ASTMD44" />&nbsp;&nbsp;<f:message key="in"/>&nbsp;&nbsp;</td>
