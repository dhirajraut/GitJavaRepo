...
<div class="form" style="text-align:center;"">
  <table>
    <tr><td colspan="3"><h2>Create Job Order - Prebill</h2></td></tr>
    ...
    <tr>
      <td colspan="3">
        <input type="submit" class="submitbutton" name="_target1" value="Prev" />
        <input type="submit" class="submitbutton" name="_target3" value="Next" />
