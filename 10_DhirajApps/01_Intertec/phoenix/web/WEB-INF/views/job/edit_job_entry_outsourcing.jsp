...
function setform()
{
 ...
 //hideIt();
  ...
  if (isAdd(code.value) == false) {
    ...
    document.editJobsOutSourcingForm.ccode.focus();
  document.editJobsOutSourcingForm.ccode.value="";
  return false;
    }
  ...
  return false;
   ...
   document.editJobsOutSourcingForm.uniqueFlag.value="uniqueFlag";
    document.editJobsOutSourcingForm.submit();
    } 
}
...
{
document.editJobsOutSourcingForm.jobFlag.value="none";
document.editJobsOutSourcingForm.jobIndex.value = index;
document.editJobsOutSourcingForm.deleteFlag.value ="delval";
document.editJobsOutSourcingForm.submit();
}
}
...
function setsubflag()
{
document.editJobsOutSourcingForm.jobValFlag.value="newjobval";
document.editJobsOutSourcingForm.tabName.value = "1";
}

function setcontactflag(rowIndex)
{
document.editJobsOutSourcingForm.jobFlag.value="none";
document.editJobsOutSourcingForm.contactIndex.value=rowIndex;
document.editJobsOutSourcingForm.contactFlag.value="contFlag";
document.editJobsOutSourcingForm.tabName.value="1";
}

function setAttachFilesFlag(rowIndex)
{
document.editJobsOutSourcingForm.attachFilesFlag.value=rowIndex;
document.editJobsOutSourcingForm.tabName.value="1";
}
...
{
document.editJobsOutSourcingForm.nextPageFlag.value = "1";
...
function checkSearchField()
{
  ...
  return false;
    ...
    {
      document.editJobsOutSourcingForm.goFlag.value="true";  
    document.editJobsOutSourcingForm.operationFlag.value = "operation";
    submitform();
    }
}
...
{
 document.editJobsOutSourcingForm.jobFlag.value="none";
 document.editJobsOutSourcingForm.popFlag.value="none";
document.editJobsOutSourcingForm.contactFlag.value="none";
  document.editJobsOutSourcingForm.uniqueFlag.value="none";
  setpage();
}
...
if(index>1)
{
 ...
 function updateJobDescription(dateFormat,jobDescExist)
  {
   var w = document.editJobsOutSourcingForm.sel5.selectedIndex;
   var ops_text = document.editJobsOutSourcingForm.sel5.options[w].text;
...
function jobDescDate(date,dateFormat)
{
  ...
  function nextList()
  {
    //document.editJobsOutSourcingForm.nextListFlag.value="next";
    document.editJobsOutSourcingForm.showNextListFlag.value="next";
	// START : #119240
	document.editJobsOutSourcingForm.operationFlag.value="none";
	document.editJobsOutSourcingForm.jobFlag.value="none";
	document.editJobsOutSourcingForm.deleteFlag.value="none";
	document.editJobsOutSourcingForm.contactFlag.value="none";
	document.editJobsOutSourcingForm.uniqueFlag.value="none";
	document.editJobsOutSourcingForm.bankFlag.value="none";
	document.editJobsOutSourcingForm.jobDateFlag.value="none";
	document.editJobsOutSourcingForm.warnUserFlag.value="none";
	// END : #119240
    document.editJobsOutSourcingForm.submit();
  }
  ...
  function prevList()
  {
   // document.editJobsOutSourcingForm.prevListFlag.value="prev";
    document.editJobsOutSourcingForm.showPrevListFlag.value="prev";
	// START : #119240
	document.editJobsOutSourcingForm.operationFlag.value="none";
	document.editJobsOutSourcingForm.jobFlag.value="none";
	document.editJobsOutSourcingForm.deleteFlag.value="none";
...
function noPrevList()
{
	document.editJobsOutSourcingForm.noPrevJob.value="true";
	document.editJobsOutSourcingForm.submit();
}

function noNextList()
{
	document.editJobsOutSourcingForm.noNextJob.value="true";
	document.editJobsOutSourcingForm.submit();
}
// END : #119240
...
{
document.editJobsOutSourcingForm.tabName.value=val;
}   
...
function monjobnumberFlag(index,jobnumber){
  ...
  document.getElementById("anchor"+index).style.visibility="hidden";
    ...
    {
      document.editJobsOutSourcingForm.monthlyJobFlag.value="monthlyid";
      document.editJobsOutSourcingForm.rowNum.value=index;
...
/*function checkForRebill(elemid,index,contractCode,jobContractId)
{
  ...
  if(status == '7100' || status == '7200')
  {
    document.editJobsOutSourcingForm.rebillFlag.value="rebill";
    document.editJobsOutSourcingForm.contractIndex.value=index;
...
{  
  ...
  document.getElementById("creditreasonbox_" + index).src="credit_reason_popup.htm?contractCode=" + contractCode + "&jobContractId=" + jobContractId + "&contractIndex=" + index+ "&controllerName=EditJobOrderOutSourcingFormController";                            
...
{ 
 ...
 document.editJobsOutSourcingForm.errorFlag.value="none";
 document.editJobsOutSourcingForm.uniqueFlag.value="uniqueFlag";
...
function selectJobDateBoolean(flag)
 {
 document.editJobsOutSourcingForm.jobDateFlag.value="jobDate";
  document.editJobsOutSourcingForm.dateFlag.value=flag;
 if(flag=='true')
 document.editJobsOutSourcingForm.openPeriodsFlag.value="true";
 else
 document.editJobsOutSourcingForm.openPeriodsFlag.value="false";
 document.editJobsOutSourcingForm.submit();
 }
...
document.editJobsOutSourcingForm.showWarn.value="false";
}
function warnUser(navigationUrl)
{
  if(document.editJobsOutSourcingForm.warnUserFlag.value == 'warn' || document.editJobsOutSourcingForm.warnUserFlag.value == 'warned')
    document.editJobsOutSourcingForm.warnUserFlag.value = 'navigate';
  else
    document.editJobsOutSourcingForm.warnUserFlag.value = "warn";
    
  document.editJobsOutSourcingForm.navigationUrl.value = navigationUrl;
  document.editJobsOutSourcingForm.submit();
}
...
<form:form name="editJobsOutSourcingForm" method="POST" action="edit_job_entry_outsourcing.htm">
...
<form:select id="projectTypes" cssClass="selectionBox" path="phxProjectType" items="${command.projectTypes}" itemLabel="name" itemValue="value" disabled="${command.projectTypeViewOnly}" />
		...
		<!-- END : #119240 -->
              ...
              title="Save and Go to Next Page"></a><a href="#" onclick="updateJobDescription('${command.dateFormat}');setTabName('0');checkcount('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}');<%--checkDate('${command.dateFormat}','${command.userTimeFormat}');--%>"><img src="images/icosave.gif"
    ...
    <td class="TDShadeBlue"><form:select id="sel5"  cssClass="selectionBoxbig" path="jobOrder.operation"  items="${icbfn:dropdown('jobOperations', operations)}" itemLabel="name" itemValue="value" disabled="${command.viewOnly && !(reopenViewOnly && (empty command.jobOrder.operation || empty fn:trim(command.jobOrder.operation)))}"/> <form:errors path="jobOrder.operation" cssClass="redstar" /></td>
          ...
          <form:input cssClass="inputBox" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" size="52" maxlength="128" path="jobOrder.receivedByUserName" disabled="${command.viewOnly}"/>
         <form:errors path="jobOrder.receivedByUserName" cssClass="redstar"/>
     <c:if test="${command.viewOnly}">
                   <a href="#" onClick="javascript:popup_show('salesrep','salesrep_drag','salesrep_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('salesrep','salesrepbody');popupboxenable();"> <img src=" images/lookup.gif" alt="Lookup Salesrep" width="13" height="13" border="0" /></a>
           </c:if></td>
                </tr>
               <tr>
        ...
        <a href="#" onClick="displayCalendar(document.forms[0].quotedate,'${command.dateFormat}',this)"> <img src=" images/calendar.gif" width="15" height="17"  align="absmiddle" border="0"/></a> &nbsp;&nbsp;<strong><f:message key="quoteID"/>:</strong></td>
    ...
    <c:when test="${command.userTimeFormat != 'AM/PM'}">
        <td class="TDShade"><strong><f:message key="nominationDate"/>:</strong></td>
                <td class="TDShadeBlue"><form:input id="nomdate" cssClass="inputBox" path="jobOrder.nominationDate" size="20" disabled="${command.viewOnly && !(reopenViewOnly && empty command.jobOrder.nominationDate)}"/>
    ...
    <c:if test="${!command.viewOnly || (reopenViewOnly && empty command.jobOrder.nominationDate)}">
     ...
     </c:if>&nbsp;<f:message key="time"/>:&nbsp
         <form:input id="nomTimes" size="4" cssClass="inputBox" path="uiNominationTime" disabled="${command.viewOnly}"/> 
    ...
    <c:when test="${command.userTimeFormat != 'AM/PM'}">
                ...
                <td width="45%" colspan="4" class="TDShadeBlue"><form:input id="etadate" cssClass="inputBox" path="jobOrder.etaDate" onchange="selectJobDate('false','etadate');" disabled="${command.viewOnly && !(reopenViewOnly && empty command.jobOrder.etaDate)}"/>
	...
	<!-- END: 118717,119283 Fix for new requirement - 04 June 2009 -->              
           ...
           <form:input id="etaTimes" size="4" cssClass="inputBox" path="uiEtaTime" disabled="${command.viewOnly}"/> 
    ...
    <td class="TDShade"><strong><f:message key="eta" />:</strong></td>
        <td colspan="2" class="TDShadeBlue"><form:input id="etadate" size="11"
          ...
          path="jobOrder.etaDate" cssClass="redstar" />
           	<!-- START: 106438,118717,119283 Fix for new requirement - 04 June 2009 -->        
      <c:if test="${!command.viewOnly ||  (not empty command.jobOrder.jobFinishDate) || (reopenViewOnly && empty command.jobOrder.etaDate)}">
	<!-- END: 106438,118717,119283 Fix for new requirement - 04 June 2009 -->              
      <a href="#"
          onClick="displayCalendar(document.forms[0].etadate,'${command.dateFormat}',this)">
        <img src=" images/calendar.gif" width="15" height="17"
          align="absmiddle" border="0" /></a>
      </c:if>&nbsp<f:message
          key="time" />:&nbsp<form:input size="4" id="etaTimes" cssClass="inputBox"
      ...
      <!-- START: 118717 Fix for new requirement - 02 June 2009 -->
      <c:if test="${!command.viewOnly || (not empty command.jobOrder.jobFinishDate) || (!not empty command.jobOrder.jobFinishDate) || (reopenViewOnly && empty command.jobOrder.etaTimeTz)}">
	  <!-- END: 118717 Fix for new requirement - 02 June 2009 -->      
      <a href="#"
        ...
        <img src=" images/lookup.gif" alt="Lookup Time Zone" width="13" height="13" border="0" /></a>
         ...
         <tr>
                  ...
                  <td class="TDShadeBlue" width="10%" colspan="1"> <form:input cssClass="inputBox" size="52" maxlength="100" path="jobOrder.turnaroundTime" disabled="${command.viewOnly}"/>
...
<td colspan="4" class="TDShadeBlue"
     ...
     <div style="visibility: hidden; display: none;"> <form:input id="servloc" size="45"
          ...
          path="jobOrder.serviceLocation.name"/></div>
                ...
                <tr>
                <td valign="top" class="TDShade" ><strong><c:choose>
      ...
      <td>&nbsp;</td>
		...
		<!-- END : #119240 -->
					<a href="#" onClick="goToNextPage('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}')"><img src=" images/savennextbluarrow.gif" alt="Save and Go to Next Page" width="14" height="14" hspace="4" border="0" align="absmiddle" title="Save and Go to Next Page"></a><a href="#" ><img src=" images/icosave.gif" alt="Save" title="Save" width="14" height="14" border="0" align="absmiddle" onClick="javascript:updateJobDescription('${command.dateFormat}');setTabName('0');checkcount('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}');<%--checkDate('${command.dateFormat}','${command.userTimeFormat}');--%>" /></a></td>
                  </tr>
                </table></td>
            </tr>
          </table>
...
<f:message key="jobId" /> :${command.jobOrder.jobNumber}<img src=" images/separator2.gif" width="2"  height="27" align="absmiddle"
style="margin-left:5px;margin-right:5px;" />
<f:message key="jobTypeASandMNTesting"/>
&nbsp;&nbsp;&nbsp;
<f:message key="status" />: <form:select id="sel1"
...
<tr>
<iframe id="pu" align="left" frameborder="0" style="padding:0px;" height="670px;" width="100%" scrolling="auto" id="searchjobContractFr"
src="blank.html" name="searchjobContractFr" allowtransparency="yes" ></iframe>
</tr>
</table>
</div>
</div>
...
{  
document.editJobsOutSourcingForm.jobFlag.value="jobval";
document.editJobsOutSourcingForm.tabName.value = "1";
var buname=document.getElementById("sel3").value;
var code= scode;
...
document.getElementById('pu').setAttribute("src","search_job_contract_insp_popup.htm?inputFieldId=inputFieldIdValue&searchForm=editJobsOutSourcingForm&code="+code+"&pageNumber="+pageN0+"&buName="+buname+"&fromPage=7");
}
}
</script>
</c:when>
...
if(scode.charAt("/"))
{ code=scode.replace("/","'");}
document.editJobsOutSourcingForm.ccode.value=code;
document.editJobsOutSourcingForm.uniqueFlag.value="uniqueFlag";
document.editJobsOutSourcingForm.submit();
}
</script>
...
<td>
<form:select id="sel11" cssClass="selectionBoxint" path="addJobContracts[${counter.index}].jobContract.invoiceType" items="${icbfn:dropdown('staticDropdown',invoiceType)}" itemLabel="name" itemValue="value" disabled="${command.addJobContracts[counter.index].contractViewOnly}"/> </td>
</tr>
...
<iframe align="left" frameborder="0" style="padding:0px;" height="530px;" width="100%" src="blank.html" scrolling="auto" id="saccountframe${counter.index}" name="saccountframe${counter.index}" allowtransparency="yes" ></iframe></tr></table></div></div>
...
<iframe align="left" frameborder="0" style="padding:0px;" height="520px;" width="100%" src="blank.html" id="searchmonthlyJob${counter.index}" name="searchmonthlyJob${counter.index}" allowtransparency="yes"></iframe></div></div>
            ...
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td style="text-align:right"><a href="#" onClick="goToNextPage('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}')"><img src="images/savennextbluarrow.gif" alt="Save and Go to Next Page" width="14" height="14" hspace="4" border="0" align="absmiddle" title="Save and Go to Next Page"></a><a href="#" ><img src="images/icosave.gif" alt="Save" title="Save" width="14" height="14" border="0"  onclick="updateJobDescription('${command.dateFormat}');setTabName('1');checkcount('${command.custCount}','${command.dateFormat}','${command.userTimeFormat}');
        <%--checkDate('${command.dateFormat}','${command.userTimeFormat}');--%>"/></a></td>
                  </tr>
                </table>
            </td>
         </tr>
...
try{
			...
			if('' != objFnshDate.value && objFnshDate.value.length > 0){						
				document.editJobsOutSourcingForm.uiEtaTime.disabled = false;
				if(document.editJobsOutSourcingForm.etaTimeFormat){
					document.editJobsOutSourcingForm.etaTimeFormat.disabled = false;
				}	
