...
document.getElementById('searchContactFr'+index).setAttribute("src","search_contact_popup.htm?inputFieldId=addJobContracts["+index+"].jobContract.billingContact.id&rowNum="+index+"&searchForm=editJobsOutSourcingForm&divName=searchbillingcontact"+index+"&divbody=contactbody"+index+"&custCode="+customercode);
}
...
<form:form name="editJobsOutSourcingForm" method="POST" action="view_job_entry_outsourcing.htm">
...
<div id="tab1" class="innercontent">
          <table width="105%" cellpadding=0 cellspacing=0 class=mainApplTable>
            <tbody>
              <tr bgcolor=#ffffff>
...
<form:select id="projectTypes" cssClass="selectionBox" path="phxProjectType" items="${command.projectTypes}" itemLabel="name" itemValue="value" disabled="${command.projectTypeViewOnly}" />
		...
		<!-- END : #119240 -->
              ...
              <tr>
                ...
                <td class="TDShadeBlue" width="30%" ><form:input size="52" disabled="true" id="finishdate" cssClass="inputBox" path="jobOrder.jobFinishDate"/>
        <form:errors path="jobOrder.jobFinishDate" cssClass="redstar"/>
                  </td>
         
                  <td class="TDShade"><f:message key="turnaroundTime"/>:</td>
                  <td class="TDShadeBlue" width="40%" colspan="3"> <form:input disabled="true" size="52" cssClass="inputBox" maxlength="100" path="jobOrder.turnaroundTime"/>
        ...
        <form:input disabled="true" id="brnch" size="52"
      ...
      <td class="TDShadeBlue"><form:select id="sel5" disabled="true" cssClass="selectionBoxbig" path="jobOrder.operation"   items="${icbfn:dropdown('jobOperations', operations)}" itemLabel="name" itemValue="value" /> <form:errors path="jobOrder.operation" cssClass="redstar" /></td>
          ...
          <form:input size="52" disabled="true" cssClass="inputBox" maxlength="128" path="jobOrder.receivedByUserName"/>
         <form:errors path="jobOrder.receivedByUserName" cssClass="redstar"/>
                   <a href="#" onClick="javascript:popup_show('salesrep','salesrep_drag','salesrep_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('salesrep','salesrepbody');popupboxenable();"><%-- <img src=" images/lookup.gif" width="13" height="13" border="0" /> --%> </a></td>
                </tr>
                <tr>
        ...
        <input name="textfield92" type="text" class="inputBox" size="20" disabled="true"/>
         ...
         <form:input disabled="true" size="52" cssClass="inputBox" path="jobOrder.adminContactUserName"/>
          <form:errors path="jobOrder.adminContactUserName" cssClass="redstar"/> 
                    <a href="#" onClick="javascript:popup_show('admincontact','admincontact_drag','admincontact_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('admincontact','admincontactbody');popupboxenable();"> <%-- <img src=" images/lookup.gif" width="13" height="13" border="0" /></a> --%> </td>
                </tr>
                <tr>
        <td class="TDShade"><strong><f:message key="nominationDate"/>:<span class="redstar">*</span></strong></td>
                <td class="TDShadeBlue"><form:input disabled="true" id="nomdate" cssClass="inputBox" path="jobOrder.nominationDate"/>
        <form:errors path="jobOrder.nominationDate" cssClass="redstar"/>
         &nbsp;&nbsp;<f:message key="time"/>:&nbsp
       <form:input disabled="true" size="4" cssClass="inputBox" path="uiNominationTime" /> 
         <form:errors path="uiNominationTime" cssClass="redstar" />
         <form:input disabled="true" size="4" cssClass="inputBox" path="jobOrder.nominationTimeTz"/>
         <form:errors path="jobOrder.nominationTimeTz" cssClass="redstar"/>
               <a href="#" onClick="javascript:popup_show('timezone','timezone_drag','timezone_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('timezone','timezonebody');popupboxenable();"><%-- <img src=" images/lookup.gif" width="13" height="13" border="0" /> --%></a>
                ...
                <td width="45%" colspan="4" class="TDShadeBlue"><form:input disabled="true" id="etadate" cssClass="inputBox" path="jobOrder.etaDate"/>
        <form:errors path="jobOrder.etaDate" cssClass="redstar"/>
                  &nbsp;&nbsp;<f:message key="time"/>:&nbsp;
       <form:input disabled="true" size="4" cssClass="inputBox" path="uiEtaTime" /> 
         ...
         <a href="#" onClick="javascript:popup_show('etatimezone','etatimezone_drag','etatimezone_exit', 'screen-corner', 120, 20);hideIt();showPopupDiv('etatimezone','etatimezonebody');popupboxenable();"> <%-- <img src=" images/lookup.gif" width="13" height="13" border="0" /> --%> </a>
          ...
          path="jobOrder.productNames"/></div>
                ...
                <td width="45%" colspan="6" class="TDShadeBlue"><form:textarea disabled="true" path="jobOrder.jobDescription" id="jobDesc" rows="5" cols="100" />
...
<th style="text-align:right"><a href="#"  onclick="updateJobDescription();goToNextPage()"><img src=" images/savennextbluarrow.gif" alt="Save and Go to Next Page" width="14" height="14" hspace="4" border="0" align="absmiddle" title="Save and Go to Next Page"></a><a href="#"><img src=" images/icosave.gif" alt="Save" title="Save" width="14" height="14" border="0" align="absmiddle"  onclick="updateJobDescription();top.document.editJobsOutSourcingForm.submit();" /></a></th>
</tr>
...
if(code!= "" && code!= null)
{
document.getElementById('pu').setAttribute("src","search_job_contract_insp_popup.htm?inputFieldId=inputFieldIdValue&searchForm=editJobsOutSourcingForm&code="+code+"&fromPage=11");
}
}
</script>
</c:when>
...
<form:select id="jobContractStatus${counter.index}" cssClass="selectionBox" disabled="true" path="addJobContracts[${counter.index}].jobContract.jobContractStatus" items="${icbfn:dropdown('staticDropdown',jobContractStatus)}"   itemLabel="name" itemValue="value" onchange="checkForRebill('jobContractStatus${counter.index}')"/> 
</c:when>
<c:otherwise>
...
<td>
<form:select disabled="true" id="sel11" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.invoiceType" items="${icbfn:dropdown('staticDropdown',invoiceType)}" itemLabel="name" itemValue="value"/> </td>
</tr>
...
<td><form:select disabled="true" id="sel12" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.pymntType" items="${icbfn:dropdown('staticDropdown',paymentType)}" itemLabel="name" itemValue="value"/></td>
<td class="TDShadeGrey"><f:message key="paymentterms"/>:</td>
<td><form:select disabled="true" id="sel13" cssClass="selectionBoxmid" path="addJobContracts[${counter.index}].jobContract.pymntTermsCd" items="${icbfn:dropdown('paymentTerms', null)}" itemLabel="name" itemValue="value"/></td>
</tr>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="applTableBot">
            <tr>
              <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                  <tr>
                   <td>&nbsp;</td>
                    <td style="text-align:right"><a href="#" onClick="goToNextPage()"><img src="images/savennextbluarrow.gif" alt="Save and Go to Next Page" width="14" height="14" hspace="4" border="0" align="absmiddle" title="Save and Go to Next Page"></a><a href="#"><img src="images/icosave.gif" alt="Save" title="Save" width="14" height="14" border="0"  onclick="top.document.editJobsOutSourcingForm.submit();"/></a></td>
                  </tr>
                </table>
      </td>
         </tr>
