...
function saveHeader()
{
	document.jobOrderCreateForm.saveHeaderFlag.value = "1";
...
<c:set var="jobMeta" value="${icbfn:objectMeta(icbfn:user().branch.businessUnit.organization.name, command.jobOrder.jobType, command.class)}" />
...
<table border="0" cellpadding="0" cellspacing="0" class="MainTable">
  ...
  <!-- ------------------------------------------ BREADCRUMB TRAIL ------------------------------------------------ -->
      ...
      <form:hidden path="saveHeaderFlag" />
          ...
          <div id="tab_inner">
              ...
              <div id="tab1" class="innercontent">
                <table width="100%" cellpadding=0 cellspacing=0 class=mainApplTable>
                  <tbody>
                    <tr bgcolor=#ffffff>
                      <th colspan=3 width="65%">Header Details <img src="images/separator2.gif" width="2" height="27"  align="absmiddle" style="margin-left:10px;margin-right:10px;"/> Job ID: New<img src="images/separator2.gif" width="2" height="27" align="absmiddle" style="margin-left:10px; margin-right:10px;"/>Job Type: ${command.jobOrder.jobType} <form:hidden path="jobOrder.jobType" /></th>
                      <th width="30%" bgcolor="#ffffff" style="text-align:right">
                        
                       
                          <f:message key="status" />: </label>
                          <form:select cssClass="selectionBox" path="jobOrder.jobStatus" items="${icbfn:dropdown('jobStatus', null)}" itemLabel="name" itemValue="value"/>
                          <form:errors path="jobOrder.jobStatus" cssClass="error"/>
                        
                      </th>
                      <th width="5%" bgcolor="#ffffff" style="text-align:right"><a href="#"><input type="image" src="images/right.gif" alt="Next" width="14" height="14" border="0" onClick="saveHeader()"/></a></th>
                    </tr>
                    <tr>
                    
                        <td width="15%" class="TDShade"><strong><f:message key="businessUnit" />: </label></strong><span class="redstar">*</span> </td>
                        <td width="35%" class="TDShadeBlue">
                          <span class="id_input">
                            <form:select cssClass="selectionBox" path="jobOrder.buName" items="${icbfn:dropdown('businessUnit', divisions)}" itemLabel="name" itemValue="value" />
                          </span>
                          <form:errors path="jobOrder.buName" cssClass="error"/>
                        </td>
                     
 
                        <td width="15%" class="TDShade"><strong><f:message key="branch" />: </label><span class="redstar">*</span></strong></td>
                        <td width="35%" colspan="2" class="TDShadeBlue">
                          <form:select cssClass="selectionBox" path="jobOrder.branchName" items="${icbfn:dropdown('branch', divisionBu)}" itemLabel="name" itemValue="value"/>
                          <form:errors path="jobOrder.branchName" cssClass="error"/>
                        </td>
                    ...
                    <tr>
                      ...
                      <td class="TDShadeBlue"><form:input cssClass="inputBox" path="jobOrder.jobFinishDate" size="10" maxlength="12"/>
                    ...
                    <tr>
                      ...
                      <td class="TDShadeBlue">
                        <form:input path="jobOrder.shippingAgentName" cssClass="inputBox" size="20" maxlength="30"/>
