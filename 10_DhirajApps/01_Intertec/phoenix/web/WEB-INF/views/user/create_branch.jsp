...
<script language="javascript">
	...
	function onSave(){
		...
		if( ( ops.length>0 && lab.length==0 ) ||  ( ops.length==0 && lab.length>0 ) ){
			...
			document.branchCreateForm.submit();
		}
	}
	...
	function openBranchPopup(branchType,rowCount)
	{
			...
			var newwindow = window.open("search_branch_popup.htm?branchtype="+branchType+"&rowCount="+rowCount+"&formName=branchCreateForm",'_blank',winParms);
			newwindow.focus();
	...
	function onAdd()
	{
		document.branchCreateForm.addOrDelete.value = "add";
		document.branchCreateForm.submit();
	}
	function onDelete(index)
	{
		document.branchCreateForm.addOrDelete.value = "delete";
		document.branchCreateForm.index.value = index;

		document.branchCreateForm.submit();
	}
 function setflag(branchtypeflag,rowIndex)
 {	 
    document.branchCreateForm.rowNum.value=rowIndex;
    document.branchCreateForm.branchTypeFlag.value=branchtypeflag;
  }
function resetBranchTypeFlag()
{
	document.branchCreateForm.branchTypeFlag.value="none";
}
</script>
...
<form:form name="branchCreateForm" method="POST" action="create_branch.htm">
...
<!---------------------------------------------TAB 1 CONTAINER----------------------------------------------------->
            <div id="tab1" class="innercontent" >
              <table width="100%" border="0" cellpadding=0 cellspacing=0 class=mainApplTable>
                <tbody>
                  <tr bgcolor=#ffffff>
                    <th colspan="2" width="40%"><f:message key="createBranch"/></th>
                    ...
                    <th width="15%" bgcolor="#ffffff" style="text-align:right"><a href="search_branch.htm"><img src="images/icofindjob.gif" alt="Search" width="16" height="14" border="0" align="absmiddle"></a>&nbsp <a href="javascript:onSave()"><img src="images/icosave.gif" alt="Save" width="14" height="14" border="0" /></a></th>
                  </tr>
                  <tr>
                    ...
                    <td width="35%" class="TDShadeBlue"><span class="id_input">
                      <form:select id="sel1" cssClass="selectionBox" path="branch.buName" items="${icbfn:dropdown('businessUnit', null)}" itemLabel="name" itemValue="value" />
                      </span>
                    </td>
                    ...
                    <td colspan="2" width="35%" class="TDShadeBlue">
                      <form:input cssClass="inputBox" size="35"  maxlength="8" path="branch.name" />
				   ...
				   <tr>
                    ...
                    <td class="TDShadeBlue"  width="35%" colspan="2">
				  ...
				  source="branch.buName"
				  target="branch.numberCategory"
				  parameters="autoNumberId.numberCategory={branch.buName}"
                  ...
                  <tr>
                    <td width="15%" class="TDShade"><strong><f:message key="branchName"/>:<span class="redstar"> *</span> </strong></td>
				  ...
				  &nbsp;&nbsp;&nbsp;<f:message key="ext"/>:
						...
						<form:errors path="branch.phoneExtension" cssClass="redstar"/>
                  ...
                  <tr>
                    ...
                    <td class="TDShadeBlue"><form:input cssClass="inputBox" size="35" maxlength="55" path="branch.address1"/>
                  ...
                  <tr>
                    ...
                    <td class="TDShadeBlue"><form:input cssClass="inputBox" size="35" maxlength="55" path="branch.address2"/>
                  ...
                  <tr>
                    ...
                    <td class="TDShadeBlue"><form:input cssClass="inputBox" size="35" maxlength="55" path="branch.address3"/>
                  ...
                  <tr>
                    ...
                    <td class="TDShadeBlue"><form:input cssClass="inputBox" size="35"  maxlength="55" path="branch.address4"/>
                  ...
                  <tr>
                    ...
                    <td class="TDShadeBlue"><form:input cssClass="inputBox" size="35"  maxlength="30" path="branch.city"/>
					...
					<form:select cssClass="selectionBox" id="sel5" path="branch.stateCode" items="${icbfn:dropdown('state', countryCodeList)}" itemLabel="name" itemValue="value" />
				...
				<ajax:select
                  ...
                  <tr>
					...
					<td>
                      <form:input cssClass="inputBox" size="35"  maxlength="30" path="branch.county"/>
					<form:errors path="branch.county" cssClass="redstar"/></td>
                   
                    <td class="TDShade"><f:message key="postal"/>:</td>
                    <td colspan="2" class="TDShadeBlue"><form:input cssClass="inputBox" size="35"  maxlength="12" path="branch.postal"/>
					<form:errors path="branch.postal" cssClass="redstar"/></td>
                  </tr>
                  <tr>
                    <td class="TDShade" style="border-bottom: #CCCCCC dashed 1px;"><f:message key="branchAdminEmail"/>: </td>
                    <td class="TDShadeBlue" style="border-bottom: #CCCCCC dashed 1px;"><form:input cssClass="inputBox" size="35"  maxlength="70" path="branch.branchEmail"/>
									<form:errors path="branch.branchEmail" cssClass="redstar"/></td>

									 <td class="TDShade" style="border-bottom: #CCCCCC dashed 1px;"><f:message key="timeZone"/>: </td>
                    <td class="TDShadeBlue" style="border-bottom: #CCCCCC dashed 1px;" width="35%" colspan="2"><form:input cssClass="inputBox" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" size="35"  maxlength="70" path="branch.timezone"/><a href="#"
				...
				<img src=" images/lookup.gif" width="13" alt="lookup Time Zone" height="13" border="0" /></a>
									<form:errors path="branch.timezone" cssClass="redstar"/></td>
                  
               <%--  <td colspan="0" class="TDShadeBlue" style="border-bottom: #CCCCCC dashed 1px;">&nbsp;</td> --%>
                  </tr>
                  <tr>
				...
				<img src="images/lookup.gif" alt="lookupBranch" width="13" height="13" border="0">
                    ...
                    <td colspan="2" class="TDShadeBlue"><form:input cssClass="inputBox" size="35"  maxlength="150" path="branch.companyDesc"/>
                  ...
                  <tr>
	                ...
	                <td class="TDShadeBlue"  width="20%"></td>
	                <td class="TDShadeBlue"  width="20%"></td>
                    <td align="left:0px;" class="TDShadeBlue" width="18%"><a href="#"><img src="images/add.gif" alt="addBranches" width="13" height="12" hspace="1px" border="0" onclick="onAdd()"/></a></td>
                  </tr>
                  <tr>
				...
				<c:forEach items="${command.assocBranches}" var="assocBranch" varStatus="counter">
                        ...
                        <tr>
						  ...
						  <!--<input name="Input122" class="inputBox" size="10"/>-->
                      ...
                      <a href="#" onClick="javascript:setflag('addAssocBranch','${counter.index}');popup_show('branchcodeassoc${counter.index}', 'branchcodeassoc${counter.index}_drag', 'branchcodeassoc${counter.index}_exit', 'screen-corner', 120, 20);hideIt();popupboxenable()">
						...
						<form:input cssClass="inputBox" size="10"  maxlength="4" path="assocBranches[${counter.index}].assocBranch.type" disabled="true"/> 
							 ...
							 <td width="50" class="TDShadeBlue" style="text-align:right;"><div id="div3" style="width:50px; text-align:center; margin-right:0;">&nbsp; <img src="images/delete.gif" alt="deleteBranch" width="13" height="12" hspace="1px" border="0" onclick="onDelete('${counter.index}')" /></div></td> 
						<ajax:autocomplete
						  baseUrl="branch.htm"
                ...
                <tr>
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td style="text-align:right"><a href="search_branch.htm"><img src="images/icofindjob.gif" alt="Search" width="16" height="14" border="0" align="absmiddle"></a>&nbsp <a href="javascript:onSave()"><img src="images/icosave.gif" alt="Save" width="14" height="14" border="0" /></a></td>
                      </tr>
                    </table></td>
...
<div class="menu_form_body" id="branchtimezonebody"	style="width:750px;height:500px;overflow-y:hidden;"><iframe align="left:2px"
frameborder="0" style="padding:2px; height:500px;" width="100%"
src="search_timezone_popup.htm?inputFieldId=branch.timezone&div1=branchtimezone&div2=branchtimezonebody"
id="frame5" name="frame5" allowtransparency="yes"></iframe></div>
</div>
<!-----------------------------------------Branch Timezone  Lookup END--------------------------------------------->
<!------------------------------------------PS Branch Code Lookup-------------------------------------------------->
