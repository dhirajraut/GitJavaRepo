...
<script >
  ...
  function sortPermissionLisByUrl()
  {
...
<form:form name="permissionListSearchPopupForm" method="POST" action="search_link_popup.htm">
      ...
      <td valign="top">
        <div id="tab1" class="innercontent" >
          <table width="100%" border="0" cellpadding="0" cellspacing="0" class="mainApplTable" style="padding:-left:5px;">
            <tr>
              <th colspan="2"><f:message key="Link Search"/></th>
            </tr>
            <tr>
              <td width="20%" class="TDShade" nowrap><f:message key="Link Name"/>: </td>
          ...
          <c:if test="${command.results != null}">
            <div id="permissionlistsearchresults"> 
              ...
              <table width="100%" cellpadding="0" cellspacing="0" class="InnerApplTable">
                <tr>
                  <th><a href="#start" onClick="sortPermissionListByName();" ><span class="TDShade"><f:message key="Link Name"/></span></a></th>
                  <th><a href="#start" onClick="sortPermissionLisByUrl();" ><span class="TDShade"><f:message key="Link URL"/></span></a></th>
                </tr>
                <c:forEach items="${command.results}" var="permission" varStatus="status">
                  <c:choose>
                    ...
                    <td><a href="#" onclick="javascript:top.return_popup_search_result('${command.inputFieldId}', '${permission.url}');top.hideVatcode('permissionlist${command.rowNum}','permissionlistbody${command.rowNum}');top.closeSearchLink();">${permission.name}</a></td>
