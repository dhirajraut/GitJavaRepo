...
<form:form name="permissionListSearchPopupForm" method="POST" action="search_permission_list_popup.htm">
			...
			<td valign="top">
				<div id="tab1" class="innercontent" >
					<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mainApplTable" style="padding:-left:5px;">
						...
						<tr>
							<td width="20%" class="TDShade" nowrap><f:message key="permissionName"/>: </td>
							<td width="80%" class="TDShadeBlue">
								<!-- START : #119240 -->
								<%-- <form:input cssClass="inputBox" path="rolePerms.value" /> --%>
								<form:input cssClass="inputBox" path="rolePerms.value" onkeypress="if(event.keyCode==13) {submitFunction();}"/>
								<!-- END : #119240 -->
									<form:errors path="rolePerms.value" cssClass="redstar"/>	
							</td>
					...
					<c:if test="${command.results != null}">
						<div id="permissionlistsearchresults"> 
							...
							<table width="100%" cellpadding="0" cellspacing="0" class="InnerApplTable">
								<tr>
									<th><a href="#start" onClick="sortPermissionByName();" ><span class="TDShade"><f:message key="permissionList"/></span></a></th>
									<th><a href="#start" onClick="sortPermissionByDescription();" ><span class="TDShade"><f:message key="permissionListDescription"/></span></a></th>
								</tr>
						...
						<tr style="background-color:#e7eeff;">                    
										...
										<td><a href="#" onclick="javascript:top.return_popup_search_result('${command.inputFieldId}', '${permission.name}');top.hidePopupDiv('roles${command.rowNum}','rolesbody${command.rowNum}');top.popupboxclose();top.document.roleCreateForm.submit();">${permission.name}</a></td>
									...
									<td align="center">
									 <!-- START : #119240 : 22/06/09 -->
											<%-- <c:forEach items="${command.pagination.pages}" var="page" varStatus="status"> --%>									<SCRIPT LANGUAGE="JavaScript">
