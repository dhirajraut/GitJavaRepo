...
function onRoleAdd()
{
document.userCreateForm.addOrDeleteRole.value = "add";
document.userCreateForm.tabName.value = "1";
document.userCreateForm.submit();
}

function onRoleDelete(index)
{
document.userCreateForm.addOrDeleteRole.value = "delete";
document.userCreateForm.roleIndex.value = index;
document.userCreateForm.tabName.value = "1";
document.userCreateForm.submit();
}
  function setflag(rowIndex)
 {   
  document.userCreateForm.userRoleFlag.value="newval"; 
  document.userCreateForm.rowNum.value=rowIndex;  
}

function onBranchChange(){   
 document.userCreateForm.timeFlag.value="branchChange"; 
 document.userCreateForm.submit();
 }

function addNew(){
  document.userCreateForm.addFlag.value="addNew";
 }
...
/*function updateBranchIframeSrc()
  ...
  {    document.getElementById('searchBranchCodeFr').setAttribute("src","search_branch_popup.htm?inputFieldId=user.branchName&div1=branchcode&div2=branchcodebody&buName="+buName+"&formName=userCreateForm");
  }  
}
...
<form:form name="userCreateForm" method="POST" action="create_user.htm">
<div style="color:red;">
    ...
    <td valign="top">
      ...
      <div id="MainContentContainer">
        ...
        <div id="tabcontainer">
          <div id="tabnav">
            <ul>
              <li><a href="#" rel="tab1"><span><f:message key="createUser"/></span></a></li>
              <li><a href="#" rel="tab2"><span><f:message key="userRoles"/></span></a></li>
            </ul>
         </div>
     ...
     <div id="tab_inner">
            ...
            <div id="tab1" class="innercontent" >
              <table width="100%" cellpadding=0 cellspacing=0 class=mainApplTable>
                ...
                <%-- <tr bgcolor=#ffffff>
              <th colspan=3 width="65%"><f:message key="user"/> :<img src="images/separator2.gif" width="2" height="27" align="absmiddle" style="margin-left:5px; margin-right:5px;">&nbsp;<f:message key="userId"/>: New&nbsp;</th>
              <th width="30%" ><f:message key="status"/>:                        
              ...
              <th width="25%" bgcolor="#ffffff" style="text-align:right"><a href="search_user.htm"><img src="images/icofindjob.gif" alt="Search" width="14" height="14" border="0" align="absmiddle"></a><a href="#"><input type="image" src="images/icosave.gif" alt="Save" width="14" height="14" border="0" /></a></th>
                   </tr>--%>

<tr bgcolor=#ffffff>
<th colspan=3 width="55%"><f:message key="user"/> :<img src="images/separator2.gif" width="2" height="27" align="absmiddle" style="margin-left:5px; margin-right:5px;">&nbsp;<f:message key="userId"/>: New&nbsp;</th>
...
<a href="#"><input type="image" src="images/icosave.gif" alt="Save" width="14"  height="14" border="0" /></a>
              ...
              <strong><f:message key="userName"/><span class="redstar">*</span></strong></td>
              
              <td width="35%" class="TDShadeBlue">
                <form:input cssClass="inputBox" size="35" maxlength="128" path="user.loginName" />
                <form:errors path="user.loginName" cssClass="redstar"/>
              </td>
              <td width="15%" class="TDShade"><strong><f:message key="employeeName"/>:</strong></td>
              
              <td colspan="2" width="35%" class="TDShadeBlue">
              <form:input cssClass="inputBoxBlue" size="35"  maxlength="11" path="employeeFullName" />
             ...
             <tr>
              ...
              <f:message key="password"/></strong></td>
            
              <td class="TDShadeBlue">
                <form:password cssClass="inputBox" size="35" maxlength="128" path="password" showPassword="true" />
                <form:errors path="password" cssClass="redstar"/>
              </td>
              
              <td class="TDShade" nowrap><strong>
              <f:message key="confirmedPassword"/></strong></td>
              
              <td colspan="2" class="TDShadeBlue">
                <form:password cssClass="inputBox" size="35"  maxlength="128" path="passwordConfirmation" showPassword="true"/>
              ...
              <td class="TDShadeBlue">
                <form:input cssClass="inputBox" size="35" maxlength="128" path="user.firstName" />
              ...
              <td colspan="2" class="TDShadeBlue">
              <form:input cssClass="inputBox" size="35" maxlength="128" path="user.middleName" />
              </td>
                  </tr>

                  <tr>
                    <td class="TDShade" style="border-bottom:#CCCCCC dashed 1px;"><f:message key="lastName"/>: </td>
                    <td class="TDShadeBlue" style="border-bottom:#CCCCCC dashed 1px;">
                      <form:input cssClass="inputBox" size="35" maxlength="128" path="user.lastName" />
                    ...
                    <td colspan="2" class="TDShadeBlue" style="border-bottom:#CCCCCC dashed 1px;">
                      <form:input cssClass="inputBox" size="35" maxlength="70" path="user.email" />
                      <form:errors path="user.email" cssClass="redstar"/>
                    </td>
                  </tr>
                  <tr>
                    <td class="TDShade"><f:message key="workerFunction"/>:</td>
                    <td class="TDShadeBlue"><form:select id="sel2" cssClass="selectionBox" path="user.workFunction" items="${icbfn:dropdown('staticDropdown',workFunction)}" itemLabel="name" itemValue="value"/></td>
        
           <td class="TDShade"><f:message key="jobCode"/>:<span class="redstar">*</span> </td>
                 <td colspan="2" class="TDShadeBlue">  <form:input cssClass="inputBox" size="35" maxlength="8" path="user.jobCodeValue"/>
          <form:errors path="user.jobCodeValue" cssClass="redstar"/>
                  <a href="#" onClick="javascript:popup_show('jobcode', 'jobcode_drag', 'jobcode_exit', 'screen-corner', 120, 20); hideIt();showjobcode();popupboxenable();"><img src="images/lookup.gif" alt="lookup Job Code" width="13" height="13" border="0"></a></td>

                  </tr>
                   <tr>
                    <td class="TDShade"><f:message key="businessUnitName"/>:<span class="redstar">*</span></td>   
                    <td class="TDShadeBlue">
                    <%--<form:select id="sel3" cssClass="selectionBox" path="user.buName" items="${icbfn:dropdown('businessUnit', null)}" itemLabel="name" itemValue="value"/>--%>

                   <form:select id="sel3" cssClass="selectionBox" path="user.buName" items="${icbfn:dropdown('businessUnit', null)}" itemLabel="name" itemValue="value" onchange="makeBranchblank()"/>
                      <form:errors path="user.buName" cssClass="error"/>
                    </td>
                    <td class="TDShade"><f:message key="branchCode"/>:<span class="redstar">*</span></td>
                    <td colspan="2" class="TDShadeBlue">
                  <form:select id="sel4" cssClass="selectionBox" path="user.branchName" items="${icbfn:dropdown('branch', divisionBu)}" itemLabel="name" itemValue="value" onchange="onBranchChange()"/>
             <form:errors path="user.branchName" cssClass="redstar"/></td>
             
            <%--<form:input id="sel4" cssStyle="text-align:left; background-color:#d2e1ff; color:#000099;" cssClass="inputBox" size="40" path="user.branchName"/>
           ...
           <img src="images/lookup.gif" alt="lookup country" width="13" height="13" border="0"></a><form:errors path="user.branchName" cssClass="redstar"/>        
                    </td>--%>
				...
				<td class="TDShadeBlue" style="border-bottom:#CCCCCC dashed 1px;">
				<form:input id="superVisor" cssClass="inputBox" size="35" maxlength="19" path="user.supervisorName" />
				<form:errors path="user.supervisorName" cssClass="redstar"/>
				<a href="#" onClick="javascript:popup_show('supervisorid', 'supervisorid_drag', 'supervisorid_exit', 'screen-corner', 120, 20); hideIt();showsupervisorid();popupboxenable();"><img src="images/lookup.gif" alt="lookup Supervisor" width="13" height="13" border="0"></a></td>
				...
				<img src=" images/lookup.gif" width="13" alt="lookup Time Zone" height="13" border="0" /></a>
                 ...
                 <tr>
                    ...
                    <td class="TDShadeBlue"><form:select id="sel5" cssClass="selectionBox" path="user.employeeType" items="${icbfn:dropdown('staticDropdown',employeeType)}" itemLabel="name" itemValue="value"/></td>
                    
          <td class="TDShade"><f:message key="reg"/></td>
                    <td colspan="2" class="TDShadeBlue"><form:select id="sel6" cssClass="selectionBox" path="user.regularTemp" items="${icbfn:dropdown('staticDropdown',regularTemp)}" itemLabel="name" itemValue="value"/></td>
                  </tr>
                  <tr>
                    <td class="TDShade"><f:message key="fullorPart"/>:</td>
                    <td class="TDShadeBlue"><form:select id="sel7" cssClass="selectionBox" path="user.fullPartTime" items="${icbfn:dropdown('staticDropdown',fullPartTime)}" itemLabel="name" itemValue="value"/></td>
                    
          <td class="TDShade"><f:message key="approver"/></td>
                    <td colspan="2" class="TDShadeBlue"><form:checkbox  path="user.isApprover" value="0" /></td>
                  </tr>
                  <tr>
                    <td class="TDShade"><f:message key="employeeStatus"/>:</td>
                    <td class="TDShadeBlue">
          
        <form:select id="sel8" cssClass="selectionBox" path="user.employeeStatus" items="${icbfn:dropdown('staticDropdown',employeeStatus)}" itemLabel="name" itemValue="value"/></td>
                    
            <td class="TDShade"><f:message key="defaultCountry"/>:</td>
                    <td colspan="2" class="TDShadeBlue">
          <form:select id="sel9" cssClass="selectionBox" path="user.countryCode" items="${icbfn:dropdown('country', null)}" itemLabel="name" itemValue="value" />
          <form:errors path="user.countryCode" cssClass="redstar"/></td>
                  </tr>
...
<td>
<strong >
<span class="redstar">*</span></strong>
<span class="Font11pt"><f:message key="markedfiledsaremdtry"/>
</span> 
</td>

<td style="text-align:right"><a href="#"><input type="image" src="images/icoadddoc.gif" alt="Save and addNew" width="14"  height="14" border="0" onClick="addNew();"/></a>&nbsp;

<a href="search_user.htm"><img src="images/icofindjob.gif" alt="Search"  height="14" border="0" align="absmiddle"></a>&nbsp;
 ...
 <!-------------------------------------------- TAB 2 CONTAINER -------------------------------------------------->
            <div id="tab2" class="innercontent" >
              <table width="100%" cellpadding=0 cellspacing=0 class=mainApplTable>
                <tbody>
                  <tr bgcolor=#ffffff>
                    <th width="65%"><f:message key="user"/><img src="images/separator2.gif" width="2" height="27" align="absmiddle" style="margin-left:5px; margin-right:5px;"></th>                   
      <th width="20%" bgcolor="#ffffff" style="text-align:right">
  <a href="#"><input type="image" src="images/icoadddoc.gif" alt="Save and addNew" width="14"  height="14" border="0" onClick="addNew();"/></a>&nbsp;
  <a href="search_user.htm"><img src="images/icofindjob.gif" alt="Search"  height="14" border="0" align="absmiddle"></a>&nbsp;
<a href="#"><input type="image" src="images/icosave.gif" alt="Save" width="14" height="14" border="0" /></a></th>
                  </tr>
                  <tr>
          ...
          <th width="60" style="text-align:right" colspan="2"><img src="images/add.gif" alt="Add row" width="13" height="12" hspace="1px" border="0" onclick="onRoleAdd('${counter.index}')"/>&nbsp;&nbsp;&nbsp;</th>
          </tr>
      ...
      <tr>
            ...
            <td class="TDShadeBlue"><form:input cssClass="inputBox" size="15" maxlength="128" path="roles[${counter.index}].name"  />
      <form:errors path="roles[${counter.index}].name" cssClass="redstar"/>
       ...
       <td class="TDShadeBlue"><form:input cssClass="inputBox" size="15"  maxlength="25" path="roles[${counter.index}].roleDesc" />
      <form:errors path="roles[${counter.index}].roleDesc" cssClass="redstar"/></td><td>&nbsp;</td>
      <td class="TDShadeBlue"><div id="tablefunction" style="width:50px; text-align:center; margin-right:0;"><a href="#"><img src="images/delete.gif" alt="Delete Row" width="13" height="12" hspace="1px" border="0" onclick="onRoleDelete('${counter.index}')"/></a> </div></td>
...
<!------------------------------USER Roles Lookup ---------------------------------------------------->
    ...
    <iframe align="left" frameborder="0" style="padding:0px;" height="530px;" width="100%" src="search_user_roles_popup.htm?inputFieldId=roles[${counter.index}].name&rowNum=${counter.index}&searchForm=userCreateForm" scrolling="auto" id="searchUserRoleFr" name="searchUserRoleFr" allowtransparency="yes" ></iframe>
      </div>
    </div>
...
<td style="text-align:right"<a href="#"><input type="image" src="images/icoadddoc.gif" alt="Save and addNew" width="14"  height="14" border="0" onClick="addNew();"/></a>&nbsp;<a href="search_user.htm"><img src="images/icofindjob.gif" alt="Search"  height="14" border="0" align="absmiddle"></a>&nbsp;&nbsp;<a href="#"><input type="image" src="images/icosave.gif" alt="Save" width="14" height="14" border="0" /></a></td>
</tr>
</table></td>
</tr>
</table>
...
<div class="menu_form_header" id="supervisorid_drag" style="width:750px;height:auto;"> <img class="menu_form_exit"   id="supervisorid_exit" src="images/form_exit.png" /> &nbsp;&nbsp;&nbsp;<f:message key="searchSupervisor"/></div>
<div class="menu_form_body" id="supervisorbody"   style="width:750px; height:530px;overflow-y:hidden;">
<table width="98%" border="0" align="center" cellpadding="0" cellspacing="0" class="InnerApplTable">
<tr>
<td valign="middle"> 
<iframe align="left" frameborder="0" style="padding:0px;" height="530px;" width="100%" src="search_user_popup.htm?inputFieldId=user.supervisorName&div1=supervisorid&div2=supervisorbody&searchForm=userCreateForm" scrolling="auto" id="searchsupervisorIdFr" name="searchsupervisorIdFr" allowtransparency="yes" ></iframe>
</td>          
</tr>       
</table> 
</div>
...
<tr>
<td valign="middle">
<iframe align="left" frameborder="0" style="padding:0px;" height="540px;" width="100%" <%--src="search_branch_popup.htm?inputFieldId=user.branchName&div1=branchcode&div2=branchcodebody&&buName=${command.user.buName}&searchForm=userCreateForm" --%>scrolling="auto" id="searchBranchCodeFr" name="searchBranchCodeFr" allowtransparency="yes" ></iframe>
</td>
</tr>
</table>       
</div>
...
<div class="menu_form_body" id="timezonebody"
  style="width:750px; height:500px;overflow-y:hidden;"><iframe align="middle"
