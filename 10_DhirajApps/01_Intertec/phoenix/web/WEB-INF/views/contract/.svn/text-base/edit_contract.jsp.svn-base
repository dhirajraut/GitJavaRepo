        ...
        <div id="tabcontainer">
          <div id="tabnav">
            <ul>
              ...
              <li><a href="#" rel="tab8"><span><f:message key="contractSlates"/></span></a></li>
...
<div class="sample_popup" id="branchcode" style="visibility: hidden; display: none;">
  <div class="menu_form_header" id="branchcode_drag" style="width:450px; "> 
    <img class="menu_form_exit"   id="branchcode_exit" src="images/form_exit.png" /> &nbsp;&nbsp;&nbsp;Search Branch Code
  </div>
...
<div class="sample_popup" id="bu" style="visibility: hidden; display: none; z-index:2;">
  <div class="menu_form_header" id="bu_drag" style="width:450px; z-index:2; "> 
    <img class="menu_form_exit"   id="bu_exit" src="images/form_exit.png" /> &nbsp;&nbsp;&nbsp;Search Business Unit
  </div>
