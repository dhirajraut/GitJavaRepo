...
<table width="100%" border="0" cellpadding="0" cellspacing="0" class="mainApplTable" style="padding:right:5px;">
						<tr>
							<th colspan="2"><f:message key="userSearchTitle"/></th>
						</tr>
						<tr>
							<td width="20%" class="TDShade" nowrap><f:message key="loginName"/>: </td>
							<td width="80%" class="TDShadeBlue">
								<form:input cssClass="inputBox" path="loginName" />
							</td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="TDShadeBlue"><form:input cssClass="inputBox" path="lastName" /></td>
						</tr>
