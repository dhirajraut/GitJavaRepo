...
<form:form name="NotePopUpForm" method="POST" action="phx_job_instruction_note_popup.htm">
...
<td><form:select  cssClass="selectionBox" id="visibility" path="visibility"  items="${command.visibilityFields}" itemLabel="name" itemValue="value"/>
...
<tr>
<td>
<input type="button" value="Save Note" class="button1" onclick="jobInstructionNoteSubmit();"/>
<input type="button"  value="Reset"  class="button1"  onclick="onReset();"/>
<input name="attachfile" type="button" class="button1" id="attachfile" accesskey="F" tabindex="53" title="Add Attachment" value="Attach a File" onClick="window.open('phx_job_instruction_attachfile_popup.htm?JobOrderNumber=${command.jobOrderNumber}&jobTestId=${command.jobTestId}&divName=addattach', null, 'scrollbars=yes, width=700, height=200');" >
</td>
</tr>
</table>
</td>
