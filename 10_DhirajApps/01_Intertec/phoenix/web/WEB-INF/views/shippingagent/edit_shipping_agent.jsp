...
<form:form name="shippingAgentEditForm" method="POST" action="edit_shipping_agent.htm">
<form:hidden path="id" />
<div style="color:red;">
            ...
            <div id="tab1" class="innercontent" >
              <table border="0" align="center" cellpadding="1" cellspacing="0" class="mainApplTable">
                <tr>
                  ...
                  <f:message key="editShippingAgent"/>
                  </authz:authorize>
                  <authz:authorize ifNotGranted="CreateShippingAgent">
                  <f:message key="viewShippingAgent"/>
                  </authz:authorize>
                  </th>
				...
				<form:select cssClass="selectionBox" path="status" items="${icbfn:dropdown('staticDropdown',activeStatus)}" itemLabel="name" itemValue="value"/>
				 ...
				 <tr>
                 <td width="20%" class="TDShade"><strong><f:message key="shippingAgentID"/>: </strong></td>
                  <td width="30%" class="TDShadeBlue">${command.id}
                  </td>
               ...
               <tr class="InnerApplTable">
                ...
                <tr>
                 ...
                 <td colspan="1" class="TDShadeBlue">
                    <form:input cssClass="inputBox" maxlength="64" size="25" path="city"/>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="applTableBot">
                <tr>
                  <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>&nbsp;</td>
                      <td style="text-align:right"><a href="search_shipping_agent.htm"><img src="images/icofindjob.gif" alt="Search" width="16" height="14" border="0" align="absmiddle"></a>&nbsp 
                      <authz:authorize ifAnyGranted="CreateShippingAgent">
