...
<form:form name="shippingAgentCreateForm" method="POST" action="create_shipping_agent.htm">
<div style="color:red;">
          ...
          <div id="tab_inner">
            ...
            <div id="tab1" class="innercontent" >
              <table border="0" align="center" cellpadding="1" cellspacing="0" class="mainApplTable">
                <tr>
                  <th colspan="2" width="50%"><f:message key="createNewShippingAgent"/></th>
                  ...
                  <th width="10%">
				  <a href="search_shipping_agent.htm"><img src="images/icofindjob.gif" alt="Search" width="16" height="14" border="0" align="absmiddle"></a>&nbsp
				  <a href="#"><input type="image" src="images/icosave.gif" alt="Save" width="14" height="14" border="0" align="absmiddle"></a></th>
                </tr>
                <tr>
                  <td width="20%" class="TDShade"><strong><f:message key="shippingAgent"/>:<span class="redstar">*</span></strong></td>
                  <td width="30%" colspan="1" class="TDShadeBlue">
                    <form:input cssClass="inputBox" size="35" maxlength="128" path="name" />
				...
				<tr>
                  ...
                  <td class="TDShadeBlue"><label>
                    <form:input cssClass="inputBox" size="35" maxlength="64" path="city" />
                    <form:errors path="city" cssClass="redstar"/>
                  </label></td>
                  <td class="TDShade"><strong><f:message key="telephoneNo"/>:</strong></td>
                  <td colspan="2" class="TDShadeBlue">
                    <form:input cssClass="inputBox" size="35" maxlength="32" path="phone" />
                    <form:errors path="phone" cssClass="redstar"/>
                  </td>
                </tr>
                ...
                <tr>
                  ...
                  <td class="TDShadeBlue">
                    <form:input cssClass="inputBox" size="35" maxlength="70" path="email" />
                    <form:errors path="email" cssClass="redstar"/>
                  </td>
              ...
              <table width="100%" border="0" cellpadding="0" cellspacing="0" class="applTableBot">
                <tr>
                  <td><table width="99%" border="0" align="center" cellpadding="0" cellspacing="0">
                    <tr>
                      <td>&nbsp;</td>
                      <td style="text-align:right"><a href="search_shipping_agent.htm"><img src="images/icofindjob.gif" alt="Search" width="16" height="14" border="0" align="absmiddle"></a>&nbsp <a href="#"><input type="image" src="images/icosave.gif" alt="Save" width="14" height="14" border="0"></a></td>
                    </tr>
                  </table></td>
                </tr>
              </table>
