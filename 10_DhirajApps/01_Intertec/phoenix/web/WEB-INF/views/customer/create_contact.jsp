...
<script language="javascript">
	...
	function onAdd()
	{
		document.contactCreateForm.addOrDelete.value = "add";
		document.contactCreateForm.tabName.value = "1";
		document.contactCreateForm.submit();
	}
	function onDelete(index)
	{
		document.contactCreateForm.addOrDelete.value = "delete";
		document.contactCreateForm.tabName.value = "1";
		document.contactCreateForm.index.value = index;
		document.contactCreateForm.submit();
	}
	function onSave()
	{
		document.contactCreateForm.tabName.value = "0";
		//document.contactCreateForm.submit();
	}
    function setflag(rowIndex)
    {	 
    document.contactCreateForm.addSeqFlag.value="newval";
    document.contactCreateForm.rowNum.value=rowIndex;
    }
	
    function setflagvalue(rowIndex)
    {
	document.contactCreateForm.contSeqFlag.value="custval";
	document.contactCreateForm.rowNum.value=rowIndex;
    }	
	...
	if(document.contactCreateForm.notesmry.value.length==0){
		confirm("Please fill Summary ");
		document.contactCreateForm.notesmry.focus();
	} else {
		document.contactCreateForm.addOrDeleteContactNote.value = "add";
	    document.contactCreateForm.tabName.value = "2";
	    document.contactCreateForm.submit();
	}
 }
 function onReset()
 {
 		document.contactCreateForm.addOrDeleteContactNote.value = "reset";
	    document.contactCreateForm.tabName.value = "2";
	    document.contactCreateForm.submit();
 } 
 function onContactNoteDelete(index){
  	document.contactCreateForm.addOrDeleteContactNote.value = "delete";
    document.contactCreateForm.tabName.value = "2";
    document.contactCreateForm.contactNoteCount.value = index;
    document.contactCreateForm.submit();
 }
 function selectNote(index){
  	document.contactCreateForm.addOrDeleteContactNote.value = "view";
    document.contactCreateForm.tabName.value = "2";
    document.contactCreateForm.contactNoteCount.value = index;
    document.contactCreateForm.submit();
 }
 function onContactSave(tabNumber){
    document.contactCreateForm.tabName.value = tabNumber;
 }
</script>
...
<form:form name="contactCreateForm" method="POST" action="create_contact.htm">
<div style="color:red;">
  ...
  <tr>
    <td valign="top">
          ...
          <div id="tab_inner">
            ...
            <div id="tab1" class="innercontent" >
              <table width="100%" cellpadding=0 cellspacing=0 class=mainApplTable>
                <tbody>
                  <tr bgcolor=#ffffff>
                    <th colspan=2 width="50%"><f:message key="contact"/></th>
                    ...
                    <th width="30%" bgcolor="#ffffff" style="text-align:right"><a href="search_contact.htm"><img src="images/icofindjob.gif" alt="Search" width="16" height="14" border="0" align="absmiddle"></a>&nbsp <a href="#"><input type="image" src="images/icosave.gif"  alt="Save" width="14" height="14" border="0"  onclick="javascript:onSave();"/></a></th>
                  </tr>
                  <tr>
                    <td class="TDShade"><f:message key="firstName"/> <strong> <span class="redstar">*</span>:</strong></td>
                    <td class="TDShadeBlue">
                      <form:input cssClass="inputBox" maxlength="128" size="35" path="contact.firstName" />
                  ...
                  <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                      <tr>
                        ...
                        <td style="text-align:right"><a href="search_contact.htm"><img src="images/icofindjob.gif" alt="Search" width="16" height="14" border="0" align="absmiddle"></a>&nbsp
                          <a href="#"><input type="image" src="images/icosave.gif"  alt="Save" width="14" height="14" border="0" onclick="javascript:onSave();"/></a>
                        </td>
                      </tr>
                    </table></td>
                </tr>
      ...
      <f:message key="contact"/>
        ...
        <th width="15%" style="text-align:right"><a href="search_contact.htm"><img src="images/icofindjob.gif" alt="Search" width="16" height="14" border="0" align="absmiddle"></a>&nbsp <a href="#"><input type="image" src="images/icosave.gif" name="submit" alt="Save" width="14" height="14" border="0" /></a></th>
      </tr>
	  ...
	  <th>&nbsp;</th>
		...
		<c:forEach items="${command.contactCusts}" var="contactCust" varStatus="counter">
			...
			<td class="TDShadeBlue"><form:input cssClass="inputBox" maxlength="3" size="3" path="contactCusts[${counter.index}].contactSeqNum" disabled="true"/></td>
			  <td class="TDShadeBlue">                
					<form:input cssClass="inputBox" maxlength="15" size="12" path="contactCusts[${counter.index}].customer.custCode"/>
			...
			<td class="TDShadeBlue" align="center">
					<form:input cssClass="inputBox" size="40" maxlength="40" path="contactCusts[${counter.index}].customer.name" disabled="true"/> 
			 </td>
			  <td class="TDShadeBlue">                
					...
					<form:errors path="contactCusts[${counter.index}].custAddrSeq.custAddrSeqId.locationNumber" cssClass="redstar"/>
				     <a href="#" onClick="javascript:setflag(${counter.index});popup_show('addressseq${counter.index}', 'addressseq_drag${counter.index}', 'addressseq_exit${counter.index}', 'screen-corner', 120, 20); hideIt();popupboxenable();">  <img src="images/lookup.gif" alt="lookup location Number" width="13" height="13" border="0"></a></td>
			<td align="center">
					<form:input cssClass="inputBox" size="40" maxlength="30" path="contactCusts[${counter.index}].custAddrSeq.addressDescr" disabled="true"/> 
			 </td>

			<td align="center">
                      <form:select id="sel2" cssClass="selectionBox" path="contactCusts[${counter.index}].status" items="${icbfn:dropdown('staticDropdown',activeStatus)}" itemLabel="name" itemValue="value"/>
			 </td>
...
<iframe align="left" frameborder="0" style="padding:0px;" height="530px;" width="100%" src="search_customer_id_popup.htm?inputFieldId=contactCusts[${counter.index}].customer.custCode&rowNum=${counter.index}&searchForm=contactCreateForm" scrolling="auto" id="customeridFr" name="customeridFr" allowtransparency="yes" ></iframe>
</div>
</div>
...
&custCode=${command.contactCusts[counter.index].customer.custCode}&rowNum=${counter.index}&searchForm=contactCreateForm" scrolling="auto" id="addressseqFr" name="addressseqFr" allowtransparency="yes" ></iframe>
                    ...
                    <table width="100%" border="0" cellpadding="0" cellspacing="0" class="applTableBot">
                       <tr>
                         <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
                           <tr>
                             <td>&nbsp;</td>
                          <td style="text-align:right"><a href="search_contact.htm"><img src="images/icofindjob.gif" alt="Search" width="16" height="14" border="0" align="absmiddle"></a>&nbsp <a href="#"><input type="image" src="images/icosave.gif" name="submit" alt="Save" width="14" height="14" border="0" /></a></td>
                        </tr>
                    </table>
				  </td>
                 </tr>
