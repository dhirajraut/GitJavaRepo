...
function languageChange(custAddrId){
	
	document.createCustomerAddressLanguageForm.languageFlag.value="true"
	document.createCustomerAddressLanguageForm.custAddrId.value=custAddrId;
	document.createCustomerAddressLanguageForm.lcode.value=document.getElementById("langcode").value;
	document.createCustomerAddressLanguageForm.submit()
}
...
<form:form name="createCustomerAddressLanguageForm" method="POST" action="create_multilingual_customer_address_popup.htm">
...
<div style="color:red;">
  <form:errors cssClass="error"/>
                ...
                <tbody>
				  ...
				  <tr>
                    ...
                    <td  class="TDShadeBlue">
                       <form:select id="langcode" cssClass="selectionBox" path="custAddressLanguage.custAddressLanguageId.languageCD" items="${icbfn:dropdown('staticDropdown',selectedLanguage)}" itemLabel="name" itemValue="value" onchange="languageChange('${command.custAddrId}');"/>
                  ...
                  <tr>
				   ...
				   <tr>
                    ...
                    <td  class="TDShadeBlue">
                     <form:input cssClass="inputBox" size="35"  maxlength="12" path="custAddressLanguage.postal"/>
		...
		<td class="TDShade"><input type="submit"  class="button1" value="Save"/> 
			...
			<%--<td class="TDShade"><input type="submit"  class="button1" value="Save" onclick="javascript:top.hidePopupDiv('${command.divName}','${command.divBody}');top.popupboxclose();"/>--%>
