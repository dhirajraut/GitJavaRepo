...
<form:form name="editSlateServicePopUpForm" method="POST" action="edit_slate_service_popup.htm">    
  ...
  <table width="98%" align="center" cellpadding="0" cellspacing="0" class="InnerApplTable" style="width:98%; margin-bottom:15px;">
    ...
    <tr>
      <td>${command.jobContractSlate.slate.slateId}</td>
      <td>${command.jobContractSlate.slate.slateDescription} </td>
      <td>
        <form:input path="jobContractSlate.quantity" size="10"/>
        <form:errors path="jobContractSlate.quantity" cssClass="redstar"/>
      </td>
    </tr>
