...
/**
 * CfgContractId generated by hbm2java
 */
public class CfgContractId  implements java.io.Serializable {
    ...
    /** default constructor */
    public CfgContractId() {
    }

    /** full constructor */
    public CfgContractId(String contractId, Date beginDate) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof CfgContractId) ) return false;
		 CfgContractId castOther = ( CfgContractId ) other; 
