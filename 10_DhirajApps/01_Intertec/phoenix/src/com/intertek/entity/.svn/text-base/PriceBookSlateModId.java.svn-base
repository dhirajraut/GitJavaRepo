...
/**
 * PriceBookSlateModId generated by hbm2java
 */
public class PriceBookSlateModId  implements java.io.Serializable {
    ...
    /** default constructor */
    public PriceBookSlateModId() {
    }

    /** full constructor */
    public PriceBookSlateModId(String contractId, String slateType, String slateId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof PriceBookSlateModId) ) return false;
		 PriceBookSlateModId castOther = ( PriceBookSlateModId ) other; 
