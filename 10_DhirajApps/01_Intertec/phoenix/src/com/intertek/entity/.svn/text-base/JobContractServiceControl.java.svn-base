...
/**
 * JobContractServiceControl generated by hbm2java
 */
public class JobContractServiceControl  implements java.io.Serializable {
    ...
    /** default constructor */
    public JobContractServiceControl() {
    }

	/** minimal constructor */
    public JobContractServiceControl(JobContractService jobContractService, String questionId, String objectName) {
        this.jobContractService = jobContractService;
        this.questionId = questionId;
        this.objectName = objectName;
    }
    /** full constructor */
    public JobContractServiceControl(JobContractService jobContractService, String questionId, String objectName, String inputValue0, String inputValue1, String inputValue2, String inputValue3, String inputValue4) {
       this.jobContractService = jobContractService;
       this.questionId = questionId;
       this.objectName = objectName;
