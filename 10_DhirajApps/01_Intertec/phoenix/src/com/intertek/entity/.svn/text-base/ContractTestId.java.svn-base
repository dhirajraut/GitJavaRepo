...
/**
 * ContractTestId generated by hbm2java
 */
public class ContractTestId  implements java.io.Serializable {
    ...
    /** default constructor */
    public ContractTestId() {
    }

    /** full constructor */
    public ContractTestId(String contractId, String testType, String testId) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ContractTestId) ) return false;
		 ContractTestId castOther = ( ContractTestId ) other; 
