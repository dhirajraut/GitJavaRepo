...
/**
 * ControlMapId generated by hbm2java
 */
public class ControlMapId  implements java.io.Serializable {
    ...
    /** full constructor */
    public ControlMapId(String contractId, String serviceName, String expressionId, String objectName) {
   ...
   public boolean equals(Object other) {
		 ...
		 if ( !(other instanceof ControlMapId) ) return false;
		 ControlMapId castOther = ( ControlMapId ) other; 
