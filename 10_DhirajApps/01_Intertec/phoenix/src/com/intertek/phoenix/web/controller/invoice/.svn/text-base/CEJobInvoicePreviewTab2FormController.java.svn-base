...
/**
 * Purpose: Controller for 'Tax' tab in CE Invoice Preview
 * 
 * @version 1.0 May 25, 2009
 * @author Patni
 */
public class CEJobInvoicePreviewTab2FormController extends SimpleFormController {

    /**
     * Instantiates a new CEJobInvoicePreviewTab2FormController.
     */
    public CEJobInvoicePreviewTab2FormController() {
        super();
        setSessionForm(true);
    ...
    protected Object formBackingObject(HttpServletRequest request) throws Exception {
        ...
        cePreviewInvoiceForm.setTabSource(Constants.CE_JOB_INV_PREVIEW_TAB2);
