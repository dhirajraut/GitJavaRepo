...
/**
 * Purpose: Controller for 'Pricing Information' tab in CE Invoice Preview 
 * 
 * @version 1.0 May 25, 2009
 * @author Patni
 */
public class CEJobInvoicePreviewTab1FormController extends SimpleFormController {

    /**
     * Instantiates a new CEJobInvoicePreviewTab1FormController.
     */
    public CEJobInvoicePreviewTab1FormController() {
        super();
        setSessionForm(true);
