...
/**
 * Purpose: Controller for 'Apply Deposit' tab in CE Invoice Preview
 * 
 * @version 1.0 May 25, 2009
 * @author Patni
 */
public class CEJobInvoicePreviewTab3FormController extends SimpleFormController {

    /**
     * Instantiates a new CEJobInvoicePreviewTab3FormController.
     */
    public CEJobInvoicePreviewTab3FormController() {
        super();
        setSessionForm(true);
