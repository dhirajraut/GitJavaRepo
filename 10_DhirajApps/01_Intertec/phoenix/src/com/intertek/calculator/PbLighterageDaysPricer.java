...
/**
 * Pricing Component - PB_LIGHTERAGE_DAYS:
 *
 ...
 * - LIGHTERAGE_TYPE - the radio button choices are ‘Harbor’, ‘Offshore’, or ‘No Lighterage’
 *
 ...
 *
 * 2.  expressionId
 *   - if the user selected ‘Harbor’, the expressionId is ‘L-HarborDay’
 *   - If the user selected ‘Offshore’, the expressionId is ‘L-OffshoreDay’
 *
 *
 ...
 * Please note here that the only change (with regard to standard formula) is the removal of the percentage thing
 *
 * Price:
 *
...
{
  private static Log log = LogFactory.getLog(PbLighterageDaysPricer.class);
  ...
  public CalculatorResult applyPricingLogic(CalculatorRequest cr)
  {
    ...
    String lighterageType = (String)params.get(Constants.LIGHTERAGE_TYPE);
    String expressionId = getExpressionId(lighterageType);
