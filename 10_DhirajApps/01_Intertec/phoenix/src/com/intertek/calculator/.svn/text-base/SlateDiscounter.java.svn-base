...
/**
 * The Slate Discounter
 *
 * Calculate the discount percentage for Slate Charge.
 *
 */

public class SlateDiscounter implements Discounter
{
  /**
  ...
  )
  {
    ...
    if(ld != null) zoneDiscnt = ld.getSlateDiscountPercent();
    overallZoneDiscnt = cr.getContract().getSlateDiscount();
