 ...
 * @author richard.qin
 */
public class InvoiceAddressDataSource extends AbstractJasperDataSource {
...
//        <variableExpression><![CDATA[($F{NAME}.equals( $F{BUSINESS_UNITS_CITY} ) ? "" : $F{NAME})]]></variableExpression>
//    </variable>
        ...
        if(ds != null){
            ...
            if(!type.equalsIgnoreCase("L")){
                ...
                */
            	...
            	list.add(DataSourceHelper.nullCheckReturnEmptyStr(ds.getFieldValue("BUSINESS_UNITS_ADDRESS1")));
                list.add(DataSourceHelper.nullCheckReturnEmptyStr(ds.getFieldValue("BUSINESS_UNITS_ADDRESS2")));
                list.add(DataSourceHelper.nullCheckReturnEmptyStr(ds.getFieldValue("BUSINESS_UNITS_ADDRESS3")));
                list.add(DataSourceHelper.nullCheckReturnEmptyStr(ds.getFieldValue("BUSINESS_UNITS_ADDRESS4")));
                list.add(DataSourceHelper.nullCheckReturnEmptyStr(ds.getFieldValue("BUSINESS_UNITS_CITY")) + ", " 
                                + DataSourceHelper.nullCheckReturnEmptyStr(ds.getFieldValue("BUSINESS_UNITS_STATE_CODE")) + " " 
                                + DataSourceHelper.nullCheckReturnEmptyStr(ds.getFieldValue("BUSINESS_UNITS_POSTAL")));
            	//END: 130869
                ...
                */
            	list.add(DataSourceHelper.nullCheckReturnEmptyStr(ds.getFieldValue("BANK_ACCT_ADDRESS1")));
 	            ...
 	            list.add(DataSourceHelper.nullCheckReturnEmptyStr(ds.getFieldValue("BANK_ACCT_COUNTRY_CODE")));
 	            //END: 130869
            }
            
            // copied from FieldPackager
            // TODO refactor
