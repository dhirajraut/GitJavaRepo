 ...
 * @author richard.qin
 */
public class InvoiceTaxNoprebillDataSource extends AbstractJasperDataSource {
    private static final Logger log = Logger.getLogger(InvoiceTaxNoprebillDataSource.class);
    ...
    public InvoiceTaxNoprebillDataSource(){
