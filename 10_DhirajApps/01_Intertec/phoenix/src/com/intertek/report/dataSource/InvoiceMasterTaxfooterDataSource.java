 ...
 * @author richard.qin
 */
public class InvoiceMasterTaxfooterDataSource extends AbstractJasperDataSource {
    private static final Logger log = Logger.getLogger(InvoiceMasterTaxfooterDataSource.class);
    ...
    public InvoiceMasterTaxfooterDataSource(){
