...
/**
 * This class used for creating Invoice_master_CE reports.
 * 
 * @author Patni
 * 
 */
public class CEInvoiceDataSource extends AbstractJasperDataSource {
    private static final Logger log = Logger.getLogger(InvoiceDataSource.class);
    private static final String[] fieldNames = { "LINE_ITEM_ID",
                                                 "JOB_NUMBER",
                                                 "INVOICE",
                                                 "CREDIT_IND",
                                                 "CUSTOMERS_NAME",
                                                 ...
                                                 "TERMS_URL", //uncomment after testing
                                                 "BU_NAME",
                                                 "COMPANY_LANG_DESC", 
                                                 "LOGO_NAME",
                                                 "sellers_country",
                                                 "DECIMAL_DIGITS",//uncomment after testing
                                                 "INV_AMT_PRE_TAX",
                                                 "INV_AMT_POST_TAX",
                                                 "DEPOSIT_SUBTOTAL"
                                                 };
   ...
   public CEInvoiceDataSource(){
    ...
    public JRDataSource getDataSource(String reportName, Map<String, Object> params) {
        String hql = "select il.id as  LINE_ITEM_ID,"
                     ...
                     + "     joli.splitPct as SPLIT_PCT," + "     joli.discountPct as DISCOUNT_PCT," + "     il.netPrice as NET_PRICE,"
                     + "     il.unitPrice as UNIT_PRICE," + "     joli.account as ACCOUNT," + "     joli.productGroup as PRODUCT_GROUP,"
