...
//public class CreateTowingCompanyFormController extends SimpleFormController
public class CreateTowingCompanyFormController extends BaseSimpleFormController
{
  public CreateTowingCompanyFormController() {
    super();
  ...
  ) throws Exception
  {
    ...
    try
    {
      towingCompany = towingCompanyService.addTowingCompany(towingCompany);
    }
    ...
    modelAndView.addObject("description", "Your towingCompany has been successfully created.");
