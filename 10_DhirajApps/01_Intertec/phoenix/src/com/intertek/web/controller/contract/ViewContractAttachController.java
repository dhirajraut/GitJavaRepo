...
public class ViewContractAttachController extends AbstractController
{
  private static Log log = LogFactory.getLog(ViewContractAttachController.class);
 
  public ViewContractAttachController() {
  }
  ...
  protected ModelAndView handleRequestInternal(
		  ...
		  ) throws Exception
	  {
		...
		String path ="";
		if(pRB != null)
			path = pRB.getString(com.intertek.util.Constants.contractfilepath);
			//path = pRB.getString(com.intertek.util.Constants.contractfilepath).concat("/");
