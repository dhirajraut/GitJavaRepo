...
public class EditJobInvoicePreviewTab2FormController extends SimpleFormController
{
  public EditJobInvoicePreviewTab2FormController() {
    super();
  ...
  ) throws Exception
  {
    ...
    addJobContract.setInvoicePreviewTabSrc("edit_job_invoice_preview_tab2.htm");
