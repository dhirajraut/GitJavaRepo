...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  <xsl:include href="../response/responses.xsl" />
  	...
  	<xsl:template match="/detail" xmlns:xsi="http://www.w3.org/2001/XMLSchema-instance" xmlns:xs="http://www.w3.org/2001/XMLSchema">
		<AcknowledgementX>
			<statusCode><xsl:value-of select="IBResponse/StatusCode"/></statusCode>
		</AcknowledgementX>
	</xsl:template>
		
  <xsl:template match="/CEInvoiceX">
    <ITS_INVOICE_GENERATION xmlns="http://peoplesoft.com/ITS_INVOICE_GENERATIONRequest">
      ...
      <MsgData>
        ...
        <xsl:variable name="businessunit" select="buName"/>
        <xsl:variable name="nomlocation" select="branchName"/>
        ...
        <xsl:variable name="companyid" select="custCode"/>
        <xsl:variable name="captureid" select="jobNumber"/>
        ...
        <xsl:variable name="contractid" select="contractCode"/>
        ...
        <xsl:for-each select="invoiceLine">
          ...
          <Transaction>
            ...
            <ITS_PRINT_TMP class="R">
              <BUSINESS_UNIT><xsl:value-of select="$businessunit"/></BUSINESS_UNIT>
              <INVOICE><xsl:value-of select="$invoice"/></INVOICE>
              <SEQ_NUM><xsl:value-of select="$prebillid"/></SEQ_NUM>
