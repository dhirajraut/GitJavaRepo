...
public class LayeredPaneDemo13
extends JFrame {
    ...
    public LayeredPaneDemo13()    {
        super("LayeredPaneDemo");

        //Create and load the duke icon.
        
        String pathToImage="C:\\D. Chandra\\Java\\D.Chandra New\\ClassroomExercises\\src\\Swings\\";
        final ImageIcon icon = new ImageIcon(pathToImage+"dukeWaveRed.gif");
    ...
    public static void main(String[] args) {
        JFrame frame = new LayeredPaneDemo13();
