...
public class TestGridBagLayout extends JFrame
	{	public TestGridBagLayout()
			{	super("GridBag Layout Managers.");
				...
				cn.gridx=1; cn.gridy=1; cn.ipadx=15; cn.ipady=0;  c.add(new JButton("2"), cn);
				cn.gridx=2; cn.gridy=2; cn.ipadx=0;  cn.ipady=15; c.add(new JButton("3"), cn);
				cn.gridx=3; cn.gridy=3; cn.ipadx=30; cn.ipady=15; c.add(new JButton("4"), cn);
				...
				try{	frGB1.setSelected( true);
						frGB2.setSelected(false);
						frGB3.setSelected(false);
						frGB4.setSelected(false);
						frGB5.setSelected(false);
						frGB6.setSelected(false);
					}
